...
import { loadDecisionEngine } from "@/lib/decision/loadDecisionEngine";
  ...
  return (
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="h-28 border-b border-white/5 flex items-center justify-between px-12">
        ...
        <div className={`px-6 h-14 rounded-3xl border text-xs uppercase tracking-[0.3em] flex items-center ${priorityStyle()}`}>
          {stats.priority}
        </div>
      ...
      <div className="px-10 pb-10">
        ...
        <div className={`rounded-[40px] border p-10 ${priorityStyle()}`}>
