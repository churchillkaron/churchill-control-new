...
export default function KitchenNeuralCorePage() {
      ...
      <div className="flex items-center justify-between mb-12">
        ...
        <div>
          ...
          <p className="text-zinc-500 mt-4 text-2xl">
            Autonomous AI restaurant cognition and operational intelligence matrix
          </p>

        </div>

        <div className="border border-cyan-500 bg-cyan-950/20 rounded-3xl px-8 py-6">
