...
import { loadWarRoom } from "@/lib/warroom/loadWarRoom";
...
export default function WarRoomPage() {
  ...
  function threatStyle() {

    if (
      stats.threat === "CRITICAL"
    ) {
  ...
  return (
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="h-28 border-b border-white/5 flex items-center justify-between px-12">
        ...
        <div className={`px-6 h-14 rounded-3xl border text-xs uppercase tracking-[0.3em] flex items-center ${threatStyle()}`}>
          {stats.threat} THREAT
        </div>
