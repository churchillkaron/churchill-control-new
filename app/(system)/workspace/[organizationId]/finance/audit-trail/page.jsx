...
export default function Page() {
  ...
  const endpoints = [{"label":"Live Audit Trail","url":"/api/finance/audit-trail/live"},{"label":"Anomaly Detection","url":"/api/finance/audit-trail/anomaly-detection"},{"label":"Entity History","url":"/api/finance/audit-trail/entity-history"}];
    ...
    <main className="space-y-6 p-6 text-white">
      <div>
        ...
        <p className="mt-2 max-w-3xl text-sm text-white/55">
          Audit log, anomaly detection and entity history.
        </p>
      </div>
