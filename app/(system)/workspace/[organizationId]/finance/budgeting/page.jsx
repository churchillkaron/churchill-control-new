...
export default function Page() {
  ...
  const endpoints = [{"label":"Budgeting","url":"/api/finance/budgeting"},{"label":"Budget Variance","url":"/api/finance/budgeting/variance"}];
  ...
  return (
    <main className="space-y-6 p-6 text-white">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-bold">Budgeting</h1>
        <p className="mt-2 max-w-3xl text-sm text-white/55">
          Budget, actuals and variance control.
        </p>
      </div>
