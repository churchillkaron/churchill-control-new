...
export default function Page() {
  ...
  const endpoints = [{"label":"Consolidation","url":"/api/finance/consolidation"},{"label":"Legal Entities","url":"/api/finance/legal-entities/list"}];
  ...
  return (
    <main className="space-y-6 p-6 text-white">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-bold">Consolidation</h1>
        <p className="mt-2 max-w-3xl text-sm text-white/55">
          Multi-company and multi-entity consolidated finance.
        </p>
      </div>
