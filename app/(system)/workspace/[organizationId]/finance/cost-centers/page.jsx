...
export default function Page() {
  ...
  const endpoints = [{"label":"Cost Centers","url":"/api/finance/cost-centers/list"}];
  ...
  return (
    <main className="space-y-6 p-6 text-white">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-bold">Cost Centers</h1>
        <p className="mt-2 max-w-3xl text-sm text-white/55">
          Cost center and reporting dimension control.
        </p>
      </div>
