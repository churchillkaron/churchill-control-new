...
export default function Page() {
  ...
  const endpoints = [{"label":"Executive KPIs","url":"/api/finance/executive-dashboard/kpi"},{"label":"Entity Ranking","url":"/api/finance/executive-dashboard/entity-ranking"},{"label":"Executive Alerts","url":"/api/finance/executive-dashboard/alerts"}];
  ...
  return (
    <main className="space-y-6 p-6 text-white">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-bold">Executive Dashboard</h1>
        <p className="mt-2 max-w-3xl text-sm text-white/55">
          CFO and accounting firm dashboard by organization and legal entity.
        </p>
      </div>
