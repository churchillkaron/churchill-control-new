...
export default function Page() {
  ...
  const endpoints = [{"label":"Fixed Assets","url":"/api/finance/fixed-assets/list"},{"label":"Depreciation","url":"/api/finance/fixed-assets/depreciation"},{"label":"Run Depreciation","url":"/api/finance/depreciation/run"}];
  ...
  return (
    <main className="space-y-6 p-6 text-white">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-bold">Fixed Assets</h1>
        <p className="mt-2 max-w-3xl text-sm text-white/55">
          Asset register, depreciation and ledger posting.
        </p>
      </div>
