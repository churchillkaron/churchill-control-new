...
export default function Page() {
  ...
  const endpoints = [{"label":"Health","url":"/api/finance/health"},{"label":"Module Runtime","url":"/api/finance/module"},{"label":"Runtime","url":"/api/finance/runtime"}];
  ...
  return (
    <main className="space-y-6 p-6 text-white">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-bold">Finance Health</h1>
