...
export default function Page() {
  ...
  const endpoints = [{"label":"Insights","url":"/api/finance/insights"},{"label":"KPIs","url":"/api/finance/kpis"},{"label":"Anomalies","url":"/api/finance/anomalies"}];
  ...
  return (
    <main className="space-y-6 p-6 text-white">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-bold">Finance Insights</h1>
        <p className="mt-2 max-w-3xl text-sm text-white/55">
          AI insights, KPIs and anomaly detection.
        </p>
      </div>
