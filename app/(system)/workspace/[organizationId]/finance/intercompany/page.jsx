...
export default function Page() {
  ...
  const endpoints = [{"label":"Runtime","url":"/api/finance/intercompany/runtime"},{"label":"Reconcile","url":"/api/finance/intercompany/reconcile"},{"label":"Eliminate","url":"/api/finance/intercompany/eliminate"},{"label":"Settle","url":"/api/finance/intercompany/settle"}];
  ...
  return (
    <main className="space-y-6 p-6 text-white">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-bold">Intercompany</h1>
        <p className="mt-2 max-w-3xl text-sm text-white/55">
          Intercompany create, reconcile, eliminate and settle.
        </p>
      </div>
