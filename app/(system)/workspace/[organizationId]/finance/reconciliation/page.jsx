...
export default function Page() {
  ...
  const endpoints = [{"label":"Reconciliation","url":"/api/finance/reconciliation"},{"label":"Anomalies","url":"/api/finance/anomalies"}];
  ...
  return (
    <main className="space-y-6 p-6 text-white">
      <div>
        ...
        <h1 className="mt-2 text-3xl font-bold">Reconciliation</h1>
