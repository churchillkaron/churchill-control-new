      ...
      <form className="space-y-5 bg-white/[0.05] p-6 rounded-2xl shadow-md" onSubmit={handleSubmit}>
        <div className="grid grid-cols-2 gap-4">
          <input
            ...
            className="p-3 rounded border border-black/[0.08] bg-white text-[#191919] focus:ring-2 focus:ring-[#D6A66A]"
            required
          />
          <input
            name="last_name"
        ...
        <input
          ...
          onChange={handleChange}
          className="w-full p-3 rounded border border-black/[0.08] bg-white text-[#191919] focus:ring-2 focus:ring-[#D6A66A]"
          required
        />
        <input
          name="phone"
        ...
        <button
          ...
          className={`w-full py-3 rounded-xl text-[#191919] font-semibold ${
            loading ? "bg-[#D8D3CB] cursor-not-allowed" : "bg-[#D6A66A] hover:bg-[#C8995B]"
          }`}
          disabled={loading}
        >
