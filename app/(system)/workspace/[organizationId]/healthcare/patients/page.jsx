...
export default function PatientsPage() {
  ...
  return (
    <main className="p-8">
      ...
      <div className="overflow-hidden rounded-3xl border border-black/[0.08] bg-[#FBF8F3]">
                    ...
                    <td className="p-5">
                      <div className="flex justify-end gap-2">
                        <Link
                          ...
                          className="rounded-xl border border-black/[0.08] px-3 py-2"
                        >
                          View
                        </Link>
                        ...
                        <Link
                          ...
                          className="rounded-xl border border-[#D6A66A]/30 bg-[#FBF3E8] px-3 py-2"
                        >
                          Edit
                        </Link>
