...
export default function ChannelReservationsPage() {
  ...
  return (
    ...
    >
      ...
      <HotelSection eyebrow="03 · Operating rule" title="Automation stops before it can damage an in-house stay" detail="Mapping conflicts, protected inventory, checked-in changes and closed business days remain explicit operator work. Automation stops before it can rewrite certified Hotel truth, and provider retry refetches provider truth before acknowledgement only after canonical Hotel acceptance is already safe.">
