...
import PestControlMonitoringScanner from "@/components/workspace/operations/pest-control/PestControlMonitoringScanner";
import { useOrganizationRuntime } from "@/lib/hooks/useOrganizationRuntime";
import { organizationHasIndustrySolution } from "@/lib/platform/solutions/OrganizationIndustrySolutionResolver";

export default function PestControlMonitoringScannerPage() {
  ...
  if (loading) return <div className="min-h-[420px] bg-[#F7F6F3] p-8 text-sm text-[#77736C]">Preparing monitoring scanner...</div>;
  ...
  return <PestControlMonitoringScanner organizationId={organizationId} />;
}
