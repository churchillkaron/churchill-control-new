...
import PestControlVisitMonitoringRound from "@/components/workspace/operations/pest-control/PestControlVisitMonitoringRound";
import { useOrganizationRuntime } from "@/lib/hooks/useOrganizationRuntime";
import { organizationHasIndustrySolution } from "@/lib/platform/solutions/OrganizationIndustrySolutionResolver";

export default function PestControlVisitMonitoringRoundPage() {
  ...
  if (loading) return <div className="min-h-[420px] bg-[#F7F6F3] p-8 text-sm text-[#77736C]">Preparing monitoring round...</div>;
  ...
  return <PestControlVisitMonitoringRound organizationId={organizationId} occurrenceId={occurrenceId} />;
}
