...
import PestControlMonitoringRounds from "@/components/workspace/operations/pest-control/PestControlMonitoringRounds";
import { useOrganizationRuntime } from "@/lib/hooks/useOrganizationRuntime";
import { organizationHasIndustrySolution } from "@/lib/platform/solutions/OrganizationIndustrySolutionResolver";

export default function PestControlMonitoringRoundsPage() {
  ...
  if (loading) return <div className="min-h-[420px] bg-[#F7F6F3] p-8 text-sm text-[#77736C]">Preparing monitoring rounds...</div>;
  ...
  return <PestControlMonitoringRounds organizationId={organizationId} />;
}
