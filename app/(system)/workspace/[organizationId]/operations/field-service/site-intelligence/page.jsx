...
import PestControlSiteIntelligence from "@/components/workspace/operations/pest-control/PestControlSiteIntelligence";
import { useOrganizationRuntime } from "@/lib/hooks/useOrganizationRuntime";
import { organizationHasIndustrySolution } from "@/lib/platform/solutions/OrganizationIndustrySolutionResolver";

export default function PestControlSiteIntelligencePage() {
  ...
  if (loading) return <div className="min-h-[420px] bg-[#F7F6F3] p-8 text-sm text-[#77736C]">Preparing site intelligence...</div>;
  ...
  return <PestControlSiteIntelligence organizationId={organizationId} />;
}
