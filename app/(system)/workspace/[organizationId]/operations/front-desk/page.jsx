...
export default function OperationsFrontDeskPage() {
  ...
  return (
    <HotelWorkspaceShell
      ...
      active="front-desk"
      title="Front Desk"
      subtitle="Work the guest, not the PMS. Avantiqo uses each property's real operating day, explains the exact blocker and exposes the safest next move for arrivals, in-house stays and departures."
