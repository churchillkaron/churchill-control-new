    ...
    return (
      <RestaurantAvantiqoTheme mode="service">
        <div className="min-h-screen bg-[#F7F6F3] text-[#191919]" data-restaurant-waiter-surface="true">
          <div className="sticky top-0 z-40 border-b border-black/[0.07] bg-[#FBF8F3]/95 px-4 py-3 backdrop-blur-xl">
            <div className="mx-auto max-w-[480px]">
              ...
              <div className="mt-1 text-[10px] text-[#8A867F]">Phone service workspace · settlement stays at the stationary POS</div>
            </div>
          </div>
        ...
        <div className="sticky top-0 z-40 border-b border-black/[0.07] bg-[#FBF8F3]/95 px-4 py-3 backdrop-blur-xl">
          <div className="mx-auto flex max-w-[1760px] flex-wrap items-end justify-between gap-3">
            <div>
              ...
              <div className="mt-1 text-[10px] text-[#8A867F]">Desktop cashier workstation · order and settlement remain visible together.</div>
            </div>

            <div className="rounded-xl border border-[#D6A66A]/30 bg-[#FBF4EA] px-3 py-2 text-[10px] font-medium uppercase tracking-[0.14em] text-[#76583A]">One continuous cashier screen</div>
          </div>
        </div>

        <div className="mx-auto grid max-w-[1760px] gap-4 p-3 xl:grid-cols-[minmax(0,1fr)_430px] xl:p-4">
          <div className="min-w-0 overflow-hidden rounded-[28px] border border-black/[0.07] bg-white" data-stationary-order-entry="true">
            {canOrder ? (
...
function RetailSaleSurface(props) {
  ...
  return (
    <div className="min-h-screen bg-[#F7F6F3] text-[#191919]" data-pos-unified-sale="true">
      ...
      <div className="mx-auto grid max-w-[1760px] gap-4 p-3 xl:grid-cols-[minmax(0,1fr)_430px] xl:p-4">
        <div className="min-w-0 overflow-hidden rounded-[28px] border border-black/[0.07] bg-white">
