...
export default function RestaurantStationaryPOSSurface({
  posConfiguration,
  posRuntime,
}) {
  const params =
  ...
  function refreshCanonicalRuntime() {
