        ...
        <div className="mt-5 grid gap-5 xl:grid-cols-[430px_minmax(0,1fr)]">
          <div className="space-y-5">
            <form onSubmit={createQualification} className="rounded-2xl border border-black/[0.075] bg-white p-5">
              ...
              <button disabled={saving} className="mt-4 w-full rounded-xl bg-[#2E2A25] px-4 py-3 text-[9px] font-medium text-[#191919] disabled:opacity-40">Create qualification</button>
            </form>
            ...
            <form onSubmit={grantQualification} className="rounded-2xl border border-black/[0.075] bg-white p-5">
              ...
              <button disabled={saving || !activeCatalog.length || !staff.length} className="mt-4 w-full rounded-xl bg-[#2E2A25] px-4 py-3 text-[9px] font-medium text-[#191919] disabled:opacity-40">Verify qualification</button>
            </form>
          </div>
