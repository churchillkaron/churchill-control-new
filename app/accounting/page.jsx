      ...
      >
        ...
        >
          ...
          <SummaryCard
            ...
            value={formatNumber(expenseVsRevenuePct * 100) + '%'}
        ...
        >
          ...
          >
            ...
            >
              ...
              <div style={readBoxStyle}>
                Net margin after expenses is {formatNumber(netMarginAfterExpenses * 100)}%. This is the owner number, not just the kitchen number.
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div style={{ display: 'grid', gap: 10 }}>
              {categoryBreakdown.length ? (
                ...
                <div style={emptyBoxStyle}>No expense data.</div>
              )}
            </div>
          </div>
            ...
            <div style={{ display: 'grid', gap: 10 }}>
              {departmentBreakdown.length ? (
                departmentBreakdown.map(([dept, val]) => (
                  <div key={dept} style={breakdownRowStyle}>
                    <span style={{ color: THEME.text }}>{dept}</span>
                    <span style={{ color: THEME.muted }}>{formatCurrency(val)}</span>
                  </div>
                ))
              ) : (
                <div style={emptyBoxStyle}>No department data.</div>
              )}
            </div>
          </div>
        </div>
        ...
        >
          ...
          {loading ? (
            <div style={emptyBoxStyle}>Loading...</div>
          ) : filteredExpenses.length === 0 ? (
            <div style={emptyBoxStyle}>No expenses yet.</div>
          ) : (
