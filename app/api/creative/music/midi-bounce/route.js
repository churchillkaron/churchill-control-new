...
async function register(body){
  ...
  midiTrack.release_bounce={contract:"AVANTIQO_MUSIC_MIDI_RELEASE_BOUNCE_LINK_V2",asset_id:asset.id,audio_track_id:track.id,bounce_contract:bounceContract,source_midi_fingerprint:sourceMidiFingerprint,tempo_map_aware:tempoMapAware,created_at:new Date().toISOString(),source_midi_preserved:true};
