...
import {
  CreativeAuthorizedMasterStillPreflightRecoveryRuntime,
} from "@/lib/creative/production/approval/CreativeAuthorizedMasterStillPreflightRecoveryRuntime";
...
export async function POST(req) {
  try {
    ...
    const result =
      await CreativeAuthorizedMasterStillPreflightRecoveryRuntime.recover({
