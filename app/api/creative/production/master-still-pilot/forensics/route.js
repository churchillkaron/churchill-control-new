...
import {
  CreativeMaskedPilotForensicsRuntime,
} from "@/lib/creative/production/pilot/CreativeMaskedPilotForensicsRuntime";
...
export async function POST(req) {
  try {
    ...
    const result = await CreativeMaskedPilotForensicsRuntime.inspect({
