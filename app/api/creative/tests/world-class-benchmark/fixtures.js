...
const CHURCHILL_ENTRANCE_PANEL = Object.freeze({
  ...
  reviewers: Object.freeze([
    Object.freeze({
      ...
      failure_modes: Object.freeze(["Brand elements deviating in shape, color, or placement", "Inaccurate replication of logo and neon sign properties", "Inconsistent gold and neon colors affecting brand perception"]),
    }),
    Object.freeze({
      ...
      failure_modes: Object.freeze(["Poor compositional hierarchy weakening visual flow", "Unrealistic lighting or unnatural shadows", "Inconsistent textures or lack of material authenticity"]),
    }),
    Object.freeze({
      ...
      failure_modes: Object.freeze(["Unauthorized use of venue or staff likenesses", "Missing clearances or releases for assets used", "Improper public distribution risking legal exposure"]),
    }),
    Object.freeze({
      ...
      failure_modes: Object.freeze(["Missing or out-of-order production steps", "Failures to meet quality gate standards", "Output inconsistencies or artifacts introduced at generation stages"]),
    }),
    Object.freeze({
      ...
      failure_modes: Object.freeze(["AI-related visual artifacts or 'uncanny valley' effects", "Color grading mismatch breaking brand tone", "Identity drift in architectural or signage details"]),
    }),
  ]),
});
