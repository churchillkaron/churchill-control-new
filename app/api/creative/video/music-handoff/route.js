...
import { handoffMusicMasterToVideoProject } from "@/lib/creative/video/runtime/CreativeMusicVideoHandoffRuntime.js";
...
export async function POST(request) {
  try {
    ...
    const result = await handoffMusicMasterToVideoProject({
