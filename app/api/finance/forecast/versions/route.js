...
export async function GET(request) {
  try {
    ...
    return NextResponse.json(
      {
        success: false,
        error: error?.message || "Forecast version listing failed",
      },
...
export async function POST(request) {
  try {
    ...
    return NextResponse.json(
      {
        success: false,
        error: error?.message || "Forecast version creation failed",
      },
      { status: statusFor(error) }
    );
  }
...
export async function PATCH(request) {
  try {
    ...
    return NextResponse.json(
      {
        success: false,
        error: error?.message || "Forecast version update failed",
      },
      { status: statusFor(error) }
    );
  }
