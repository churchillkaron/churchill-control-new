...
const TOKEN = "avq-cedar-v3-founder-4min-20260819";
  ...
  try {
    ...
    const execution = await ServiceExecutionRuntime.execute({
      ...
      input: {
        ...
        voice: "cedar",
        response_format: "mp3",
        quantity: Math.max(0.02, words / 140),
        instructions: "Single continuous founder performance for a world-class four-minute investor film. Neutral international English. Warm, intelligent, experienced, calm, assured and cinematic. This is the founder personally telling his own story from beginning to end, never a detached narrator, announcer or salesperson. Target about 140 words per minute so the spoken master is about three minutes and fifty seconds, leaving the cinematic logo opening and end-card resolve to bring the finished film to approximately four minutes. Use natural pauses after the personal opening statements and before major thesis lines. Give emotional emphasis without melodrama to: the software should understand the business; that is why I built Avantiqo; understand recommend approve execute; one operating architecture; it can begin to understand the business itself; and we are building the system businesses will operate through. Pronounce Avantiqo as ah-VAN-tee-koh. Maintain one consistent voice, room tone, energy and microphone perspective for the entire recording so sections can be used both as voice-over and exact founder lip-sync source.",
      },
      metadata: {
        module: "CREATIVE",
        operation: "AVANTIQO_INVESTOR_VIDEO_NARRATION_CEDAR_V3_FOUNDER_4MIN",
        brand: "Avantiqo",
        source: "avantiqo_investor_video_20260819_founder_master_v3",
