...
export async function POST(request) {
  try {
    ...
    const context = { organizationId, actor, permissions: access.permissions || [], callerRequest: request, metadata: { source: "CODE_STUDIO", explicit_user_commit_request: true } };
    const capability = createCodeAICommitCapability();
