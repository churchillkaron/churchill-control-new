...
export async function POST(request) {
  try {
    ...
    if (/ENTITY_REQUIRED|ENTITY_SCOPE_MISMATCH|ENTITY_ENGAGEMENT_MISMATCH|ENTITY_INACTIVE_OR_OUT_OF_SCOPE|PERIOD_REQUIRED|PERIOD_SCOPE_MISMATCH|ENGAGEMENT_SCOPE_MISMATCH|TEMPLATE_UNAVAILABLE|TEMPLATE_HAS_NO_ACTIVE_STEPS|ENGAGEMENT_UNAVAILABLE|CLIENT_PROFILE_UNAVAILABLE|ASSIGNMENT_REQUIRED|SEGREGATION_REQUIRED|NOT_ACTIVE_FIRM_MEMBER|PORTAL_ACCESS_REQUIRED/.test(message)) {
