...
export async function POST(request) {
  try {
    ...
    if (/ENTITY_REQUIRED|ENTITY_SCOPE_MISMATCH|PERIOD_REQUIRED|PERIOD_SCOPE_MISMATCH|TEMPLATE_UNAVAILABLE|TEMPLATE_HAS_NO_ACTIVE_STEPS|ENGAGEMENT_UNAVAILABLE|CLIENT_PROFILE_UNAVAILABLE|ASSIGNMENT_REQUIRED|SEGREGATION_REQUIRED|NOT_ACTIVE_FIRM_MEMBER/.test(message)) {
