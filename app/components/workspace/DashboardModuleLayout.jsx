...
export default function DashboardModuleLayout({moduleName,tabs=[],kpis=[],sidePanel=null,children}){
  ...
  return(
    <div className="p-6 space-y-6 text-white font-sans">
      ...
      <div className="p-4 bg-white/5 backdrop-blur-lg rounded-2xl shadow-inner text-white/70">Dashboard Summary / Charts</div>
    </div>
  );
}
