  ...
  return (
    <div className="relative h-screen w-full text-white overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-center justify-center px-6">
        ...
        {/* Glass Container */}
        <div className="text-center backdrop-blur-md bg-white/[0.04] border border-white/10 rounded-3xl px-8 py-10 shadow-[0_20px_80px_rgba(0,0,0,0.6)] max-w-2xl">
          ...
          {/* Title */}
          <h1 className="text-5xl md:text-7xl font-semibold mb-8 leading-tight bg-gradient-to-b from-white to-white/70 bg-clip-text text-transparent">
          ...
          <div className="flex justify-center gap-4">
            ...
            <button className="border border-white/20 px-8 py-3 rounded-xl text-white/70 hover:bg-white/10 transition">
              Request Demo
            </button>
          </div>
