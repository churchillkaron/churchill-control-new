...
function AvantiqoMark() {
  return (
    <div className="flex items-center gap-4">
      <div className="relative flex h-11 w-11 items-center justify-center overflow-hidden rounded-2xl border border-[#D6A66A]/45 bg-[#D6A66A]/[0.08] shadow-[0_0_36px_rgba(214,166,106,.12)]">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_35%_25%,rgba(255,229,166,.35),transparent_45%)]" />
        <span className="relative font-serif text-[21px] text-[#F4D79D]">A</span>
      </div>
      <div>
        <div className="text-[15px] font-medium uppercase tracking-[0.34em] text-[#F3E8D2]">Avantiqo</div>
...
export default function HomePage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#030303] text-white">
      ...
      <header className="relative z-20 mx-auto flex w-full max-w-[1500px] items-center justify-between px-6 py-6 sm:px-10 lg:px-14">
        <AvantiqoMark />
        <Link
          href="/login"
          className="rounded-full border border-[#D6A66A]/45 bg-[#D6A66A]/[0.06] px-5 py-2.5 text-[10px] uppercase tracking-[0.24em] text-[#F2D79D] transition hover:border-[#F2D79D]/70 hover:bg-[#D6A66A]/[0.12]"
        >
          Login
        </Link>
      </header>

      <section className="relative z-10 mx-auto grid min-h-[calc(100vh-96px)] w-full max-w-[1500px] items-center gap-10 px-6 pb-16 pt-8 sm:px-10 lg:grid-cols-[0.94fr_1.06fr] lg:px-14 lg:pb-24 lg:pt-2">
        <div className="max-w-[690px]">
          <div className="inline-flex items-center gap-3 rounded-full border border-[#D6A66A]/20 bg-[#D6A66A]/[0.04] px-4 py-2 text-[9px] uppercase tracking-[0.28em] text-[#D6A66A]/80">
          ...
          <div className="mt-9 flex flex-wrap gap-3">
            {['Unify', 'Understand', 'Create', 'Operate', 'Scale'].map((item) => (
              <span key={item} className="rounded-full border border-white/[0.08] bg-white/[0.025] px-4 py-2 text-[9px] uppercase tracking-[0.22em] text-white/45">
                {item}
              </span>
            ))}
          </div>
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            <Link
              href="/login"
              className="rounded-full border border-[#F1CF85] bg-[linear-gradient(100deg,#8B571F,#D9A54D,#F1D18B,#A76C27)] px-6 py-3.5 text-[10px] font-semibold uppercase tracking-[0.22em] text-black shadow-[0_16px_50px_rgba(191,128,45,.16)] transition hover:brightness-110"
            >
              Avantiqo Login
            </Link>
            <span className="text-[9px] uppercase tracking-[0.24em] text-white/28">Private preview access</span>
          </div>
        </div>
              ...
              <div className="relative">
                ...
                <div className="mt-8 flex flex-wrap gap-2">
                  {group.items.map((item) => (
                    <span key={item} className="rounded-full border border-white/[0.075] bg-black/30 px-3 py-2 text-[8px] uppercase tracking-[0.19em] text-white/38">
                      {item}
                    </span>
                  ))}
                </div>
      ...
      <section className="relative z-10 border-t border-white/[0.06] px-6 py-20 sm:px-10 lg:px-14 lg:py-28">
        <div className="mx-auto flex w-full max-w-[1500px] flex-col items-start justify-between gap-10 lg:flex-row lg:items-end">
          <div className="max-w-4xl">
            <div className="text-[9px] uppercase tracking-[0.34em] text-[#D6A66A]/60">The next operating layer</div>
            <h2 className="mt-5 font-serif text-[clamp(2.8rem,6vw,6rem)] leading-[0.95] tracking-[-0.04em] text-[#F1ECE3]">
          ...
          <Link href="/login" className="shrink-0 rounded-full border border-[#D6A66A]/35 px-6 py-3 text-[9px] uppercase tracking-[0.24em] text-[#E9C982] transition hover:bg-[#D6A66A]/10">
            Login
          </Link>
        </div>
      </section>
