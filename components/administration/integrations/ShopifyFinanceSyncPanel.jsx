        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-white/60">
              Avantiqo observes Shopify payments and refunds by default. Finance posting is enabled only after a legal entity and settlement bank account are explicitly configured.
            </p>
          </div>
          ...
          <div className="mt-6 grid gap-5 md:grid-cols-2">
            ...
            <div className="md:col-span-2 flex flex-col gap-3 rounded-2xl border border-white/10 bg-black/25 p-4 text-sm text-white/60 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <div className="mt-1 text-xs text-white/40">Refund records never prove cash movement by themselves; Avantiqo posts only successful Shopify payment transactions.</div>
              </div>
              <button
                type="button"
                onClick={save}
