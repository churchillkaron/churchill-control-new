          ...
          <div className="rounded-2xl border border-white/8 bg-black/25 p-5">
            ...
            <div className="mt-5 space-y-2">
              {(stages.length ? stages : [
                ...
                { id: "vocal-correction", label: "Pitch & timing correction", description: "Musician-reviewed owned correction lane; remains gated until the configured engine is production-certified", status: "ENGINE GATED" },
