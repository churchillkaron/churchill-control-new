...
function makeTrack(type, index) {
  return {
    id: crypto.randomUUID(), type, audio_role: type === "vocal" ? "SONG_VOCAL" : ["guitar","bass","keys","drums","instrument","backing"].includes(type) ? "INSTRUMENT" : "PROGRAM",
