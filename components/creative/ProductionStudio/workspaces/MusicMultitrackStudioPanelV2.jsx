    ...
    <section className="min-h-[760px] bg-[#070707] text-white">
      ...
      <div className="grid min-h-[660px] xl:grid-cols-[minmax(0,1fr)_380px]">
        ...
        <aside className="space-y-4 bg-black/20 p-4">
          ...
          <div className="rounded-2xl border border-emerald-300/10 bg-emerald-300/[0.025] p-4 text-[10px] leading-5 text-emerald-100/45"><div className="flex items-center gap-2 text-emerald-100/60"><Headphones className="h-3.5 w-3.5"/>Live preview is not release mastering.</div><div className="mt-2">Clip gain → trim → polarity → EQ → compression → fader/pan → sends/master. Original takes remain immutable.</div></div>
