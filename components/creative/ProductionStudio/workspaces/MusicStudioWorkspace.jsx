...
import { MicOff, Music2 } from "lucide-react";
      ...
      <div className="sticky top-0 z-20 border-b border-white/7 bg-[#080808]/95 px-6 py-3 backdrop-blur-xl">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <div className="mt-1 text-xs text-white/32">Compose original music or build performance backing tracks from confirmed source audio.</div>
          </div>
