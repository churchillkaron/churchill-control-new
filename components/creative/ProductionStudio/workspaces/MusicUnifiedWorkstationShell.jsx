...
export default function MusicUnifiedWorkstationShell({ organizationId, projectId, projectName = "Audio Project", audioRoom = "MUSIC_PRODUCTION", onRoomChange = null, onProfessionalReleaseAdvanced }) {
  ...
  return (
    <div className="min-h-full bg-[#070707]">
      ...
      {audioRoom === "SOUND_DESIGN" ? <><MusicSoundDesignObjectPanel organizationId={organizationId} projectId={projectId} onSaved={() => setWorkstationRevision((value) => value + 1)} /><MusicAdvancedSoundDesignPanel organizationId={organizationId} projectId={projectId} onSaved={() => setWorkstationRevision((value) => value + 1)} /></> : null}
