  ...
  return <div className="shrink-0 border-b border-amber-300/15 bg-amber-300/[0.045] px-4 py-3 lg:px-5">
    <div className="flex flex-wrap items-center gap-3">
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-1 text-[10px] leading-5 text-[#817A72]">Your unsaved local draft is preserved. Avantiqo will not overwrite the newer server version.</div>
      </div>
      <button type="button" onClick={() => void persistence.reloadLatestAfterConflict()} className="rounded-md border border-[#D8D3CB] bg-[#FBFAF8] px-3 py-1.5 text-[9px] text-[#665F57]">Reload latest</button>
