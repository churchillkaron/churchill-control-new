...
export default function ImageStudioLightWrapPreviewOverlay({style={},scale=1,assetUrl="",preview={},hasMask=false,maskStyle={},hasEdgeAlpha=false}){
  const reactId=useId();
  const spec=imageStudioLightWrapPreview({style,scale,asset_url:assetUrl,preview,has_mask:hasMask,mask_style:maskStyle,has_edge_alpha:hasEdgeAlpha});
