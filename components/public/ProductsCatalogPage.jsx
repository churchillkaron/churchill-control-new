...
function CategoryArt({group,index,compact=false}) {
  ...
  if (group.id === "industry") return <div className="absolute inset-0 overflow-hidden bg-[#12100E]"><div className="absolute inset-0 scale-[1.08]"><PublicArtStage kind="solutions"/></div><div className="absolute inset-0 bg-black/16"/><div className="absolute bottom-4 left-4 text-[7px] font-semibold uppercase tracking-[.18em] text-[#F0C98F]">0{index+1} · {group.label}</div></div>;
