    ...
    <div className="grid gap-3 md:grid-cols-3">
      {["development","staging","production"].map((key) => {
        ...
        return <div key={key} className="rounded-[20px] border border-black/[.07] bg-white p-5">
          ...
          {!row ? (canManageSecurity?<button disabled={busy||!productionReady} onClick={() => add(key)} className="mt-5 rounded-xl bg-[#1D1A17] px-4 py-2 text-[9px] font-semibold text-white disabled:opacity-40">Create {key}</button>:<div className="mt-5 text-[8px] leading-4 text-[#8B8177]">An organization Developer administrator creates shared environments.</div>) :
            <>
  ...
  return <div>
    ...
    <div className="rounded-[20px] border border-black/[.07] bg-white p-5">
      <div className="grid gap-3 md:grid-cols-[1fr_220px_140px_auto] md:items-end">
        ...
        <button onClick={create} disabled={busy} className="h-[38px] rounded-xl bg-[#1D1A17] px-4 py-2.5 text-[9px] font-semibold text-white disabled:opacity-40">Create credential</button>
      </div>
  ...
  return <div>
    ...
    <div className="rounded-[20px] border border-black/[.07] bg-white p-5">
      <div className="grid gap-3 lg:grid-cols-[1fr_1.4fr_220px_auto] lg:items-end">
        ...
        <button onClick={create} disabled={busy} className="h-[38px] rounded-xl bg-[#1D1A17] px-4 py-2.5 text-[9px] font-semibold text-white disabled:opacity-40">Add endpoint</button>
      </div>
