      ...
      <div className="mx-auto max-w-[1640px]">
        ...
        <div className="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1.15fr)_minmax(360px,0.85fr)]">
          <section className="rounded-[24px] border border-black/[0.075] bg-white p-5">
            ...
            <button onClick={saveMetadata} disabled={busy === "save"} className="mt-4 inline-flex items-center gap-2 rounded-xl bg-[#1D1B18] px-4 py-2.5 text-[11px] font-medium text-[#191919]"><Save size={13} />{busy === "save" ? "Saving…" : "Save controls"}</button>
          </section>
          ...
          <section className="rounded-[24px] border border-black/[0.075] bg-white p-5">
            ...
            <div className="mt-4 flex flex-wrap gap-2">{!openApproval && !canSign ? <button onClick={() => approval("request")} className="rounded-xl bg-[#1D1B18] px-3.5 py-2.5 text-[11px] font-medium text-[#191919]">Request approval</button> : null}{openApproval ? <><button onClick={() => approval("approve")} className="rounded-xl bg-[#1D1B18] px-3.5 py-2.5 text-[11px] font-medium text-[#191919]">Approve</button><button onClick={() => approval("reject")} className="rounded-xl border border-[#B36B52]/20 px-3.5 py-2.5 text-[11px] text-[#9A533D]">Reject</button></> : null}{canSign ? <Pill><CheckCircle2 size={10} className="mr-1 inline" />Approved</Pill> : null}</div>
