        ...
        {data ? <>
          ...
          <div className="mt-5 rounded-2xl border border-white/[0.08] bg-white/[0.025] p-5">
            ...
            {view === "reviews" ? <div className="space-y-3">{rows.map(row => {
              ...
              const closureReady = Boolean(review.assigned_to && review.due_date && review.acknowledged_by && review.acknowledged_at && String(form.resolutionNote || "").trim());
