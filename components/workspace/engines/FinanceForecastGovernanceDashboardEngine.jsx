...
function governanceBadge(row) {
  if (row.governance_complete === true) {
    return <span className="rounded-full border border-emerald-300/20 bg-emerald-300/[0.06] px-3 py-1 text-xs text-emerald-100">Governance complete</span>;
  }
  return <span className="rounded-full border border-amber-300/20 bg-amber-300/[0.06] px-3 py-1 text-xs text-amber-100">Governance incomplete</span>;
}
