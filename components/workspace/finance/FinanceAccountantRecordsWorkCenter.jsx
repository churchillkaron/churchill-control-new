...
export default function FinanceAccountantRecordsWorkCenter({
  ...
  const [portalPaymentSetup, setPortalPaymentSetup] = useState(null);
  const [portalPaymentBusy, setPortalPaymentBusy] = useState(false);
  const [portalPaymentBankAccountId, setPortalPaymentBankAccountId] = useState("");
