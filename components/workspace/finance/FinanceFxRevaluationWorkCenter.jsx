...
export default function FinanceFxRevaluationWorkCenter({ organizationId, entityId, periodId }) {
  ...
  const runs = useMemo(
    () => (Array.isArray(workspace?.runs) ? workspace.runs : []),
    [workspace?.runs],
  );
