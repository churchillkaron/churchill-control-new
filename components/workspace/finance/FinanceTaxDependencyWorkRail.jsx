          ...
          return <article key={dependency.id} className={`p-4 ${index === 0 ? "bg-[#FFF9F0]/35" : ""}`}>
            ...
            <details className="mt-3 overflow-hidden rounded-lg border border-black/[0.06] bg-white">
              ...
              <div className="border-t border-black/[0.06] bg-[#FAF9F7] p-3">
                {readOnly ? <div className="mb-2 inline-flex items-center gap-1.5 rounded-lg border border-black/[0.06] bg-white px-2.5 py-2 text-[8px] leading-4 text-[#817B73]"><LockKeyhole size={9} /> A colleague owns this work. Their coordination is visible, but only the owner can change it.</div> : null}
