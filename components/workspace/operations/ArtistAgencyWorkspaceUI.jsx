...
function BookingDetail({ booking, organizationId, onClose, onChanged }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-[#F7F6F3]/20 backdrop-blur-[2px]" onMouseDown={onClose}>
...
function NewBookingModal({ organizationId, onClose, onCreated }) {
  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-[#F7F6F3]/20 p-4 backdrop-blur-[2px]" onMouseDown={onClose}>
