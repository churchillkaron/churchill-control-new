...
export default function PestControlTechnicianCockpit({ organizationId }) {
  ...
  const completionReady = protocolReady && proofReady && !isTerminal(selected);
      ...
      <div className="mx-auto max-w-[1680px]">
        <header className="flex flex-wrap items-end justify-between gap-4 border-b border-black/[0.07] pb-5">
          <div>
            ...
            <p className="mt-1 max-w-3xl text-[11px] leading-5 text-[#777169]">One controlled path from arrival to inspection, treatment, proof and customer-safe completion.</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <button type="button" onClick={() => load()} className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-black/[0.08] bg-white text-[#806143]" aria-label="Refresh technician queue">
            ...
            <section className="overflow-hidden rounded-2xl border border-black/[0.075] bg-white shadow-[0_1px_2px_rgba(0,0,0,0.025)]">
              ...
              <div className="grid gap-0 lg:grid-cols-[minmax(0,1fr)_310px]">
                <div className="p-5 md:p-6">
                  ...
                  <div className="mt-6 border-t border-black/[0.06] pt-5">
                    <div className="text-[9px] font-medium uppercase tracking-[0.13em] text-[#8A867F]">3 · Prove</div>
                  ...
                  <div className="mt-6 border-t border-black/[0.06] pt-5">
                    <div className="text-[9px] font-medium uppercase tracking-[0.13em] text-[#8A867F]">4 · Outcome</div>
                ...
                <aside className="border-t border-black/[0.06] bg-[#FBFAF8] p-5 lg:border-l lg:border-t-0">
                  <div className="lg:sticky lg:top-5">
                    ...
                    <div className="mt-4 rounded-xl border border-black/[0.06] bg-white p-3.5 text-[8px] leading-4 text-[#837C73]">Completion writes the protocol submission into the work order, executes the canonical Operations lifecycle, reconciles the exact service occurrence, consumes recorded service materials, and creates follow-up work automatically when the outcome requires it.</div>
                    ...
                    {!completionReady && !isTerminal(selected) ? <div className="mt-2 text-center text-[8px] leading-3 text-[#9C958D]">Completion stays locked until the live protocol preflight is satisfied.</div> : null}
                  </div>
                </aside>
              </div>
            </section>
