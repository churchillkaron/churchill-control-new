    ...
    <main className="min-h-[calc(100vh-61px)] bg-[#F7F6F3] px-4 py-5 text-[#191919] md:px-7 lg:px-9 lg:py-7">
      <div className="mx-auto max-w-[1580px]">
        ...
        {state.data ? <>
          ...
          <aside className="space-y-4 xl:sticky xl:top-5"><section className="rounded-2xl border border-black/[0.07] bg-[#24211E] p-4 text-[#191919]"><div className="flex items-start justify-between gap-3"><div><div className="text-[8px] font-medium uppercase tracking-[0.14em] text-[#CDB89D]">Visit control</div><div className="mt-1 text-[14px] font-medium">{readinessIssues.length ? "Finish the treatment record" : "Record is structurally ready"}</div></div>{readinessIssues.length ? <ClipboardCheck size={18} className="text-[#D6A66A]" /> : <CheckCircle2 size={18} className="text-[#A9B69B]" />}</div><div className="mt-4 grid grid-cols-2 gap-2"><div className="rounded-xl border border-black/[0.07] bg-[#FBF8F3] p-3"><div className="text-[7px] uppercase tracking-[0.08em] text-[#746E66]">Findings</div><div className="mt-1 text-[18px] font-medium">{findings.length}</div><div className="text-[7px] text-[#746E66]">{summary.areas} areas · {summary.severe} severe</div></div><div className="rounded-xl border border-black/[0.07] bg-[#FBF8F3] p-3"><div className="text-[7px] uppercase tracking-[0.08em] text-[#746E66]">Applications</div><div className="mt-1 text-[18px] font-medium">{applications.length}</div><div className="text-[7px] text-[#746E66]">Stock posts at close</div></div></div>
