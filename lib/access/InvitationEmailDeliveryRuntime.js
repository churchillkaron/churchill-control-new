...
function messageFor({ kind, sourceName, recipientName, inviteUrl, expiresAt, role, permissions, billingModel }) {
  ...
  if (kind === "supplier") {
    return {
      ...
      message: `${greeting}\n\n${source} has invited you to access its Supplier Portal in Avantiqo. This creates supplier-only access for this customer relationship and does not create internal staff or business-workspace membership.\n\nOpen invitation:\n${inviteUrl}${expiryLine}\n\nUse the exact email address that received this invitation. If you were not expecting this invitation, you can ignore this message.`,
    };
  }
  if (kind === "developer") {
