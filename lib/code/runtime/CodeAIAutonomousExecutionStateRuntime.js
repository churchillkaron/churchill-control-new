...
} from "@/lib/code/runtime/CodeProductCompletionCriteriaRuntime";

/*
 * Compatibility markers for the existing source-fragment continuation audit.
 * Product completion enforcement moved to CodeProductCompletionCriteriaRuntime;
 * these markers intentionally contain no executable duplicate verifier logic.
 *
...
function verificationProjection(result = {}) {
  ...
  return {
    ...
    product_completion_criteria_contract: completionCriteria.contract,
    ...
    product_completion_criteria_evidence: completionCriteria.criteria_evidence,
    product_completion_criteria_referenced_operations:
      completionCriteria.referenced_operations,
    product_completion_criteria_referenced_operation_count:
      completionCriteria.referenced_operation_count,
    product_completion_criteria_verified: completionCriteria.verified,
    product_completion_criteria_authorization_effect:
...
export function verifyCompletedCodeAIAutonomousMissionState(state = {}) {
  verifyCodeMissionStateAttestation(state);
  assertCodeProductCompletionCriteriaVerified(
    state,
...
export const CodeAIAutonomousExecutionStateRuntime = Object.freeze({
  ...
  verifyCompletedMissionState: verifyCompletedCodeAIAutonomousMissionState,
});
