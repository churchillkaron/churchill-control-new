...
const LESSONS = Object.freeze({
  ...
  TS_COMPILER_EXPORTED_TYPE_REMOVED:
    "Preserve compiler-resolved exported TypeScript contracts across cross-file refactors.",
  TS_COMPILER_EXPORTED_TYPE_PROPERTY_REMOVED:
    "Preserve compiler-resolved inherited or aliased public TypeScript properties unless dependents are coherently migrated and reverified.",
  TS_COMPILER_EXPORTED_TYPE_PROPERTY_OPTIONALITY_CHANGED:
    "Preserve compiler-resolved public TypeScript property optionality unless the public contract is intentionally migrated and reverified.",
  TS_COMPILER_PARAMETER_PROPERTY_REMOVED:
    "Preserve compiler-resolved cross-file input properties accepted by exported functions.",
  TS_COMPILER_PARAMETER_OPTIONAL_PROPERTY_TIGHTENED:
    "Do not make compiler-resolved optional cross-file input properties required without a coherent migration.",
  TS_COMPILER_RETURN_PROPERTY_REMOVED:
    "Preserve compiler-resolved cross-file return properties promised by exported functions.",
  TS_COMPILER_RETURN_REQUIRED_PROPERTY_WEAKENED:
    "Do not weaken compiler-resolved required return properties to optional without a coherent migration.",
  TS_COMPILER_EXPORTED_TYPE_GENERIC_ARITY_CHANGED:
    "Preserve compiler-resolved exported generic arity unless every dependent instantiation is intentionally migrated and reverified.",
  TS_COMPILER_FUNCTION_GENERIC_ARITY_CHANGED:
    "Preserve compiler-resolved exported function generic arity unless every dependent call site is intentionally migrated and reverified.",
