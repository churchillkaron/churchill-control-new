...
import { executeIntelligenceLocalQueueAndWait } from "../../platform/service-runtime/providers/avantiqo-intelligence/AvantiqoIntelligenceLocalQueueRuntime.js";
...
async function researchDesignReferences({ organizationId, userMessage, experienceKind = "marketing-site" }) {
  try {
    const module = await import("../../platform/research/runtime/OperatorPublicSearchDiscoveryRuntime.js");
