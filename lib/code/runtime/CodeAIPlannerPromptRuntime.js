...
function compactRepositoryGuidance(value, profile = "normal") {
  ...
  return {
    ...
    instructions_text: boundedText(
      ...
      minimal ? 900 : reduced ? 1700 : MAX_REPOSITORY_GUIDANCE_INSTRUCTIONS,
    ),
    verification_commands_text: boundedText(
      source.verification_commands_text,
      minimal ? 500 : reduced ? 900 : MAX_REPOSITORY_GUIDANCE_COMMANDS,
    ),
    ci_workflows_text: boundedText(
      source.ci_workflows_text,
      minimal ? 240 : reduced ? 400 : MAX_REPOSITORY_GUIDANCE_WORKFLOWS,
    ),
    monorepo_summary: boundedText(source.monorepo_summary, minimal ? 300 : 600),
    instruction_scope_rule: boundedText(source.instruction_scope_rule, minimal ? 300 : 600),
...
function transportState(state, repositoryGuidance, profile = "normal") {
  ...
  return {
    ...
    tests: newestWithinBudget(
      ...
      minimal ? 900 : reduced ? 1500 : 2600,
      minimal ? 2 : reduced ? 3 : 4,
    ),
    ...
    source_read_evidence: newestWithinBudget(
      sourceReads,
      minimal ? 3000 : reduced ? 4400 : 6400,
      minimal ? 2 : reduced ? 3 : 4,
    ),
    ...
    evidence: newestWithinBudget(
      rollingEvidence,
      minimal ? 900 : reduced ? 1700 : 3000,
      minimal ? 5 : reduced ? 6 : 8,
    ),
