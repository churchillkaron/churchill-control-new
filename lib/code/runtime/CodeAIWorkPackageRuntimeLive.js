...
function promptTransport({ objective, objectiveContext, state, callNumber, budget }) {
  ...
  const repairGuidance = repair
    ? "This is a repair pass. Use current_source_changes and latest_failed_verification. Do not reread stale source. Apply the coherent repair, verify, then review diff."
    : null;
