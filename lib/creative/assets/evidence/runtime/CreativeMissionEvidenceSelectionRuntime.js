...
const ROLE_PATTERNS = Object.freeze({
  LOCATION: /\b(location|venue|entrance|exterior|interior|architecture|building|facade|doorway|restaurant|bar|room|street|environment|scene plate|source plate)\b/i,
  IDENTITY: /\b(identity|person|portrait|staff|employee|team|guest|customer|host|waiter|server|chef|manager|talent|cast|character|people)\b/i,
  WARDROBE: /\b(wardrobe|uniform|clothing|costume|outfit|apparel|shirt|dress|jacket|styling)\b/i,
  PRODUCT: /\b(product|food|dish|meal|drink|cocktail|beer|wine|bottle|glass|menu|packaging|item|prop|equipment)\b/i,
  BRAND: /\b(brand|logo|wordmark|emblem|signage|sign|label|typography)\b/i,
  TEXT: /\b(text|copy|title|caption|menu|label|typography|wording)\b/i,
  STYLE: /\b(style|mood|lighting|colour|color|composition|cinematography|aesthetic|treatment)\b/i,
});
