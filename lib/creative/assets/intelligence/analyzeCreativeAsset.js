...
} from "../../../platform/service-runtime/execution/ServiceExecutionRuntime.js";
...
Return strict JSON only:
{
  ...
  "semantic_fitness":{
    "visually_identifiable_location":{"identifiable":false,"name":"","confidence":0,"anchors":[],"generic_environment_only":true},
    "visibly_supported_profession":{"identifiable":false,"profession":"","confidence":0,"evidence":[]},
    "cinematic_reference_value":{"score":0,"composition":"","depth":"","lighting":"","material_truth":"","specificity":"","limitations":[]}
  },
...
- Treat filenames, page titles, URLs, search-result labels, EXIF, businessProfile and other context as provenance only. They may never prove what a viewer can identify in the pixels.
- A generic tropical coast must NOT be called Phuket merely because metadata says Phuket. visually_identifiable_location.identifiable may be true only when the pixels contain sufficiently specific visual anchors; otherwise set generic_environment_only true and leave name empty.
- A generic office, building, laptop, calculator, paperwork or business website image must NOT be called accounting merely because the source company is an accounting firm. visibly_supported_profession.identifiable may be true only when visible actions, objects, documents or setting together make that profession legible to a viewer.
- Cinematic reference value is separate from semantic truth. High resolution or beauty cannot compensate for wrong location/profession evidence.
