import * as Repository from "../repositories/CreativeAssetRepository.js";
import * as CreativeProjectRepository
from "../../projects/repositories/CreativeProjectRepository.js";
...
} from "../intelligence/planner/mergeCreativeAssetNodeEvidence.js";
import {
  projectPrimarySoundtrackAsset,
} from "../intelligence/planner/projectPrimarySoundtrackAsset.js";
...
async function projectAssets({
  ...
  const withSoundtrack = projectPrimarySoundtrackAsset({
    project,
...
export const CreativeAssetsRuntime = {
  async list(params = {}) {
    ...
    if (!selectedIds.size) {
      const projected = await projectAssets({
        assets: uniqueById(direct),
        organization_id: organizationId,
        creative_project_id: projectId,
        project,
      });
      return projected.map(normalize);
    }
