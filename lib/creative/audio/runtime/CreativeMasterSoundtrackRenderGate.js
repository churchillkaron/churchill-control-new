  ...
  CreativeEdlRenderRuntime.render = async function renderWithMasterSoundtrackGate(input = {}) {
    ...
    const tracks = {
      ...
      master_soundtrack: {
        ...
        gain: 1,
        audio_studio_qc_sealed: master.audio_studio_qc_sealed === true,
        audio_studio_qc_seal_hash: master.audio_studio_qc_seal_hash,
        audio_studio_finish_task_id: master.audio_studio_finish_task_id,
      },
    };
    const exportProfile = {
    ...
    const updated = await AssetGraphRepository.update(result.render.id, {
      ...
      metadata: {
        ...
        audio_studio_qc_seal_hash: master.audio_studio_qc_seal_hash,
        audio_studio_finish_task_id: master.audio_studio_finish_task_id,
        audio_studio_master_id: master.audio_studio_master_id,
        audio_studio_master_checksum: master.audio_studio_master_checksum,
