...
const ENGINES=Object.freeze([
  ...
  {id:"MATCHMOVE_3D",prepaid:true,visual:false,contracts:["CREATIVE_OPENCV_MATCHMOVE_EXECUTION_V1","AVANTIQO_MATCHMOVE_AUTHORITY_V1","AVANTIQO_PROFESSIONAL_MATCHMOVE_AUTHORITY_V1"]},
  {id:"ROTO_MATTING",prepaid:true,visual:true,contracts:["CREATIVE_OPENCV_ROTO_EXECUTION_V1","AVANTIQO_ROTO_MATTE_AUTHORITY_V1","AVANTIQO_PROFESSIONAL_ROTO_MATTING_V1"]},
  {id:"LAYERED_COMPOSITING",prepaid:true,visual:true,contracts:["AVANTIQO_AOV_COMPOSITING_V1","AVANTIQO_LAYERED_COMPOSITING_RENDER_V1","AVANTIQO_PROFESSIONAL_COMPOSITING_GRAPH_V1","AVANTIQO_DEEP_EXR_COMPOSITING_V1"]},
  {id:"LENS_SENSOR_OPTICS",prepaid:true,visual:true,contracts:["AVANTIQO_LENS_SENSOR_PROFILE_V1","CREATIVE_OPTICAL_FINISHING_V1","AVANTIQO_LENS_STMAP_CALIBRATION_V1"]},
  {id:"COLOR_DI",prepaid:true,visual:true,contracts:["AVANTIQO_COLOR_MANAGEMENT_AUTHORITY_V1","AVANTIQO_COLOR_FINISHING_V1","AVANTIQO_ACES_AMF_HANDOFF_V1"]},
  {id:"EDITORIAL_PICTURE_LOCK",prepaid:true,visual:true,contracts:["CREATIVE_DIRECTED_EDIT_TIMELINE_V1","CREATIVE_EDIT_PREPARATION_V1","AVANTIQO_CMX3600_EDL_HANDOFF_V1","AVANTIQO_OTIO_EDITORIAL_HANDOFF_V1","AVANTIQO_AAF_EDITORIAL_HANDOFF_V1"]},
  {id:"RENDER_FARM",prepaid:true,visual:false,contracts:["AVANTIQO_RENDER_FARM_V1","AVANTIQO_RENDER_FARM_EXECUTION_V1","AVANTIQO_DISTRIBUTED_RENDER_WORKER_V1"]},
  {id:"PRODUCTION_STAGING",prepaid:true,visual:false,contracts:["AVANTIQO_PRODUCTION_STAGING_V1","AVANTIQO_VFX_VERSION_PUBLISH_CACHE_V1"]},
  {id:"TEMPORAL_4K_UPSCALE",prepaid:true,visual:true,contracts:["AVANTIQO_TEMPORAL_SUPER_RESOLUTION_V1"]},
  {id:"ADVANCED_DELIVERY",prepaid:true,visual:false,contracts:["AVANTIQO_ADVANCED_DELIVERY_AUTHORITY_V1"]},
