...
export const CHURCHILL_FROZEN_NIGHT_HERO = Object.freeze({
  ...
  required_layers: Object.freeze([
    ...
    Object.freeze({
      id: "singer",
      source_kind: "authentic_asset",
      asset_id: "370a3030-8656-4b28-934f-6653d5eaf3c8",
    ...
    Object.freeze({
      id: "band",
      source_kind: "authentic_asset",
      asset_id: "cb027610-625c-4751-99a0-6a41b3597237",
  ...
  visual_rules: Object.freeze([
    ...
    "Every visible registered venue zone must originate from an authentic source asset.",
    ...
    "Pool must remain orange/amber registered-source geometry.",
  ]),
});
