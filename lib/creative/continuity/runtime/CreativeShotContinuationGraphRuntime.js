    ...
    nodes.push(createProductionNode({
      ...
      requirements: {
        ...
        virtual_camera_state:
          shot.virtual_camera_state ||
          currentNode.requirements?.virtual_camera_state ||
          {},
        ...
        subject: shot.subject || currentNode.requirements?.subject || "",
        actors: list(shot.actors || currentNode.requirements?.actors),
        lighting: shot.lighting || currentNode.requirements?.lighting || {},
        environmental_continuity_state:
          shot.environmental_continuity_state ||
          currentNode.requirements?.environmental_continuity_state ||
          {},
        pursuit_spatial_choreography:
          shot.pursuit_spatial_choreography ||
          currentNode.requirements?.pursuit_spatial_choreography ||
          {},
        pursuit_performance_choreography:
          shot.pursuit_performance_choreography ||
          currentNode.requirements?.pursuit_performance_choreography ||
          {},
        editorial_causality:
          shot.editorial_causality ||
          currentNode.requirements?.editorial_causality ||
          {},
        generation_strategy:
          shot.generation_strategy ||
          currentNode.requirements?.generation_strategy ||
          {},
        previsualization_blueprint:
          currentNode.requirements?.previsualization_blueprint || {},
      ...
      metadata: {
        ...
        image_studio_closing_authority_required: true,
      },
    }));
  }
  ...
  if (!existingReview) {
    nodes.push(createProductionNode({
      ...
      requirements: {
        ...
        minimum_composition_score: 94,
        minimum_identity_score: references.identity_expected ? 96 : 0,
        response_schema: {
          passed: "boolean",
          ...
          camera_authority_preserved: "boolean",
          continuity_state_preserved: "boolean",
          material_truth_preserved: "boolean",
          performance_state_preserved: "boolean",
