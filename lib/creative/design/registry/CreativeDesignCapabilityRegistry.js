const CAPABILITIES = Object.freeze({
  ...
  "creative.design.layout.inspect": Object.freeze({
    id: "creative.design.layout.inspect",
    name: "Design Collision Inspection",
    execution: "DETERMINISTIC_FAIL_CLOSED",
    user_facing: false,
    provider_required: false,
    produces: "DESIGN_COLLISION_REPORT",
  }),
  "creative.design.paginate": Object.freeze({
    id: "creative.design.paginate",
    name: "Deterministic Design Pagination",
    execution: "DETERMINISTIC_FAIL_CLOSED",
    user_facing: false,
    provider_required: false,
    produces: "STRUCTURED_DESIGN_DOCUMENT",
...
export const CREATIVE_DESIGN_CAPABILITY_CONTRACT = Object.freeze({
  contract: "CREATIVE_DESIGN_CAPABILITY_REGISTRY_V2",
  ...
  pagination_business_truth_mutation_forbidden: true,
  collision_inspection_fail_closed: true,
