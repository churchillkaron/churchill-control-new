...
export const AVANTIQO_FONT_LIBRARY = Object.freeze([
  ...
  family({ id: "playfairdisplay", name: "Playfair Display", category: "SERIF", roles: ["LUXURY", "EDITORIAL", "DISPLAY"], priority: 200 }),
  ...
  family({ id: "cormorantgaramond", name: "Cormorant Garamond", category: "SERIF", roles: ["LUXURY", "FASHION", "EDITORIAL"], priority: 230 }),
  family({ id: "sourceserif4", name: "Source Serif 4", category: "SERIF", roles: ["DOCUMENT", "EDITORIAL", "REPORT"], priority: 240 }),
  family({ id: "lora", name: "Lora", category: "SERIF", roles: ["EDITORIAL", "DOCUMENT", "LONGFORM"], priority: 250 }),
