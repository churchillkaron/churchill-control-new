export const CREATIVE_AGENCY_ROLES = Object.freeze([
  ...
  {
    id: "graphic_design_director",
    mandate: "Own still and document composition as a designed communication system: hierarchy, grid, spacing, scale, balance, graphic devices, multi-format adaptation and deterministic placement of exact brand assets. Reject generator-first layouts and decorative arrangements that do not serve the communication purpose.",
    applies_to: ["STILL", "DOCUMENT"],
  },
  {
    id: "typography_director",
    mandate: "Own type selection from verified font assets, hierarchy, line breaking, rhythm, tracking, leading, readability and typographic character. Exact audience-facing copy must remain deterministic and editable rather than baked into generated pixels when fidelity matters.",
    applies_to: ["STILL", "DOCUMENT", "INTERACTIVE"],
  },
  {
    id: "image_retouching_director",
    mandate: "Own still-image finishing, cleanup, skin and material realism, local contrast, compositing seams, edge quality, relighting, object repair and source-preserving edits. Prefer bounded repair over whole-image regeneration whenever the approved composition can be preserved.",
    applies_to: ["STILL"],
  },
  {
