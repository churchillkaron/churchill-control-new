...
const COMMON_CONTRACT = Object.freeze({
  ...
  role_decisions:
    "Decision record for every registered agency role. Each role must explicitly be ACTIVE or NOT_REQUIRED. applies_to defines workflow eligibility, not automatic activation. Choose ACTIVE only when that discipline is genuinely needed by the mission and plan; eligible roles may be NOT_REQUIRED when a concrete decision explains why. Active roles require concrete decision, evidence, confidence, risks and repair instructions.",
  quality:
