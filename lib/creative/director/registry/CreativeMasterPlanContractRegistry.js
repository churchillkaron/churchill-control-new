...
const TEMPORAL_SCHEMA = Object.freeze({
  ...
  shot: Object.freeze({
    ...
    first_pass_intent:
      "Mandatory pre-generation authoring contract containing story_delta, visible_event, edit_reason, continuity_anchor, sound_picture_event and predicted_failure. The director must solve these before generation; downstream review is a backstop, not the authoring mechanism.",
    device:
