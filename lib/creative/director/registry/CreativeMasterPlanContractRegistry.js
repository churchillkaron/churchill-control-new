...
const COMMON_CONTRACT = Object.freeze({
  ...
  deliverables: Object.freeze({
    ...
    production_steps:
      "For UNIVERSAL executors, an explicit ordered capability plan. Every step must define id, title, purpose, service, capability, dependencies, output_spec, requirements and quality_gate. Every service/capability pair must come from context.available_production_capabilities. Provider names, prompts and provider parameters are forbidden here.",
  }),
  ...
  production: Object.freeze({
    ...
    cross_deliverable_steps:
      "Optional workflow-level capability steps that depend on finished deliverables, such as coherence, integration or system-level quality. Every service/capability pair must come from context.available_production_capabilities. Provider prompts are forbidden.",
  }),
  role_decisions:
