...
const CREATIVE_EXCELLENCE_GATE = Object.freeze({
  ...
  anti_cliche_test:
    "Identify the most likely category, AI-generation and advertising clichés for this exact mission and deliberately design against them. Rejected patterns must be mission-specific, not generic statements such as avoid generic content. These specific constructions are treated as advertising filler wherever they appear in the direction and must not be used: elevate your, unforgettable experience, the tagline form where X meets Y, more than just, discover the difference, unlock potential, redefine in any form, your or their journey and journey begins, premium experience, seamless or seamlessly, innovative solutions, cutting-edge, game-changer, transform your. Describing an audience journey or a customer journey is ordinary strategy language and is not what this forbids. Do not merely avoid these words: each one stands in for craft that has not been decided yet, so replace it with the observable execution it gestures at, exactly as craft_translation requires. A single one of them used three times is enough to fail this direction outright.",
  medium_necessity:
