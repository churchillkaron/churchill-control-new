...
function cameraPlatform(camera = {}) {
  ...
  if (/dolly|track|truck/.test(value)) return "DOLLY_TRACK";
  if (/crane|jib/.test(value)) return "CRANE_JIB";
  if ((/pan|tilt/.test(value)) && (/fluid|tripod/.test(value))) return "FLUID_HEAD_TRIPOD";
