...
function reviewPayload({ reviewer, context, plan, floor }) {
  ...
  return {
    ...
    rules: [
      ...
      "Before claiming required evidence is missing, inspect reviewer_scoped_evidence and the full plan. If the evidence is present, judge its quality and sufficiency instead of claiming absence.",
