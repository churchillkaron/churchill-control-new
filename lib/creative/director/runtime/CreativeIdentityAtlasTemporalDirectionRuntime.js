...
import {
  CreativePersistentSubjectLockRuntime,
} from "@/lib/creative/identity/runtime/CreativePersistentSubjectLockRuntime";
...
export const CreativeIdentityAtlasTemporalDirectionRuntime = {
  async create(input = {}) {
    ...
    const plan = CreativePersistentSubjectLockRuntime.attachToPlan(
