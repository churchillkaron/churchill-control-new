...
export const CreativeMasterPlanRuntime = Object.freeze({
  ...
  async create({
    ...
    try {
      ...
      const missionBoundPlan = defer_semantic_mission_contract === true
        ? { ...policyBoundPlan, semantic_mission_contract: null }
        : applySemanticMissionContract(policyBoundPlan, { mission, project, brief });
      let plan = applyDerivedRoleDecisions(
        missionBoundPlan,
        CREATIVE_MASTER_PLAN_ROLES,
      );
