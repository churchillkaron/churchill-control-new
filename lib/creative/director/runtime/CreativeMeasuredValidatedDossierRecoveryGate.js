...
const INSTALL_FLAG = Symbol.for(
  "avantiqo.creative.measured-validated-dossier-recovery-gate.v1",
);
const CONTRACT =
  "CREATIVE_MEASURED_VALIDATED_DOSSIER_RECOVERY_GATE_V1";
...
function install() {
  ...
  CreativeMeasuredUniversalTemporalDirectionRuntime.create =
    async function createWithMeasuredValidatedDossierRecovery(
      ...
      return attachGateEvidence(recovered, project);
    };
}
