  ...
  return JSON.stringify({
    ...
    required_output: {
      ...
      protected_opening_strategy: {
        ...
        opening_story_form: "multiple independent real-world signals across places and systems that gradually feel connected, without revealing a single operational cause",
    ...
    mandatory_rules: [
      ...
      "The protected opening threshold may reveal that the world is connected or that an intelligence is present, but it must not reveal that the preceding places were all caused by one ordinary business event. That causal proof belongs to Chapter Two or later.",
