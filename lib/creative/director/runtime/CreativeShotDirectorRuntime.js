...
export const CreativeShotDirectorRuntime = {
  async direct({
    ...
    try {
      ...
      if (error.code !== "CREATIVE_DIRECTOR_UNKNOWN_REFERENCE_ASSET") {
        throw error;
      }
