...
const CONTRACT = "AVANTIQO_STORY_ESCALATION_V1";
const SCENE_CONTRACT = "AVANTIQO_STORY_ESCALATION_SCENE_V1";
const SHOT_CONTRACT = "AVANTIQO_STORY_ESCALATION_SHOT_V1";
