...
- Do not emit provider_prompt, negative_prompt or any other provider prompt text. The shot's own direction is the source the execution transport derives the prompt from, so that direction must be complete enough to execute without interpretation.
- Everything a negative prompt would carry belongs in negative_constraints as direction.
