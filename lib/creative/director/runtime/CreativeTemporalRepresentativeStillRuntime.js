import { CreativeHeroSubjectProminenceRuntime } from "./CreativeHeroSubjectProminenceRuntime.js";
import { CreativeHeroSpatialCompositionRuntime } from "./CreativeHeroSpatialCompositionRuntime.js";
...
export const CreativeTemporalRepresentativeStillRuntime = Object.freeze({
  ...
  select({ shot = {} } = {}) {
    ...
    const prominence = CreativeHeroSubjectProminenceRuntime.create({ shot, representative: { frame_source: selected.source } });
    const spatialComposition = CreativeHeroSpatialCompositionRuntime.create({ shot, representative: { frame_source: selected.source } });
    ...
    return {
      ...
      hero_subject_prominence: prominence,
