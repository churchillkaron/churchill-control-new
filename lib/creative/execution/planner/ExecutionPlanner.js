...
export function buildExecutionPlan({
  ...
  plan.steps = nodes
    ...
    .map((node) => {
      ...
      const referenceAssets = list(requirements.reference_assets);
      ...
      return createExecutionStep({
        ...
        input: {
          ...
          intent: stripPrompts(node.intent || {}),
          requirements,
          source_assets: stripPrompts(sourceAssets),
          reference_assets: stripPrompts(referenceAssets),
          reference_asset_ids: list(requirements.reference_asset_ids),
          generation,
          provider_parameters: stripPrompts(generation.provider_parameters || {}),
        ...
        metadata: {
          ...
          execution_metadata_allowlisted: true,
