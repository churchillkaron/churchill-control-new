...
function visualInstruction(input = {}, context = {}) {
  ...
  return [
    ...
    context.generation_envelope?.contract === "CREATIVE_VIDEO_GENERATION_ENVELOPE_V1"
      ? "The structured generation envelope is the creative source of truth. This text is only a transient model-compatibility serialization and must not override, weaken, reinterpret or replace the envelope."
      : null,
    "The Shot Cinematic DNA is a release-blocking directing contract, not descriptive metadata. Execute its visual hierarchy, scale role, iconic-frame target, composition, depth, camera philosophy, lighting, atmosphere, human consequence, place causality, material behavior, sonic-picture role and anti-generic constraints. A merely photoreal result that misses this graphic intent is a failed shot.",
