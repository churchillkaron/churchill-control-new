...
function visualInstruction(input = {}, context = {}) {
  ...
  return [
    ...
    targetedRepair
      ...
      : null,
    "Treat every structured field as binding: story purpose, visible subject, exact action over time, performance, opening/progression/closing frames, camera, lighting, production design, signature-frame design, continuity, source-asset identity, output specification, negative constraints, failure modes, and repair rules.",
    ...
    "Before motion, preserve the approved signature-frame design as visual authority. The moving result must contain at least one frame that still reads as campaign-grade key art with the approved graphic silhouette, depth layering, material-light event, controlled palette and emotional focal detail.",
    ...
    "Reject generic AI beauty, synthetic skin, repeated perfect geometry, evenly spaced natural forms, plastic bark/foliage, clean CG corridors, floating haze, decorative beams, fake rain, texture boiling, overprocessed color, game-camera blocking and any result whose production value depends on blur or camera motion rescuing a weak frame.",
    "For moving humans, do not default to a centered rear-follow or body-height third-person chase view. Rear views require the explicit approved anti-game-camera rationale and must create new spatial or emotional information rather than merely following an avatar.",
    section("Targeted QA repair specification", repairSpecification),
    section("Release-blocking Shot Cinematic DNA", context.cinematic_dna),
