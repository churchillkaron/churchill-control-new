...
export const CreativeIdentityKeyframeGraphRuntime = {
  apply({ graph, shots = [] } = {}) {
    ...
    if (graph.metadata?.image_studio_is_upstream_asset_authority === true) {
      const nodes = list(graph.nodes).map((node) => {
        ...
        return {
          ...
          requirements: {
            ...
            image_studio_identity_authority_required: true,
          },
          generation: {
          ...
          metadata: {
            ...
            legacy_identity_keyframe_suppressed_by_image_studio: true,
          },
        };
      });
      return {
        ...
        metadata: {
          ...
          identity_keyframe_contract: "IMAGE_STUDIO_IDENTITY_AUTHORITY_V1",
          identity_keyframe_count: 0,
          identity_keyframes: [],
          legacy_identity_keyframe_generation_suppressed: true,
        },
      };
    }
