...
export function buildImageProductionPackage({task={},asset_nodes=[],previsualization_authority=null}={}){
  ...
  let threatPack=null;
  let governedThreatKey=foundationAuthority.threat_identity_key||requestedThreatKey;
  if(threat(r)){
    ...
    const base=!governedThreatKey&&threatSelection.candidate_count>1?null:threatSelection.selected;
