...
export function validate({ payload = {} }) {
  ...
  if (intentionalEdit) {
    if (!text(payload.creative_project_id) || !text(payload.master_asset_id) || !text(payload.intended_delta || payload.objective)) {
...
export async function execute({ context, payload = {} }) {
  if (text(payload.expected_change_set_fingerprint) && text(payload.master_asset_id)) {
