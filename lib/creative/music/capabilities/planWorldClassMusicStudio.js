...
export async function execute({ context, payload = {} }) {
  ...
  const listeningContext = buildMusicListeningContext({
    evidence: conversationContext.listening_evidence,
    current: conversationContext,
    sections: conversationContext.approved_sections,
  });
  ...
  return {
    ...
    music_listening_evidence: conversationContext.listening_evidence || null,
