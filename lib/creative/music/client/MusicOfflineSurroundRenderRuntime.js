...
import { buildMusicImmersiveScene } from "../runtime/CreativeMusicImmersiveSceneRuntime.js";
...
export async function renderMusicSurroundPremasterOffline({ session, assetUrls, expectedDurationSeconds = null, renderWindow = null } = {}) {
  ...
  const immersiveScene = buildMusicImmersiveScene(session);
  ...
  return {
    ...
    immersive_scene: immersiveScene,
