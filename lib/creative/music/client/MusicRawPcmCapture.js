...
export async function startMusicRawPcmCapture({
  ...
  function materializePass({ allowEmpty = false } = {}) {
    ...
    const capture_qc = analyzeMusicCaptureQc(channels, context.sampleRate, { chunk_gap_count: chunkGapCount, frame_discontinuity_count: frameDiscontinuityCount, expected_frame_count: expectedFrameStart });
