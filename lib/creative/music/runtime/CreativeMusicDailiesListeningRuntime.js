...
function reviewPolicyViolations({ result = {}, rendered = {} } = {}) {
  ...
  if (/(section boundary|boundary at|no boundary|closest boundary)/.test(failureText) && /(strings?|vocal|percussion|resolution|integrated strength|fragile emergence|transition)/.test(failureText)) {
...
export async function runMusicDailiesListening({ organization_id, creative_project_id = null, asset = {}, binding = {}, master_report = {}, translation_qc = null } = {}) {
