...
async function reviewFamily({ organization_id, family, mandate, intended, rendered, binding }) {
  const response = await creativeReason({
    ...
    outputShape: { score: 0, passed: false, evidence: ["string"], failures: ["string"], repair: ["string"] },
    temperature: 0.2,
  });
...
export async function runMusicDailiesListening({ organization_id, asset = {}, binding = {}, master_report = {} } = {}) {
