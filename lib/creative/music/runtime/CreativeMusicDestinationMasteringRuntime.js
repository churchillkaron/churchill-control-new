export const MUSIC_MASTERING_DESTINATION_CONTRACT = "AVANTIQO_MUSIC_MASTERING_DESTINATION_V1";

const PROFILE_DEFINITIONS = Object.freeze({
  streaming: Object.freeze({ id: "streaming", label: "Streaming", target_lufs: -14, true_peak_dbtp: -1, loudness_range_lu: 8, sample_rate: 48000, channels: 2, deliveries: ["wav", "mp3"] }),
  video_web: Object.freeze({ id: "video_web", label: "Web video", target_lufs: -14, true_peak_dbtp: -1, loudness_range_lu: 10, sample_rate: 48000, channels: 2, deliveries: ["wav", "aac"] }),
  film_video_music: Object.freeze({ id: "film_video_music", label: "Film / video music", target_lufs: -18, true_peak_dbtp: -2, loudness_range_lu: 12, sample_rate: 48000, channels: 2, deliveries: ["wav"] }),
  club: Object.freeze({ id: "club", label: "Club playback", target_lufs: -9, true_peak_dbtp: -0.8, loudness_range_lu: 6, sample_rate: 48000, channels: 2, deliveries: ["wav", "mp3"] }),
  live_backing: Object.freeze({ id: "live_backing", label: "Live backing track", target_lufs: -12, true_peak_dbtp: -1, loudness_range_lu: 8, sample_rate: 48000, channels: 2, deliveries: ["wav"] }),
  archival: Object.freeze({ id: "archival", label: "Archival master", target_lufs: -18, true_peak_dbtp: -3, loudness_range_lu: 14, sample_rate: 48000, channels: 2, deliveries: ["wav", "flac"] }),
});
...
function variantKey(profile) {
  return [profile.target_lufs, profile.true_peak_dbtp, profile.loudness_range_lu, profile.sample_rate, profile.channels].join(":");
}
...
export function buildMusicDestinationMasteringPlan(input = {}) {
  ...
  return Object.freeze({
    ...
    reasoning_brief: variants.map((variant) => `${variant.destinations.join(" + ")}: ${variant.target_lufs} LUFS target, ${variant.true_peak_dbtp} dBTP ceiling; ${variant.deliveries.join("/")} delivery.`),
