...
function compactSemantic(analysis = {}) {
  ...
  return {
    ...
    rhythm_intelligence: semantic.rhythm_intelligence || null,
    melody_intelligence: semantic.melody_intelligence || null,
    form_intelligence: semantic.form_intelligence || null,
    melody_analysis_ready: semantic.melody_analysis_ready === true,
    form_analysis_ready: semantic.form_analysis_ready === true,
    rhythm_analysis_ready: semantic.rhythm_analysis_ready === true,
