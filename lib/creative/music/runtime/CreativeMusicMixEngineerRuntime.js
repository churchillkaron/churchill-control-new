...
function evidenceFingerprint(bundle={}){return hash({contract:bundle?.contract||null,tracks:(bundle?.tracks||[]).map(r=>({track_id:r.track_id,measured:r.measured===true,mean_db:r.mean_db??null,peak_dbfs:r.peak_dbfs??null,crest_proxy_db:r.crest_proxy_db??null,sub_vs_lowmid_db:r.sub_vs_lowmid_db??null,presence_vs_lowmid_db:r.presence_vs_lowmid_db??null,air_vs_presence_db:r.air_vs_presence_db??null,sibilance_vs_presence_db:r.sibilance_vs_presence_db??null,warmth_vs_lowmid_db:r.warmth_vs_lowmid_db??null,boxiness_vs_warmth_db:r.boxiness_vs_warmth_db??null,boxiness_vs_presence_db:r.boxiness_vs_presence_db??null,stereo_correlation:r.stereo_correlation??null,mono_fold_down_loss_db:r.mono_fold_down_loss_db??null,stereo_phase_risk:r.stereo_phase_risk===true,integrated_lufs:r.integrated_lufs??null,true_peak_dbtp:r.true_peak_dbtp??null,loudness_range_lu:r.loudness_range_lu??null,dynamics_envelope:r.dynamics_envelope||[]})),relationships:bundle?.relationships||[]});}
function role(track={}){
