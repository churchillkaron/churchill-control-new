...
export function createMusicTrack(input = {}) {
  ...
  return {
    ...
    audio_role: normalizeProfessionalAudioRole(input.audio_role, type === "vocal" ? "SONG_VOCAL" : ["guitar","bass","keys","drums","instrument","backing"].includes(type) ? "INSTRUMENT" : "PROGRAM"),
