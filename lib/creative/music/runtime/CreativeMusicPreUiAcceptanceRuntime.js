...
export function buildMusicPreUiAcceptance({ provider = {}, capabilities = {}, defer_singing_identity = true } = {}) {
  ...
  const matrix = [
    ...
    row("foley", sfx.production_routing_allowed === true && certified.has("ai.sfx.generate") ? "READY" : "BLOCKED", sfx.production_routing_allowed === true ? "FOLEY_USES_CERTIFIED_SFX_EXECUTION" : "FOLEY_EXECUTION_ENGINE_REQUIRED"),
