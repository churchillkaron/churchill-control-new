...
import { MUSIC_PROFESSIONAL_VOCAL_REVIEW_CONTRACT, MUSIC_PROFESSIONAL_VOCAL_REVIEW_THRESHOLD, MUSIC_PROFESSIONAL_VOCAL_REVIEW_CRITERIA, validateProfessionalVocalListeningReview } from "./CreativeMusicProfessionalVocalReviewRuntime.js";
...
export async function certifyProfessionalVocalProduction(input={}){
  ...
  const listeningReview=validateProfessionalVocalListeningReview(input.human_listening_review);
  ...
  const evidence={ contract:CONTRACT, status:"PASS", corrected_vocal_asset_id:correctedAssetId, human_listening_review_approved:true, human_listening_review:listeningReview, approved_by:text(input.approved_by)||null, approved_at:new Date().toISOString() };
...
export const CreativeMusicProfessionalVocalProductionRuntime=Object.freeze({ contract:CONTRACT, vocalReviewContract:MUSIC_PROFESSIONAL_VOCAL_REVIEW_CONTRACT, vocalReviewThreshold:MUSIC_PROFESSIONAL_VOCAL_REVIEW_THRESHOLD, vocalReviewCriteria:MUSIC_PROFESSIONAL_VOCAL_REVIEW_CRITERIA, validateListeningReview:validateProfessionalVocalListeningReview, prepare:prepareProfessionalVocalProduction, certify:certifyProfessionalVocalProduction });
