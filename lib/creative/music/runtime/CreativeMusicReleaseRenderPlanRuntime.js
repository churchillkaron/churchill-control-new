...
const CONTRACT = "AVANTIQO_MUSIC_RELEASE_RENDER_PLAN_V5";
...
export function buildMusicReleaseRenderPlan(sessionInput = {}, input = {}) {
  ...
  return {
    ...
    exports: {
      ...
      release_wav: { enabled: true, format: "wav", codec: "pcm_s24le", bit_depth: 24, sample_rate: Math.round(finite(session.sample_rate, 48000)), dither_required: true },
