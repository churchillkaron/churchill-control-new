...
export function buildMusicReleaseRenderPlan(sessionInput = {}, input = {}) {
  ...
  return {
    ...
    safety: {
      ...
      silent_midi_omission_forbidden: true,
      release_finish_stage_separate: true, surround_never_silently_folded_to_stereo: true, dolby_branding_requires_licensed_toolchain: true, provider_job_submitted: false, endpoint_mutation_performed: false,
    },
  };
}
