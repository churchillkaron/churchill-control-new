...
export function buildMusicSemanticAnalysis(analysis = {}) {
  ...
  const form = buildMusicFormIntelligence(analysis);
  return Object.freeze({
    ...
    rhythm_intelligence: rhythm,
    rhythm_analysis_ready: rhythm.rhythm_analysis_ready === true,
    melody_intelligence: melody,
    melody_analysis_ready: melody.melody_analysis_ready === true,
    form_intelligence: form,
    form_analysis_ready: form.form_analysis_ready === true,
