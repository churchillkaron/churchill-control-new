import { normalizeMusicImmersiveObject } from "./CreativeMusicImmersiveObjectRuntime.js";
...
const LAYOUTS = Object.freeze({
  ...
  "7.1.4": Object.freeze({
    ...
    channel_count: 12,
    speaker_order: ["L", "R", "C", "LFE", "Lrs", "Rrs", "Ls", "Rs", "Tfl", "Tfr", "Tbl", "Tbr"],
    ffmpeg_channel_layout: "7.1.4",
    surround: true,
  }),
});
...
export function normalizeMusicSpatialTrack(input = {}) {
  return {
    ...
    immersive: normalizeMusicImmersiveObject(input.immersive || {}),
...
export function createMusicSpatialAudioConfig(input = {}) {
  ...
  return {
    ...
    immersive_scene: {
      canonical_object_scene_enabled: true,
      ambisonic_master_enabled: true,
      ambisonic_order: 1,
      ambisonic_channel_order: "ACN",
      ambisonic_normalization: "SN3D",
      b_format_channel_labels: ["W", "Y", "Z", "X"],
    ...
    browser_preview: {
      ...
      native_height_monitor_claim_allowed: layout.id === "7.1.4",
    },
  };
}
