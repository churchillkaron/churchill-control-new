...
export async function createMusicVocalCorrectionRequestTask({
  ...
  const task = await ProductionTaskRuntime.create({
    ...
    description: "Durable request for certified isolated-vocal pitch and whole-phrase timing correction. Execution is permitted only through the certified owned Modal vocal-correction capability lane.",
