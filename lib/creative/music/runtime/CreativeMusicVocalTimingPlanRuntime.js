...
export function buildMusicVocalTimingPlan({ analysis } = {}) {
  ...
  return {
    ...
    all_phrases_reviewed: phrases.every((phrase) => phrase.approved),
    ...
    render_ready: false,
    render_blocker: "MUSICIAN_TIMING_PLAN_RENDER_NOT_CONNECTED",
...
export function reviewMusicVocalTimingPhrase(plan = {}, phraseId, input = {}) {
  ...
  next.all_phrases_reviewed = next.phrases.every((entry) => entry.approved);
