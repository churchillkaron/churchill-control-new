...
async function executeGeneratedMusic(input, plan) {
  ...
  return {
    ...
    quality: finalTribunal ? {
      status: finalTribunal.release_ready === true && finishing?.destination_qc_passed === true && finishing?.perceptual_translation_passed === true
        ? "PASS"
      ...
      release_ready: finalTribunal.release_ready === true && finishing?.destination_qc_passed === true && finishing?.perceptual_translation_passed === true,
