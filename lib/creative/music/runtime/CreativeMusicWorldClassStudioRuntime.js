...
export function buildWorldClassMusicStudioPlan(input = {}) {
  ...
  if (["audio_for_video", "cinematic_sound_design", "audio_post", "surround_mix", "immersive_object_audio", "vehicle_acoustic_analysis", "professional_post_stems"].some((id) => selectedIds.has(id))) {
