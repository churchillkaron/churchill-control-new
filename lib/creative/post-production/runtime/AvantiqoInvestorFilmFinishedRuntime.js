...
const EDIT = Object.freeze([
  ["b01", 9.2], ["b08", 5.0], ["b09", 5.0], ["founder01", 9.4],
  ["b02", 9.2], ["b15", 5.0], ["b19", 5.0], ["founder02", 9.4],
  ["b03", 9.0], ["b18", 5.0], ["b04", 9.2], ["b05", 9.2],
  ["b06", 9.2], ["b07", 5.0], ["b20", 5.0], ["b08", 5.0],
  ["b11", 5.0], ["b12", 5.0], ["b10", 5.0], ["b13", 5.0],
  ["b14", 5.0], ["b16", 5.0], ["b17", 5.0], ["founder03", 9.4],
  ["b15", 5.0], ["b14", 5.0], ["b09", 5.0], ["b18", 5.0],
  ["founder04", 9.4], ["b10", 5.0], ["b13", 5.0], ["b07", 5.0],
...
function productScreenSvg() {
  return Buffer.from(`<svg xmlns="http://www.w3.org/2000/svg" width="1080" height="604" viewBox="0 0 1080 604"><rect width="1080" height="604" rx="24" fill="#050607" fill-opacity="0.95" stroke="#c8a96a" stroke-opacity="0.62" stroke-width="2"/><text x="28" y="40" fill="#f5f5f5" font-family="Arial" font-size="24" font-weight="700" letter-spacing="2">AVANTIQO</text><text x="28" y="58" fill="#777a7e" font-family="Arial" font-size="8" letter-spacing="4">SYNTHETIC INTELLIGENCE OS</text><g fill="#9b9da1" font-family="Arial" font-size="9"><text x="28" y="91">HOME</text><text x="87" y="91">COMMERCIAL</text><text x="166" y="91">OPERATIONS</text><text x="244" y="91">SUPPLY CHAIN</text><text x="329" y="91">FINANCE</text><text x="383" y="91">PEOPLE</text><text x="430" y="91">PROJECTS</text><text x="491" y="91">COMPLIANCE</text><text x="568" y="91">DOCUMENTS</text><text x="640" y="91">ANALYTICS</text><text x="705" y="91">SERVICES</text><text x="765" y="91">ADMINISTRATION</text></g><line x1="0" y1="108" x2="1080" y2="108" stroke="#1c1e22"/><rect x="40" y="145" width="486" height="95" rx="20" fill="#07080a" stroke="#292b30"/><text x="60" y="183" fill="#f6f6f6" font-family="Arial" font-size="23">Good Afternoon, User</text><text x="60" y="211" fill="#85888d" font-family="Arial" font-size="12">One operating context across the company.</text><rect x="40" y="258" width="486" height="291" rx="20" fill="#07080a" stroke="#292b30"/><text x="60" y="289" fill="#96999f" font-family="Arial" font-size="11" letter-spacing="3">LIVE BUSINESS STATE</text><g fill="#c7c8ca" font-family="Arial" font-size="12"><text x="60" y="326">Revenue</text><text x="60" y="353">Orders</text><text x="60" y="380">Inventory Alerts</text><text x="60" y="407">Pending Approvals</text></g><g fill="#c8a96a" font-family="Arial" font-size="11" font-weight="700"><text x="386" y="326">CONNECTED</text><text x="386" y="353">CONNECTED</text><text x="386" y="380">CONNECTED</text><text x="386" y="407">CONNECTED</text></g><rect x="545" y="145" width="495" height="404" rx="20" fill="#07080a" stroke="#292b30"/><text x="568" y="180" fill="#c8a96a" font-family="Arial" font-size="11" font-weight="700" letter-spacing="3">COMPANY INTELLIGENCE</text><text x="568" y="222" fill="#f6f6f6" font-family="Arial" font-size="27">Organization intelligence</text><text x="568" y="251" fill="#95979c" font-family="Arial" font-size="12">Talk with Avantiqo about the business, open a workspace,</text><text x="568" y="270" fill="#95979c" font-family="Arial" font-size="12">prepare work or execute connected capabilities.</text><rect x="568" y="302" width="449" height="70" rx="13" fill="#050607" stroke="#26282c"/><text x="588" y="330" fill="#c7c8ca" font-family="Arial" font-size="12">I'm Avantiqo. Ask me about this organization,</text><text x="588" y="351" fill="#c7c8ca" font-family="Arial" font-size="12">tell me what to open, or tell me what you need done.</text><rect x="568" y="490" width="449" height="46" rx="13" fill="#050607" stroke="#26282c"/><text x="588" y="518" fill="#696c71" font-family="Arial" font-size="12">Ask Avantiqo anything...</text><rect x="925" y="497" width="82" height="32" rx="10" fill="#c8a96a"/><text x="951" y="518" fill="#090909" font-family="Arial" font-size="11" font-weight="700">SEND</text></svg>`);
}

function businessSystemMapSvg() {
  return Buffer.from(`<svg xmlns="http://www.w3.org/2000/svg" width="1280" height="720" viewBox="0 0 1280 720"><defs><filter id="g"><feGaussianBlur stdDeviation="5"/></filter></defs><g fill="none" stroke="#c8a96a" stroke-opacity="0.75" stroke-width="1.5"><path d="M274 187 C380 187 430 250 510 300"/><path d="M274 294 C390 294 438 318 510 336"/><path d="M274 401 C395 401 440 374 510 360"/><path d="M274 508 C395 508 438 428 510 390"/><path d="M1006 187 C900 187 850 250 770 300"/><path d="M1006 294 C890 294 842 318 770 336"/><path d="M1006 401 C885 401 840 374 770 360"/><path d="M1006 508 C885 508 842 428 770 390"/></g><g font-family="Arial"><rect x="54" y="145" width="220" height="78" rx="18" fill="#050607" fill-opacity="0.9" stroke="#c8a96a" stroke-opacity="0.46"/><text x="76" y="176" fill="#c8a96a" font-size="10" font-weight="700">COMMERCIAL</text><text x="76" y="200" fill="#f1f1f2" font-size="14">Customers · Growth</text><rect x="54" y="252" width="220" height="78" rx="18" fill="#050607" fill-opacity="0.9" stroke="#c8a96a" stroke-opacity="0.46"/><text x="76" y="283" fill="#c8a96a" font-size="10" font-weight="700">OPERATIONS</text><text x="76" y="307" fill="#f1f1f2" font-size="14">Orders · Dispatch · Jobs</text><rect x="54" y="359" width="220" height="78" rx="18" fill="#050607" fill-opacity="0.9" stroke="#c8a96a" stroke-opacity="0.46"/><text x="76" y="390" fill="#c8a96a" font-size="10" font-weight="700">SUPPLY CHAIN</text><text x="76" y="414" fill="#f1f1f2" font-size="14">Buy · Receive · Stock</text><rect x="54" y="466" width="220" height="78" rx="18" fill="#050607" fill-opacity="0.9" stroke="#c8a96a" stroke-opacity="0.46"/><text x="76" y="497" fill="#c8a96a" font-size="10" font-weight="700">PEOPLE</text><text x="76" y="521" fill="#f1f1f2" font-size="14">Roles · Work · Payroll</text><rect x="1006" y="145" width="220" height="78" rx="18" fill="#050607" fill-opacity="0.9" stroke="#c8a96a" stroke-opacity="0.46"/><text x="1028" y="176" fill="#c8a96a" font-size="10" font-weight="700">FINANCE</text><text x="1028" y="200" fill="#f1f1f2" font-size="14">Invoice · Ledger · Close</text><rect x="1006" y="252" width="220" height="78" rx="18" fill="#050607" fill-opacity="0.9" stroke="#c8a96a" stroke-opacity="0.46"/><text x="1028" y="283" fill="#c8a96a" font-size="10" font-weight="700">COMPLIANCE</text><text x="1028" y="307" fill="#f1f1f2" font-size="14">Obligations · Evidence</text><rect x="1006" y="359" width="220" height="78" rx="18" fill="#050607" fill-opacity="0.9" stroke="#c8a96a" stroke-opacity="0.46"/><text x="1028" y="390" fill="#c8a96a" font-size="10" font-weight="700">DOCUMENTS</text><text x="1028" y="414" fill="#f1f1f2" font-size="14">Context · Records · Proof</text><rect x="1006" y="466" width="220" height="78" rx="18" fill="#050607" fill-opacity="0.9" stroke="#c8a96a" stroke-opacity="0.46"/><text x="1028" y="497" fill="#c8a96a" font-size="10" font-weight="700">ANALYTICS</text><text x="1028" y="521" fill="#f1f1f2" font-size="14">Signals · Decisions</text><rect x="462" y="235" width="356" height="204" rx="28" fill="#030405" fill-opacity="0.93" stroke="#e0c98f" stroke-opacity="0.72" stroke-width="2"/><text x="640" y="285" fill="#c8a96a" font-size="11" font-weight="700" text-anchor="middle">ORGANIZATION CONTEXT</text><text x="640" y="330" fill="#fff" font-size="29" font-weight="700" text-anchor="middle">ONE BUSINESS</text><text x="640" y="359" fill="#d0d1d4" font-size="15" text-anchor="middle">entities · locations · roles · customers</text><text x="640" y="383" fill="#d0d1d4" font-size="15" text-anchor="middle">suppliers · permissions · history</text><text x="640" y="419" fill="#75dbb4" font-size="12" font-weight="700" text-anchor="middle">AI EXECUTION LAYER</text><text x="640" y="604" fill="#d7d8da" font-size="13" text-anchor="middle">CUSTOMER REQUEST  →  SERVICE ORDER  →  DISPATCH  →  PROOF  →  INVOICE  →  LEDGER</text><text x="640" y="654" fill="#c8a96a" font-size="15" font-weight="700" text-anchor="middle">ONE COMPANY · ONE CONTEXT · ONE INTELLIGENCE LAYER</text></g></svg>`);
}
...
async function renderLogoClip(ffmpeg, logoRaw, output, duration, closing = false) {
  await run(ffmpeg, [
    ...
    "-filter_complex", `[0:v]tpad=stop_mode=clone:stop_duration=${duration},setpts=PTS-STARTPTS,format=rgba,zoompan=z='min(zoom+0.00025,1.035)':d=1:s=1280x720:fps=24,fade=t=in:st=${closing ? 0.1 : 0.25}:d=0.75,fade=t=out:st=${Math.max(0, duration - 0.65)}:d=0.6,format=yuv420p[v]`,
    "-map", "[v]", "-an", "-c:v", "libx264", "-preset", "veryfast", "-crf", "17", "-pix_fmt", "yuv420p", "-t", String(duration), output,
  ]);
}

async function renderFounderPlate(ffmpeg, founderImage, output, duration, variant) {
  const increment = [0.000055, 0.00004, 0.000065, 0.000045, 0.00006][variant] || 0.00005;
  const maxZoom = [1.035, 1.028, 1.04, 1.03, 1.038][variant] || 1.035;
  const x = ["iw/2-(iw/zoom/2)", "iw/2-(iw/zoom/2)-8", "iw/2-(iw/zoom/2)+8", "iw/2-(iw/zoom/2)-5", "iw/2-(iw/zoom/2)+5"][variant] || "iw/2-(iw/zoom/2)";
  await run(ffmpeg, [
    "-y", "-loop", "1", "-framerate", "24", "-i", founderImage,
    "-vf", `scale=1360:765:force_original_aspect_ratio=increase,crop=1280:720,zoompan=z='min(zoom+${increment},${maxZoom})':x='${x}':y='ih/2-(ih/zoom/2)':d=1:s=1280x720:fps=24,eq=contrast=1.02:saturation=0.97:brightness=-0.003,unsharp=5:5:0.28:5:5:0.0,format=yuv420p`,
    "-an", "-c:v", "libx264", "-preset", "veryfast", "-crf", "17", "-pix_fmt", "yuv420p", "-t", String(duration), output,
  ]);
}
...
function fitEditToNarration(duration) {
  ...
  for (const [key, requested] of EDIT) {
    ...
    const actual = Math.min(requested, duration - used);
...
export const AvantiqoInvestorFilmFinishedRuntime = {
  ...
  async render() {
    ...
    const directory = await fs.mkdtemp(path.join(os.tmpdir(), "avantiqo-investor-identity-safe-"));
    try {
      const narration = path.join(directory, "narration.mp3");
      const score = path.join(directory, "score.mp3");
      const founderImage = path.join(directory, "approved-founder.jpg");
      ...
      videoSegments.forEach((item, index) => {
        filters.push(`[${index}:v]trim=duration=${item.duration.toFixed(3)},setpts=PTS-STARTPTS,scale=1280:720,fps=24,setsar=1,eq=contrast=1.02:saturation=0.97:brightness=-0.003,format=yuv420p[v${index}]`);
        labels.push(`[v${index}]`);
      });
      ...
      const output = path.join(directory, "avantiqo-investor-film-v4-identity-safe-review.mp4");
      await run(ffmpeg, [
        ...args,
