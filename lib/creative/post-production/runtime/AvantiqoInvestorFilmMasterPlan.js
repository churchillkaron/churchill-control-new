...
export const AVANTIQO_INVESTOR_FILM_MASTER_PLAN = Object.freeze({
  ...
  founder_dialogue_policy: "VOICE_OVER_ONLY_NO_VISIBLE_LIP_SYNC_DEPENDENCY",
  founder_visual_policy: "NON_SPEAKING_MOTION_PROFILE_WORKING_REFLECTIVE_OR_ENVIRONMENTAL_PORTRAIT",
  visible_mouth_sync_required: false,
  visible_mouth_sync_allowed: false,
  ...
  acts: Object.freeze([
    ...
    { id: "origin", film_start: 8, film_end: 48.078, duration: 40.078, audio_start: 0, audio_end: 40.078, source: "FOUNDER_VOICEOVER_PLUS_SEMANTIC_LIVE_ACTION", narration: true },
    ...
    { id: "final-act", film_start: 144.266, film_end: 237.5, duration: 93.234, audio_start: AVANTIQO_INVESTOR_FINAL_ACT_PLAN.audio_start_seconds, audio_end: AVANTIQO_INVESTOR_FINAL_ACT_PLAN.audio_end_seconds, source: "INTEGRATIONS_GOVERNED_AI_CROSS_INDUSTRY_FOUNDER_VOICEOVER_CLOSE", narration: true },
  ]),

  founder_visible_windows: Object.freeze([
    { key: "opening-founder-origin", audio_start: 0, audio_end: 11.391, film_start: 8, film_end: 19.391, duration: 11.391, dialogue_mode: "VOICE_OVER", visible_speaking_forbidden: true },
    { key: "founder-mid-integration", audio_start: 136.266, audio_end: 140.062, film_start: 144.266, film_end: 148.062, duration: 3.796, dialogue_mode: "VOICE_OVER", visible_speaking_forbidden: true },
    { key: "founder-mid-ai", audio_start: 177.188, audio_end: 183.516, film_start: 185.188, film_end: 191.516, duration: 6.328, dialogue_mode: "VOICE_OVER", visible_speaking_forbidden: true },
    { key: "founder-close", audio_start: 219.375, audio_end: 226.125, film_start: 227.375, film_end: 234.125, duration: 6.75, dialogue_mode: "VOICE_OVER", visible_speaking_forbidden: true },
  ]),
  ...
  sound: Object.freeze({
    voice: "LOCKED_CEDAR_V5_SINGLE_FOUNDER_VOICEOVER",
  ...
  release_gates: Object.freeze([
    ...
    "NO_VISIBLE_FOUNDER_LIP_SYNC_DEPENDENCY",
    "FOUNDER_VISUALS_NON_SPEAKING_WHILE_VOICEOVER_PLAYS",
