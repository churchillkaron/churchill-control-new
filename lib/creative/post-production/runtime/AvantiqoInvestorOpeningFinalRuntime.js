...
async function createGlassOverlay(directory, mode) {
  const output = path.join(directory, `glass-${mode}.png`);
  ...
  const svg = Buffer.from(`
    <svg xmlns="http://www.w3.org/2000/svg" width="470" height="400">
      ...
      <text x="34" y="376" font-family="Arial, Helvetica, sans-serif" font-size="11" letter-spacing="1.4" fill="#d9caa8" fill-opacity="0.72">REAL BUSINESS CONTEXT · GOVERNED EXECUTION</text>
    </svg>
  `);
