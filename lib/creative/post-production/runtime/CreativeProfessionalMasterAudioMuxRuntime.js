      ...
      const node = createCreativeAssetNode({
        ...
        metadata: {
          ...
          audio_studio_qc_sealed:
            master_render.metadata?.audio_studio_qc_sealed === true,
          audio_studio_qc_seal_hash:
            master_render.metadata?.audio_studio_qc_seal_hash || null,
          audio_studio_finish_task_id:
            master_render.metadata?.audio_studio_finish_task_id || null,
          audio_studio_master_id:
            master_render.metadata?.audio_studio_master_id || null,
          audio_studio_master_checksum:
            master_render.metadata?.audio_studio_master_checksum || null,
