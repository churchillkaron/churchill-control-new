...
function sceneIntent(scene = {}) {
  return {
    ...
    story_state_before: scene.metadata?.story_state_before || "",
    state_change: scene.metadata?.state_change || "",
    story_state_after: scene.metadata?.story_state_after || "",
    transition_logic: scene.metadata?.transition_logic || "",
