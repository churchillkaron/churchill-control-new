...
export const manifest = defineCapability({
  ...
  action: "inspect",
  description:
    "Inspect the real Creative production queue for one canonical Studio project. Returns bounded queue counts and production state for chat status, verification, and safe continuation. This is read-only and never dispatches providers, spends wallet balance, or publishes.",
  permissions: [REQUIRED_PERMISSION],
  events: [],
  tags: ["creative", "video", "production", "queue", "read", "verification"],
  transactional: false,
  aiEnabled: true,
