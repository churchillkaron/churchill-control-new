...
export const manifest = defineCapability({
  ...
  tags: ["creative", "video", "film", "production", "provider-dispatch", "paid-media", "render", "generate"],
  operatorAliases: [
    "run video production", "start video production", "generate the approved video",
    "render the approved video", "start generating the video", "produce the approved film",
    "run the creative production", "continue video production",
  ],
  operatorExamples: [
    "The video direction is approved. Start production.",
    "Generate the approved video project now.",
  ],
  transactional: true,
  aiEnabled: true,
