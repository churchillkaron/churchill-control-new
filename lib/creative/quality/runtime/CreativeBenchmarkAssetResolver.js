...
export async function resolveBenchmarkAssets({
  ...
  // AUDIO case is right rather than degraded. Churchill holds 17 images, 5 videos and no
  // audio, and composing original sound from the venue is exactly what that case is for.
  //
