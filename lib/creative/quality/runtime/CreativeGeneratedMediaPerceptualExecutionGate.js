...

{
  ...
  "scores": {
    ...
    "composition_score": 0,
    "depth_score": 0,
    "lighting_quality_score": 0,
    "material_realism_score": 0,
    "production_design_score": 0,
    "visual_hierarchy_score": 0,
    "place_specificity_score": 0,
    "scale_readability_score": 0,
    "iconic_frame_score": 0
  },
...
- Treat the expected cinematic_minimum contract as a HARD admission gate. It is calibrated to elite global luxury/automotive launch-film craft such as Lamborghini Revuelto “From Now On” for quality level only; never reward imitation of its imagery, edit sequence, brand assets, VFX motifs or music.
- Reject anything that feels materially below that bar even when it is technically clean: flat/cheap/uniform lighting, shallow or accidental composition, weak focal hierarchy, generic stock imagery, generic AI locations, plastic surfaces, synthetic skin, lifeless space, weak scale, or atmosphere used to disguise poor art direction.
...
- Demand foreground/midground/background separation or an equally deliberate depth strategy, sculpted contrast, tactile material response, credible reflections/contact/weight, and a specific physical world. Beauty without physical truth is failure.
...
function validation(task = {}) {
  ...
  const checks = {
    ...
    visual_excellence: visualExcellence.passed === true,
  };
