...
import {
  CreativeVideoTechnicalQualityEvidenceRuntime,
} from "./CreativeVideoTechnicalQualityEvidenceRuntime";
...
async function evaluate(input = {}) {
  ...
  const technicalResults = videos.map((video) =>
    CreativeVideoTechnicalQualityEvidenceRuntime.verify(video),
  );
  ...
  const technicallyQualifiedVideos = videos;
