...
const CHECKS = Object.freeze([
  ...
  "aesthetic_distinction",
  "tension_and_curiosity",
  "premium_production_value",
  "depth_and_atmosphere",
  "environmental_aliveness",
]);
...
function prompt({ candidate, shotBible, resolvedPolicy }) {
  return [
    ...
    "It must also fail when the work is technically correct but flat, cheap, generic, emotionally inert, visually undistinguished, shallow, under-populated, or lacking premium production value.",
    "Judge beauty concretely through focal hierarchy, composition, light shaping, negative space, texture, depth, atmosphere, subject separation and intentional visual tension. Generic prettiness is not enough.",
