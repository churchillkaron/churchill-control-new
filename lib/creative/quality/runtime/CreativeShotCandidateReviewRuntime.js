...
const CHECKS = Object.freeze([
  ...
  "cinematic_beauty",
  "frame_design_fidelity",
  "dp_intent_fidelity",
  "physical_world_fidelity",
  "visual_journey_fidelity",
  "benchmark_craft_floor",
  "identity_continuity",
  "product_fidelity",
...
function prompt({ candidate, shotBible, resolvedPolicy }) {
  return [
    ...
    "A major-brand release must fail if researched subject identity, beauty, anatomy, product truth, physics, camera, performance, continuity or synthetic artifacts are visibly weak.",
    "When Shot Bible subject_truth.required is true, researched_subject_fidelity must compare the visible candidate against exact_subject, variant, defining_visual_features, source_ids and reference_evidence. A generic category lookalike is an automatic FAIL.",
    "cinematic_beauty judges authored composition, motivated light, atmosphere, scale, camera placement, texture, reveal and emotional charge. Merely correct, legible or expensive-looking footage is not enough. Generic AI coverage, flat light, weak framing or beauty with no story function must FAIL.",
    "frame_design_fidelity compares the rendered opening, hero and closing compositions against cinematic.frame_design and cinematic.visual_state_conditioning. Reject subject-scale drift, horizon drift, lost negative space, weak depth planes, wrong eye path, lost silhouette or a hero frame that would not work as a premium campaign still.",
    "dp_intent_fidelity compares visible lens perspective, focus behavior, camera path, acceleration, parallax, motivated key/fill/practicals, contrast and exposure against cinematography_acquisition, professional_filmcraft and cinematic.dp_intent. An attractive but differently photographed shot must FAIL.",
    "physical_world_fidelity compares architecture, surfaces, aging, props, reflections, weather, practical sources, human density, material response, contact and motion against cinematic.physical_world. Reject plastic smoothing, texture crawl, unstable reflectance, wrong mass or invented set dressing.",
    "visual_journey_fidelity compares the take with cinematic.visual_journey_state and cinematic.film_visual_journey. Reject a take that is locally beautiful but breaks the planned scale, energy, darkness, color, density or payoff progression of the complete film.",
    "benchmark_craft_floor is a transferable premium-advertising floor informed by the supplied reference family, not a request to copy their shots. Require decisive composition, designed darkness, tactile material detail, scale contrast, motivated camera, physically integrated VFX, clean silhouettes, controlled color worlds, deliberate withholding/reveal, strong payoff imagery and zero visible generative instability.",
