...
export const WORLD_CLASS_QUALITY_FLOORS = Object.freeze({
  ...
  generated_media: Object.freeze({
    ...
    minimum_composition_score: 96,
    minimum_aesthetic_distinction_score: 96,
    minimum_tension_curiosity_score: 94,
    minimum_production_value_score: 96,
    minimum_depth_atmosphere_score: 95,
    minimum_environmental_aliveness_score: 94,
  }),
});
