...
export const CreativePublishCommandRuntime = {
  async create({
    ...
    const command = createCreativeAssetNode({
      ...
      description: "Connector-neutral approved publish command bound to one certified release-package derivative.",
      lineage: {
      ...
      metadata: {
        ...
        release_master_asset_node_id:
          releasePackage.metadata?.master_render_asset_node_id ||
          readiness.metadata?.final_render_asset_node_id ||
          null,
