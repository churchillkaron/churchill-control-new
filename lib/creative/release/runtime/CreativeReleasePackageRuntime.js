...
const CONTRACT = "CREATIVE_RELEASE_PACKAGE_V2";
...
export const CreativeReleasePackageRuntime = Object.freeze({
  ...
  async certify({ organization_id, creative_project_id } = {}) {
    ...
    const node = createCreativeAssetNode({
      ...
      description:
        "Immutable release package binding the current approved creative master to every governed channel derivative and its current delivery evidence.",
      lineage: {
      ...
      intelligence: {
        ...
        tags: ["release-package", "immutable", "current-master", "channel-derivatives", "checksums"],
      },
