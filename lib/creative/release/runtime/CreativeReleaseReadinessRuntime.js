...
export const CreativeReleaseReadinessRuntime = {
  async evaluate({
    ...
    const report = createCreativeAssetNode({
      ...
      description: "Immutable release-readiness audit across timeline, final render, post-finishing master-audio integrity, technical evidence, semantic Creative review, rights and authenticated approvals.",
      lineage: {
      ...
      intelligence: {
        ...
        tags: ["release-readiness", "semantic-quality-required", "final-master-audio-integrity"],
      },
