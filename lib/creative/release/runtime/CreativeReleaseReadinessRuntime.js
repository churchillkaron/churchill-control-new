...
export const CreativeReleaseReadinessRuntime = {
  async evaluate({
    ...
    const checks = [
      ...
      check("technical_qc_passed", requireTechnicalQc, technicalQcPassed, render?.metadata?.technical_qc || null, "Technical quality control has not passed."),
      ...
      check(
        ...
        releaseGateReport?.review?.approved === true && Boolean(releaseGateReport?.review?.approved_by),
