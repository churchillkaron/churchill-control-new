...
export const CreativeReleaseReadinessRuntime = {
  async evaluate({
    ...
    const report = createCreativeAssetNode({
      ...
      description: "Immutable release-readiness audit across timeline, render, technical evidence, semantic Creative review, rights and authenticated approvals.",
      lineage: {
      ...
      intelligence: {
        ...
        tags: ["release-readiness", "semantic-quality-required"],
      },
