      ...
      try {
        ...
        deliveries.push({
          ...
          audio_studio_qc_sealed:
            masterRender.metadata?.audio_studio_qc_sealed === true,
          audio_studio_qc_seal_hash:
            masterRender.metadata?.audio_studio_qc_seal_hash || null,
          audio_studio_finish_task_id:
            masterRender.metadata?.audio_studio_finish_task_id || null,
