...
export async function renderCyclesProduction({project,scene}={}){
  ...
  try{
    ...
    return{contract:AVANTIQO_CYCLES_PRODUCTION_RENDER_CONTRACT,engine:"CYCLES",scene:renderCfg,aov_contract:"OPENEXR_AOV_BUNDLE",aovs:renderCfg.aovs,outputs,provider_calls_performed:false,production_render:true,material_library_hash:cfg.material_library.library_hash,texture_binding_contract:textureBinding.contract,texture_binding_count:textureBinding.binding_count,model_binding_contract:modelBinding.contract,model_binding_count:modelBinding.binding_count,usd_scene_composition_contract:usdComposition?.contract||null,usd_scene_composition_hash:usdComposition?.composition_hash||null,usd_scene_composition_checksum:usdComposition?.checksum||null};
  }finally{
