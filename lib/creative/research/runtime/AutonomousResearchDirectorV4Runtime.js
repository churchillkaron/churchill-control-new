  ...
  async run({ organization_id, mission = {}, project = {}, brief = {}, assets = [], force = false } = {}) {
    ...
    try {
      ...
      if (priorEvidence.length) {
        ...
        const webEvidenceProvider =
          text(process.env.AVANTIQO_WEB_RESEARCH_PROVIDER) || "openai";
        const evidenceResult = await ServiceExecutionRuntime.execute({
          organization_id,
          service_id: "ai.reasoning.execute",
          provider_id: webEvidenceProvider,
          ...
          provider_policy: {
            allowed_providers: [webEvidenceProvider],
            preferred_providers: [webEvidenceProvider],
            preferred_models: [],
