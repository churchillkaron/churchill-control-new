...
export function normalizeAndValidateResearch({
  ...
  const creativeGrounding = normalizeCreativeGrounding(payload.creative_grounding || payload.creativeGrounding, sourceIds);
  const strategicSynthesis = normalizeStrategicSynthesis(payload.strategic_synthesis || payload.strategicSynthesis, sourceIds);
