...
function resolvedCertification(contract) {
  ...
  if (contract.capability === "ai.audio.stems") {
    const runtimeReady = ["1", "true", "yes", "on"].includes(String(process.env.AVANTIQO_AUDIO_ENGINE_ENABLED || "").toLowerCase()) && ["1", "true", "yes", "on"].includes(String(process.env.AVANTIQO_MUSIC_SEPARATOR_ENGINE_ENABLED || "").toLowerCase()) && ["1", "true", "yes", "on"].includes(String(process.env.AVANTIQO_MUSIC_SEPARATOR_ENGINE_CERTIFIED || "").toLowerCase()) && ["1", "true", "yes", "on"].includes(String(process.env.AVANTIQO_LOCAL_COMPUTE_QUEUE_ENABLED || "").toLowerCase());
