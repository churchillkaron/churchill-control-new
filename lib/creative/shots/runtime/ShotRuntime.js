...
function hydrate(shot) {
  ...
  return {
    ...
    virtual_camera_state: object(
      shot.virtual_camera_state || metadata.virtual_camera_state,
    ),
...
async function normalizedUpdate(id, values = {}) {
  ...
  if (Object.prototype.hasOwnProperty.call(values, "virtual_camera_state")) {
    metadata.virtual_camera_state = object(values.virtual_camera_state);
    delete next.virtual_camera_state;
  }
