...
export const CREATIVE_IMAGE_STUDIO_ADJUSTMENT_CONTRACT = "CREATIVE_IMAGE_STUDIO_ADJUSTMENT_V2";
...
export function applyImageStudioPixelAdjustments(raw,width,height,channels,style={}){
  ...
  return {bytes:curved.bytes,width,height,channels,adjustments:a};
}
