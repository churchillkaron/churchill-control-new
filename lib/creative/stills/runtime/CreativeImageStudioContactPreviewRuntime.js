...
export function imageStudioGroundShadowPreview({style={},rotation=0,scale=1,asset_url="",preview={},mask_style={},has_mask=false}={}){
  ...
  const simpleMask=!has_mask||(typeof mask_style?.clipPath==="string"&&!mask_style?.outline);
  if(!simpleMask)return {preview_supported:false,reason:"COMPLEX_MASK_EXPORT_ONLY",shadow};
