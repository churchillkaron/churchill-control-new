...
export function imageStudioLightWrapPreview({style={},scale=1,asset_url="",preview={},has_mask=false,has_edge_alpha=false}={}){
  ...
  if(has_mask)return {preview_supported:false,reason:"MASKED_LIGHT_WRAP_EXPORT_ONLY",settings};
