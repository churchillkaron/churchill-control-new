...
export function imageStudioLightWrapPreview({style={},scale=1,asset_url="",preview={},has_mask=false,mask_style={},has_edge_alpha=false,edge_preview=null}={}){
  ...
  const edgeAlpha=has_edge_alpha||edge_preview?.alpha_changes===true;
  if(edgeAlpha&&edge_preview?.preview_supported!==true)return {preview_supported:false,reason:"EDGE_FINISHED_LIGHT_WRAP_EXPORT_ONLY",settings};
  ...
  const edgeRadius=edge_preview?.preview_supported===true?Math.max(0,n(edge_preview.radius)):0;
  return {
    preview_supported:true,
    reason:null,
    fidelity:edgeRadius>0?"APPROXIMATE_RASTER_EXACT_EDGE_BOUNDARY_CONCEPT":"APPROXIMATE_RASTER_EXACT_BOUNDARY_CONCEPT",
    settings,
...
export function imageStudioGroundShadowPreview({style={},rotation=0,scale=1,asset_url="",preview={},mask_style={},has_mask=false,edge_preview=null}={}){
  ...
  const edgeAlpha=edge_preview?.alpha_changes===true;
  if(edgeAlpha&&edge_preview?.preview_supported!==true)return {preview_supported:false,reason:"EDGE_FINISHED_SHADOW_EXPORT_ONLY",shadow};
  ...
  return {preview_supported:true,reason:null,fidelity:edgeAlpha?"APPROXIMATE_RASTER_EXACT_EDGE_BOUNDARY_GEOMETRY":"APPROXIMATE_RASTER_EXACT_GEOMETRY",shadow,outer_style,silhouette_style,edge_filter_required:edgeAlpha};
}
