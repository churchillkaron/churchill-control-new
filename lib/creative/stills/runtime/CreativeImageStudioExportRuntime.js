...
import { imageStudioSharpIccProfile, normalizeImageStudioOutputColorSpace } from "./CreativeImageStudioColorManagementRuntime.js";
...
export async function renderImageStudioMaster({
  ...
  const base = sharp({ create: { width, height, channels: 4, background } }).composite(composites).withIccProfile(iccProfile);
  let bytes;
  let mime;
  let extension;
