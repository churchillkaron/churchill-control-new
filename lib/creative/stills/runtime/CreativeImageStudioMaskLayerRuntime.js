export const CREATIVE_IMAGE_STUDIO_MASK_LAYER_CONTRACT = "CREATIVE_IMAGE_STUDIO_MASK_LAYER_V2";
...
export function buildImageStudioMaskLayer({
  ...
  opacity=1, invert=false, radius=24, sort_order=0, mask_source_asset_id=null,
  mask_source_kind="GEOMETRIC", provenance=null,
}={}){
  ...
  return Object.freeze({
    id,artboard_id,parent_layer_id:null,source_asset_id:mask_source_asset_id||null,layer_type:"MASK",name:`Mask · ${resolvedShape.toLowerCase().replace("_"," ")}`,
    ...
    metadata:{
      ...
      mask_source_kind:String(mask_source_kind||"GEOMETRIC").toUpperCase(),mask_provenance:provenance&&typeof provenance==="object"?provenance:null,
    },
  });
}
