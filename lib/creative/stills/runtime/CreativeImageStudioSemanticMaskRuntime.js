export const CREATIVE_IMAGE_STUDIO_SEMANTIC_MASK_CONTRACT = "CREATIVE_IMAGE_STUDIO_SEMANTIC_MASK_V1";
...
export function attachImageStudioSemanticMatte(maskLayer={}, evidence={}){
  ...
  if(!evidence.mask_asset_id||!evidence.source_asset_id) throw new Error("IMAGE_STUDIO_SEMANTIC_MATTE_EVIDENCE_REQUIRED");
...
export function validateImageStudioSemanticMask(maskLayer={},targetLayer={}){
  ...
  if(["SUBJECT","BACKGROUND"].includes(resolved)){
    ...
    if(!maskLayer.source_asset_id||!metadata.semantic_source_asset_id) failures.push("SEMANTIC_MASK_EVIDENCE_REQUIRED");
