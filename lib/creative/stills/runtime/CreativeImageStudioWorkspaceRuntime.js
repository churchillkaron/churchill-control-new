...
const COMMANDS = Object.freeze([
  ...
  "add_reference", "create_comment", "request_review", "resolve_comment", "snapshot_version", "export_artboard",
]);
...
export function buildImageStudioWorkspaceState(input = {}) {
  ...
  return {
    ...
    ui: { panel: PANELS.includes(input.ui?.panel) ? input.ui.panel : "artboards", tool: TOOLS.includes(input.ui?.tool) ? input.ui.tool : "select", compare: Boolean(input.ui?.compare) },
    dirty: false,
  };
}
