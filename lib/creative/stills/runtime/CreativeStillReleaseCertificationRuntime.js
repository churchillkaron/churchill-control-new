...
export const CreativeStillReleaseCertificationRuntime = Object.freeze({
  ...
  async certify(input = {}) {
    ...
    const readinessNode = createCreativeAssetNode({
      organization_id: organizationId,
      creative_project_id: projectId,
      ...
      description: "Still-image release readiness bound to the exact master checksum and preflight result.",
      lineage: {
        source: "still_release_readiness",
