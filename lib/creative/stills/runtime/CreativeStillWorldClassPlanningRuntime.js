...
function mediaSignals(assets = []) {
  const result = { images: 0, references: 0, identity: 0, product: 0, brand: 0, vector: 0 };
...
export function planCreativeStillWorldClassProduction(input = {}) {
  ...
  const controls = {
    ...
    style_system: designHeavy || photographic || assets.references > 0,
  ...
  return Object.freeze({
    ...
    signals: { design_heavy: designHeavy, copy_heavy: copyHeavy, photographic, identity_required: identityRequired, product_required: productRequired, vector_required: vectorRequired, print_required: printRequired, multi_format: multiFormat, source_editing: sourceEditing },
    controls,
