...
export const manifest = defineCapability({
  ...
  description:
    "Prepare a real Creative Studio project from an agreed brief. Creates the mission, project, brief, and initial Studio state only; it does not generate paid media, publish, or authorize publication.",
  permissions: [REQUIRED_PERMISSION],
  events: ["creative.studio.project.prepared"],
  tags: ["creative", "studio", "brief", "project", "draft"],
  transactional: true,
  aiEnabled: true,
