...
export const CREATIVE_TOOL_CAPABILITIES = Object.freeze({
  ...
  CINEMATIC_MOTION_DESIGN: "creative.motion.cinematic-design",
  ...
  SINGLE_VIEW_CAMERA_PROXY: "creative.camera.single-view-proxy",
  OBJECT_TRACK: "creative.object.track",
  OPTICAL_FLOW: "creative.optical-flow.compute",
  SEGMENTATION: "creative.segmentation.execute",
  IMAGE_SEGMENTATION: "creative.image.segmentation.execute",
  MOTION_ANALYSE: "creative.motion.analyse",
  DEPTH_ESTIMATE: "creative.depth.estimate",
  NORMAL_ESTIMATE: "creative.normals.estimate",
  MATERIAL_ESTIMATE: "creative.materials.estimate",
  GEOMETRY_PROXY: "creative.geometry-proxy.build",
  PRACTICAL_LIGHT_ESTIMATE: "creative.practical-light.estimate",
...
const TOOL_DEFINITIONS = Object.freeze([
  ...
  {
    id: "blender",
    label: "Blender / Cycles (Avantiqo Node 01)",
    runtime: CREATIVE_TOOL_RUNTIME.LOCAL,
    availability: "RUNTIME_DISCOVERED",
    deterministic: true,
    quality_tier: CREATIVE_TOOL_QUALITY_TIER.PREMIUM,
    cost_class: CREATIVE_TOOL_COST_CLASS.ZERO,
    human_approval_required: false,
    fallback_policy: "AVANTIQO_LOCAL_NODE_ONLY_NO_SANDBOX_FALLBACK",
    capabilities: [
      CREATIVE_TOOL_CAPABILITIES.THREE_D_RENDER,
      CREATIVE_TOOL_CAPABILITIES.CINEMATIC_MOTION_DESIGN,
    ],
  },
  {
    id: "depth-geometry-proxy",
    label: "Depth Geometry Proxy",
    runtime: CREATIVE_TOOL_RUNTIME.SANDBOX,
    availability: "ON_DEMAND",
    deterministic: true,
    quality_tier: CREATIVE_TOOL_QUALITY_TIER.PRODUCTION,
    cost_class: CREATIVE_TOOL_COST_CLASS.LOW,
    human_approval_required: false,
    fallback_policy: "SINGLE_VIEW_RELATIVE_GEOMETRY_ONLY_NO_FAKE_PHOTOGRAMMETRY",
    capabilities: [
      CREATIVE_TOOL_CAPABILITIES.GEOMETRY_PROXY,
      CREATIVE_TOOL_CAPABILITIES.SINGLE_VIEW_CAMERA_PROXY,
    ],
  },
  {
    id: "opencv",
    ...
    capabilities: [
      ...
      CREATIVE_TOOL_CAPABILITIES.IMAGE_SEGMENTATION,
      CREATIVE_TOOL_CAPABILITIES.MOTION_ANALYSE,
      CREATIVE_TOOL_CAPABILITIES.NORMAL_ESTIMATE,
      CREATIVE_TOOL_CAPABILITIES.PRACTICAL_LIGHT_ESTIMATE,
    ],
  },
  {
    id: "imagemagick",
  ...
  },
  {
    ...
    capabilities: [
      ...
      CREATIVE_TOOL_CAPABILITIES.VIDEO_EXTEND,
      CREATIVE_TOOL_CAPABILITIES.VIDEO_UPSCALE,
      ...
      CREATIVE_TOOL_CAPABILITIES.IMAGE_UPSCALE,
      CREATIVE_TOOL_CAPABILITIES.DEPTH_ESTIMATE,
      CREATIVE_TOOL_CAPABILITIES.MATERIAL_ESTIMATE,
