...
const TOOL_BOOTSTRAPS = Object.freeze({
  ...
  blender: [
    ...
    {
      cmd: "apt-get",
      args: ["install", "-y", "blender", "ffmpeg", "libegl1", "libgl1", "libgles2"],
      sudo: true,
    },
    {
      cmd: "blender",
  ...
  opencv: [
    ...
    {
      cmd: "apt-get",
      args: ["install", "-y", "openimageio-tools"],
      sudo: true,
    },
    {
      cmd: "bash",
  ...
  aaf: [
    {
      ...
      args: [
        "-lc",
        "rm -rf /tmp/avantiqo-aaf && python3 -m venv /tmp/avantiqo-aaf/venv && /tmp/avantiqo-aaf/venv/bin/pip install --disable-pip-version-check --no-cache-dir pyaaf2",
      ],
    },
    {
      cmd: "/tmp/avantiqo-aaf/venv/bin/python",
      args: ["-c", "import aaf2; print(aaf2.__version__ if hasattr(aaf2,'__version__') else 'pyaaf2-ready')"],
    },
  ],
  openimageio: [
    {
