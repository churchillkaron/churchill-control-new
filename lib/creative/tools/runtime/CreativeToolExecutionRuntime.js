...
} from "@/lib/creative/tools/runtime/CreativeSpatialProductTwinRuntimeV3";

const CONTRACT = "CREATIVE_TOOL_EXECUTION_RUNTIME_V5";
...
async function executeSandboxCapability({
  ...
  if (selected_tool_id === "opencv") {
    if (capability === CREATIVE_TOOL_CAPABILITIES.CAMERA_TRACK) {
      return CreativeOpenCVCameraTrackRuntime.execute({
        organization_id,
        project,
        ...input,
      });
