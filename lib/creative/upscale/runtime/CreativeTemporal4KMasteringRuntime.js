...
export function planTemporal4K({source_width,source_height,fps,frame_count,source_asset_node_id,source_checksum=null,audio_asset_node_id=null,model="FLASHVSR_V1_1",target_width=3840,target_height=2160}={}){
  ...
  const body={contract:AVANTIQO_TEMPORAL_4K_MASTERING_CONTRACT,source_asset_node_id:text(source_asset_node_id)||null,source_checksum:text(source_checksum)||null,source:{width:w,height:h,fps:rate,frame_count:frames},flashvsr:{worker_contract:"AVANTIQO_VIDEO_FLASHVSR_GPU_MASTER_V1",model:text(model),source_frame_count:frames,padded_frame_count:padded,temporal_model_required:true,per_frame_independent_sr_forbidden:true,source_detail_may_not_be_reinvented_frame_to_frame:true},delivery:{mastering_surface_policy:"TEMPORAL_SR_THEN_EXACT_DELIVERY_NORMALIZATION",target_width:Number(target_width),target_height:Number(target_height),exact_delivery_resolution_required:true,reencode_after_sr_allowed:true,audio_remux_asset_node_id:text(audio_asset_node_id)||null},qc:{temporal_flicker_check:true,detail_crawl_check:true,texture_boiling_check:true,skin_detail_stability_check:true,material_detail_stability_check:true,rain_continuity_check:true,fog_volumetric_continuity_check:true,reflection_stability_check:true,edge_ringing_check:true,grain_temporal_coherence_check:true,motion_blur_continuity_check:true,depth_of_field_continuity_check:true,lens_response_continuity_check:true,exposure_pumping_check:true,identity_drift_check:true,over_sharpening_check:true,grain_restoration_after_sr:true,source_to_master_frame_count_preserved:true,source_to_master_duration_preserved:true}};
