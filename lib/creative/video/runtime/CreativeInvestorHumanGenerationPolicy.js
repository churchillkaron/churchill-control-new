...
export const INVESTOR_HUMAN_GENERATION_CONTRACT =
  "AVANTIQO_VIDEO_HUMAN_FAST_DISTILLED_MULTI_KEYFRAME_V1";
...
const REQUIRED_MACHINE_CHECKS = Object.freeze([
  "face_identity",
  "anatomy",
  "subject_consistency",
  "motion_physics",
...
const REQUIRED_EXACT_MASTER_VISUAL_CHECKS = Object.freeze([
  "identity",
  "face",
  "eyes",
  "hands",
...
export function investorHumanGenerationPolicy(scene, { required } = {}) {
  ...
  return Object.freeze({
    ...
    maximum_keyframes: humanRequired
      ...
      : 0,
    required_machine_checks: humanRequired ? [...REQUIRED_MACHINE_CHECKS] : [],
    required_exact_master_visual_checks: humanRequired
      ? [...REQUIRED_EXACT_MASTER_VISUAL_CHECKS]
      : [],
    fine_detail_machine_certification_forbidden: humanRequired,
...
export function assertInvestorHumanGenerationPolicy(policy = {}) {
  ...
  if (!Array.isArray(value.required_machine_checks) || value.required_machine_checks.length < REQUIRED_MACHINE_CHECKS.length) {
    throw new Error("AVANTIQO_INVESTOR_HUMAN_MACHINE_QC_POLICY_INVALID");
  }
  if (!Array.isArray(value.required_exact_master_visual_checks) || value.required_exact_master_visual_checks.length < REQUIRED_EXACT_MASTER_VISUAL_CHECKS.length) {
    throw new Error("AVANTIQO_INVESTOR_HUMAN_VISUAL_QC_POLICY_INVALID");
  }
  if (value.fine_detail_machine_certification_forbidden !== true) {
    throw new Error("AVANTIQO_INVESTOR_HUMAN_FINE_DETAIL_MACHINE_CERTIFICATION_FORBIDDEN");
  }
...
export const AVANTIQO_INVESTOR_HUMAN_GENERATION_POLICY = Object.freeze({
  ...
  required_machine_checks: REQUIRED_MACHINE_CHECKS,
  required_exact_master_visual_checks: REQUIRED_EXACT_MASTER_VISUAL_CHECKS,
