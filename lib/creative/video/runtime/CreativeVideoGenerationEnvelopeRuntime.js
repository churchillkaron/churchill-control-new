...
export function buildCreativeVideoGenerationEnvelope(input = {}) {
  ...
  const body = {
    ...
    physical_world: object(shotBible.cinematic?.physical_world),
    film_visual_journey: object(shotBible.cinematic?.film_visual_journey),
    visual_journey_state: object(shotBible.cinematic?.visual_journey_state),
    dp_intent: object(shotBible.cinematic?.dp_intent || input.dp_intent),
