...
function worldState(value = {}) {
  ...
  return bounded({
    ...
    wind_direction: firstValue(world.wind_direction, source.wind_direction, metadataWorld.wind_direction),
    precipitation_state: firstValue(world.precipitation_state, source.precipitation_state, source.rain_state, metadataWorld.precipitation_state),
    wetness_state: firstValue(world.wetness_state, source.wetness_state, source.material_wetness, metadataWorld.wetness_state),
    ground_deformation_state: firstValue(world.ground_deformation_state, source.ground_deformation_state, source.mud_state, metadataWorld.ground_deformation_state),
    footprint_track_state: firstValue(world.footprint_track_state, source.footprint_track_state, source.footprints, metadataWorld.footprint_track_state),
    wardrobe_wetness_state: firstValue(world.wardrobe_wetness_state, source.wardrobe_wetness_state, source.wardrobe?.wetness_state, metadataWorld.wardrobe_wetness_state),
    atmosphere: firstValue(world.atmosphere, source.atmosphere, metadataWorld.atmosphere),
    atmosphere_density: firstValue(world.atmosphere_density, source.atmosphere_density, source.fog_density, metadataWorld.atmosphere_density),
    practical_light_state: firstValue(world.practical_light_state, source.practical_light_state, source.lighting?.practical_state, metadataWorld.practical_light_state),
    lightning_state: firstValue(world.lightning_state, source.lightning_state, source.weather?.lightning_state, metadataWorld.lightning_state),
    moving_threat_state: firstValue(world.moving_threat_state, source.moving_threat_state, source.threat_state, metadataWorld.moving_threat_state),
...
function author(input = {}) {
  ...
  const contractBase = {
    ...
    policy: {
      ...
      wind_direction_may_not_flip_without_authored_cause: true,
      rain_intensity_and_drop_direction_may_not_reset_between_neighboring_shots: true,
      wetness_and_mud_must_accumulate_causally: true,
      footprints_and_ground_deformation_must_persist_when_visible: true,
      wardrobe_wetness_may_not_dry_or_reset_without_story_time_or_cause: true,
      fog_density_and_beam_scattering_must_evolve_continuously: true,
      lightning_aftereffects_must_propagate_into_subsequent_state: true,
      moving_threat_position_and_search_pattern_must_preserve_spatial_lineage: true,
