...
import { projectCustomerPaymentRecoveryMarketingOutcome }
from "../../marketing/projectCustomerPaymentRecoveryMarketingOutcome";
...
export async function reverseCustomerPaymentCommand(
  ...
  const marketing_outcome = await projectCustomerPaymentRecoveryMarketingOutcome({
    input,
    result,
  });
...
export async function applyCustomerPrepaymentSystemCommand(
  input
){
  return await applyCustomerPrepayment({
    ...input,
