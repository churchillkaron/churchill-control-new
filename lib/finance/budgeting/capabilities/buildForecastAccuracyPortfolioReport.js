...
function latestApprovedRow(report) {
...
async function buildEntityRow({ organizationId, entity, historyLimit }) {
  try {
    ...
    const latestApproved = latestApprovedRow(report);
    ...
    return {
      ...
      latest_approved_period_id: latestApproved?.period_id || null,
      latest_approved_period_name: latestApproved?.period_name || null,
      latest_approved_period_start_date: latestApproved?.period_start_date || null,
      latest_approved_period_end_date: latestApproved?.period_end_date || null,
      latest_approved_version_id: latestApproved?.version_id || null,
      latest_approved_version_number: latestApproved?.version_number || null,
    ...
    return {
      ...
      latest_approved_period_id: null,
      latest_approved_period_name: null,
      latest_approved_period_start_date: null,
      latest_approved_period_end_date: null,
      latest_approved_version_id: null,
      latest_approved_version_number: null,
    ...
    value:
      row.measurement_status === "error"
        ...
        : [
            ...
            `Latest approved ${row.latest_approved_period_name || "Unavailable"}`,
