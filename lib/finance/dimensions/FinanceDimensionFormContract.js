...
const VALUE_TYPE_OPTIONS = [
  ["LIST", "Select from approved values"],
  ["TEXT", "Free text"],
  ["NUMBER", "Number"],
  ["DATE", "Date"],
  ["BOOLEAN", "Yes / No"],
...
const DIMENSION_VALUE_FIELDS = [
  ...
  { name: "parent_value_id", label: "Parent Value", type: "lookup", lookup: "finance_dimension_values", dependsOn: "dimension_id", dependsOnLabel: "Dimension" },
