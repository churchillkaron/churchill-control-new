...
export function applyFinanceWorkspaceRegistry(registry) {
  ...
  // Closed workspaces are serialized from their runtime contract. Attach the
  // business operation to that contract so CRUD normalization cannot erase it.
  ...
  convergeClosedOperationalWorkspace("depreciation", { readOnly: true });
