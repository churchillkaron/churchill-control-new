...
function convergeForecastingWorkspace(item) {
  ...
  item.description =
    "Forecast revenue, direct costs, operating expenses and operating profit from posted ledger run-rates, test explicit business scenarios against period budgets, and preserve approved scenario versions.";
