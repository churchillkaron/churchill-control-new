...
export async function validateScheduledReportWrite({ organizationId, payload, recordId = null }) {
  ...
  const normalizedPayload = normalizeScheduledReportPayload({
    ...payload,
    ...(Object.prototype.hasOwnProperty.call(payload, "next_run_at") && !payload.timezone
      ? { timezone: candidate.timezone }
      : {}),
  });
  if (!Object.prototype.hasOwnProperty.call(payload, "timezone")) {
    delete normalizedPayload.timezone;
  }
