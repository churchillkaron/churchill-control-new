...
export const createVendorPaymentReadCapability = () => exactMoneyRead({
  capability: "vendor_payments", permission: "finance.payables.manage", table: "vendor_payments", idKey: "payment_id",
});
