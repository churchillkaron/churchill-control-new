...
export async function financeGateway(event) {
  ...
  switch (type) {
    ...
    case "POS_SALE_RECOGNIZED":
    case "POS_CASH_PAYMENT_RECEIVED":
    case "POS_CARD_PAYMENT_RECEIVED":
    case "POS_QR_PAYMENT_RECEIVED":
    case "POS_TRANSFER_PAYMENT_RECEIVED":
