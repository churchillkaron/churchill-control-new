...
const CLOSE_TAX_CAPABILITIES = new Set([
  "period_close",
  "year_end",
  "vat_returns",
  "statutory_filings",
...
export function resolveFinanceCapabilitySection(capabilityId) {
  ...
  if (CLOSE_TAX_CAPABILITIES.has(id)) return "close";
...
export function resolveFinanceNavigationSection(pathname) {
  ...
  if (financePath === "/finance" || financePath === "/finance/") return "home";
  if (financePath.startsWith("/finance/clients")) return "clients";
  if (financePath.startsWith("/finance/review")) return "work";
  if (financePath.startsWith("/finance/work")) return "work";
  if (financePath.startsWith("/finance/accounting-firm")) return "home";
  if (financePath.startsWith("/finance/bank-reconciliation")) return "books";
  if (
