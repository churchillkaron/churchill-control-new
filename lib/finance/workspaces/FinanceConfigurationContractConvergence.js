...
import { FINANCE_DOCUMENT_SEQUENCE_TYPES } from "@/lib/finance/number-sequences/FinanceNumberSequenceVocabulary";
...
function convergeRevenueRecognition() {
  const contract = replaceSchema("revenue_recognition", [
    ...
    { name: "source_document_id", label: "Customer Invoice", type: "lookup", lookup: "customer_invoices", visibleWhen: { field: "source_document_type", equals: "CUSTOMER_INVOICE" } },
    { name: "contract_reference", label: "Contract / Reference", type: "text", visibleWhen: { field: "source_document_type", notEquals: "CUSTOMER_INVOICE" } },
    {
    ...
    { name: "revenue_account_id", label: "Revenue Account", type: "lookup", lookup: "revenue_accounts", required: true },
    { name: "deferred_revenue_account_id", label: "Deferred Revenue Account", type: "lookup", lookup: "deferred_revenue_accounts", required: true },
