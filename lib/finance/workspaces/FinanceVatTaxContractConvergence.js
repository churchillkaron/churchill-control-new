...
export function applyFinanceVatTaxContractConvergence() {
  ...
  if (eInvoicing) {
    eInvoicing.schema = [
      { name: "provider_code", label: "Certified Provider", type: "select", required: true, options: [{ value: "netbay_invoicechain", label: "Netbay InvoiceChain" }, { value: "inet_etax", label: "INET One E-Tax" }, { value: "certified_etax_rest", label: "Other Certified REST Provider" }] },
      { name: "network", label: "Network / Scheme", type: "select", required: true, options: [{ value: "TH_RD_ETAX", label: "Thailand RD e-Tax Invoice / e-Receipt" }], defaultValue: "TH_RD_ETAX" },
      { name: "jurisdiction_code", label: "Jurisdiction", type: "select", required: true, options: [{ value: "TH", label: "Thailand" }], defaultValue: "TH" },
      {
        name: "document_type",
        label: "Document Type",
        type: "select",
        required: true,
        options: [{ value: "CUSTOMER_INVOICE", label: "Customer Invoice" }, { value: "CREDIT_NOTE", label: "Credit Note" }, { value: "DEBIT_NOTE", label: "Debit Note" }, { value: "SELF_BILLED_INVOICE", label: "Self-Billed Invoice" }, { value: "OTHER", label: "Other" }],
      },
      { name: "sender_identifier", label: "Registered Sender Identifier", type: "text", required: true },
      {
        ...
        type: "select",
        required: true,
        options: [{ value: "INACTIVE", label: "Inactive" }, { value: "ACTIVE", label: "Active" }, { value: "SUSPENDED", label: "Suspended" }],
