...
const POLICY = Object.freeze({
  chart_of_accounts: { read: "finance.accounting.view", write: "finance.accounting.manage" },
  bank_accounts: { read: "finance.banking.view", write: "finance.banking.manage" },
  cost_centers: { read: "finance.accounting.view", write: "finance.configuration.manage" },
  currencies: { read: "finance.accounting.view", write: "finance.configuration.manage" },
  legal_entities: { read: "finance.accounting.view", write: "finance.configuration.manage" },
