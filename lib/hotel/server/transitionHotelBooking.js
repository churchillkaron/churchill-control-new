...
export async function transitionHotelBooking({ supabase, organizationId, bookingId, action }) {
  ...
  const bookingUpdate = {
    ...
    ...(normalizedAction === "CHECK_OUT"
      ? {
          actual_check_out_at: changedAt,
          actual_check_out_business_date: checkoutOperationalDate.businessDate,
        }
      : {}),
  };
