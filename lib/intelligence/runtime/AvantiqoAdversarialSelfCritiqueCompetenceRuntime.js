...
export async function runAvantiqoAdversarialSelfCritiqueCompetence({organizationId=learningOrganizationId()}={}){
  ...
  const upstreamFingerprint=hash(JSON.stringify(object(longHorizon.data?.[0]?.metadata)));
