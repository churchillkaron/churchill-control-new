...
export function getBusinessDiagnosisReadiness({ env = process.env } = {}) {
  ...
  return {
    ...
    proof: {
      ...
      scope_checksum_required: authenticity.scope_checksum_required === true,
      origin_user_required: authenticity.origin_user_required === true,
...
export function getPublicBusinessDiagnosisReadiness({ env = process.env } = {}) {
  ...
  return {
    ...
    proof: {
      ...
      scope_checksum_required: readiness.proof.scope_checksum_required,
      origin_user_required: readiness.proof.origin_user_required,
