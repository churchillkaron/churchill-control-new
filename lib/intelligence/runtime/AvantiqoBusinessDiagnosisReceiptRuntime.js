...
export const AVANTIQO_BUSINESS_DIAGNOSIS_AUDIT_PROJECTION_CONTRACT = "AVANTIQO_BUSINESS_DIAGNOSIS_AUDIT_PROJECTION_V2";
...
function buildLegacyBusinessDiagnosisAuditProjection({
  receipt_fingerprint=null, diagnosis_class=null, business_timezone=null, final_evidence_state=null, residual_material=false,
  answer_boundary_status=null, answer_unsupported_recommendation_outcome_detected=false,
  validated_external_context_count=0, unresolved_external_context_count=0,
  baseline_period_id=null, baseline_period_start_date=null, baseline_period_end_date=null,
...
export function verifyBusinessDiagnosisAuditProjection(evidence={}){
  ...
  if(!projectionContract){
    ...
    return {status:legacyExpected===fingerprint?"VERIFIED_LEGACY":"MISMATCH",verified:legacyExpected===fingerprint,expected_fingerprint:legacyExpected,projection_contract:null};
  }
  ...
  return {status:expected===fingerprint?"VERIFIED":"MISMATCH",verified:expected===fingerprint,expected_fingerprint:expected,projection_contract:projectionContract};
}
...
export function buildBusinessDiagnosisReceipt({organization_id=null,entity_id=null,metric=null,diagnosis_class=null,business_timezone=null,baseline_period_id=null,baseline_period_start_date=null,baseline_period_end_date=null,current_period_id=null,current_period_start_date=null,current_period_end_date=null,final_diagnosis=null,external_research_plan=null,external_evidence_assessment=null,external_diagnosis_closure=null,answer_brief=null,answer_boundary=null}={}){
  ...
  const auditProjectionFingerprint=businessDiagnosisAuditProjectionFingerprint({
    receipt_fingerprint:fingerprint,diagnosis_class:payload.diagnosis_class,business_timezone:payload.business_timezone,final_evidence_state:payload.final_evidence_state,residual_material:payload.residual_material,
  ...
  return {...payload,receipt_fingerprint:fingerprint,audit_projection_contract:AVANTIQO_BUSINESS_DIAGNOSIS_AUDIT_PROJECTION_CONTRACT,audit_projection_fingerprint:auditProjectionFingerprint};
}

export const AvantiqoBusinessDiagnosisReceiptRuntime=Object.freeze({contract:AVANTIQO_BUSINESS_DIAGNOSIS_RECEIPT_CONTRACT,build:buildBusinessDiagnosisReceipt,auditProjectionContract:AVANTIQO_BUSINESS_DIAGNOSIS_AUDIT_PROJECTION_CONTRACT,auditProjection:buildBusinessDiagnosisAuditProjection,auditProjectionFromReceipt:buildBusinessDiagnosisAuditProjectionFromReceipt,auditFingerprint:businessDiagnosisAuditProjectionFingerprint,verifyAudit:verifyBusinessDiagnosisAuditProjection});
