...
const DRIVER_READ_HINTS = Object.freeze({
  ...
  profit:["finance.profit_loss.read","finance.trial_balance.read","finance.cash_management.read"],
  ...
  revenue:["finance.profit_loss.read","finance.customer_invoices.read","finance.trial_balance.read"],
  ...
  cost_total:["finance.profit_loss.read","finance.trial_balance.read","finance.cash_management.read"],
  cogs:["finance.profit_loss.read","finance.trial_balance.read","supply_chain.inventory_items.read","supply_chain.stock_position.read"],
