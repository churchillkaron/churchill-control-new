...
export function scoreAvantiqoCapabilityLearningPriority({capability={},coverage={}}={}){
  ...
  const usageEvidence=weightedOutcomes+liveOutcomes*0.5+readinessSuccess*0.25;
  ...
  const priority=gap*(0.35+usage*0.5+risk*0.15)+exploration*gap;
  return {
