...
const BUSINESS_DRIVER_DIAGNOSIS_PATTERN = /\b(why|reason|cause|driver|explain|diagnose|root cause)\b.{0,120}\b(profit|margin|revenue|sales|cost|expense|cogs|food cost|labor cost|occupancy|bookings?)\b|\b(profit|margin|revenue|sales|cost|expense|cogs|food cost|labor cost|occupancy|bookings?)\b.{0,120}\b(drop|down|declin|increase|up|worse|lower|higher|change)\b/i;
