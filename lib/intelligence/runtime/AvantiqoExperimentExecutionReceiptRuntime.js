...
export async function recordAvantiqoExperimentExecutionReceipt({
  ...
  const row = {
    ...
    content:
      "Immutable structural execution receipt bound to one consumed single-use claim. The execution start is claim-window bound while completion may occur later. The receipt cannot authorize another execution, promote knowledge, start training, or fabricate a result.",
    importance: 1,
    confidence: 1,
