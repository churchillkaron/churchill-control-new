...
export function buildAvantiqoMissionOutcomeEvidenceCandidateRow({
  ...
  if (
    ...
    evaluation.history_scan_complete === false ||
  ...
  return {
    ...
    metadata: {
      ...
      history_scan_complete: evaluation.history_scan_complete !== false,
      ...
      history_count_stable: evaluation.history_count_stable !== false,
