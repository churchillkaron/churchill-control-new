...
function adapterRecipe(dataset = {}, examples = {}) {
  ...
  return {
    ...
    adapter_framework: "PEFT_LORA",
    preferred_implementation: TRAINING_METHOD,
    foundation_model: FOUNDATION_MODEL,
    foundation_weights_immutable: true,
    base_precision: "FP32_CPU_OR_LOCAL_GPU_MIXED",
    base_quantized: false,
    minimum_gpu_class: "OPTIONAL_LOCAL_GPU_ASSIST",
    ...
    moe_lora_target_parameters: [...MOE_LORA_TARGET_PARAMETERS],
    lora_dropout: 0,
...
export async function prepareAvantiqoModelTrainingJob({ datasetId } = {}) {
  ...
  const jobFingerprint = stableHash(
    `${datasetFingerprint}|${exampleFingerprint}|${FOUNDATION_MODEL}|${TRAINING_METHOD}`,
  );
