...
async function persistReview({ organizationId, candidate, canary }) {
  ...
  const row = {
    ...
    content: `Model candidate ${candidate.id} passed offline benchmark and isolated canary certification. Production release remains explicitly pending.`,
    importance: 0.99,
    confidence: 1,
