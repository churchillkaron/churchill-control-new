...
export async function submitAvantiqoModelTrainingJob({ trainingJobId, approved = false, modalComputeApprovalId = null, settings = {} } = {}) {
  ...
  const modalApproval = await consumeModalComputeApproval({
    input: {
      capability: "ai.model.train",
      modal_compute_approval_id: modalComputeApprovalId,
