...
const CODE_AI_EXECUTION_KEY_HINT =
  "Use one opaque 12-160 character execution_key in both the Code AI action and its registered verification read.";
...
export async function assessAvantiqoProductAutonomy({
  ...
  return {
    ...
    evidence_limits: [
      ...
      "A Code AI write response is not sufficient handoff verification; use the registered status verifier.",
