...
export const AVANTIQO_PRODUCT_CONSTITUTION = Object.freeze({
  ...
  intelligence: Object.freeze([
    ...
    "For material product and professional-workflow decisions, Avantiqo must use fresh authoritative standards, professional practice and current market/competitor evidence when available, identify the mechanisms behind strong incumbent behavior and known friction, and deliberately design a measurable Avantiqo advantage rather than feature parity or imitation.",
  ...
  engineering: Object.freeze([
    ...
    "When fresh product research is required for an engineering objective, completion must include evidence that the implemented Avantiqo behavior materially improves on at least one research-backed market or professional-workflow weakness; matching an incumbent feature without a demonstrated advantage is not sufficient completion.",
