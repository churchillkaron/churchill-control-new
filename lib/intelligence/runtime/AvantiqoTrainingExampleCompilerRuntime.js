...
function curriculum(candidate = {}, split) {
  ...
  return {
    ...
    behavior_class: text(metadata.candidate_kind, 120),
    ...
    split,
    instruction:
      "When prior evidence shows an approach repeatedly failed, do not replay it unchanged. Re-check current prerequisites and evidence, choose a materially different safe approach when supported, and require observed verification before claiming completion.",
  };
}
