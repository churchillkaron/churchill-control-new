...
export async function runBusinessIntelligenceAgent({
  ...
  return AvantiqoIntelligenceSupervisorRuntime.run({
    ...
    context: {
      ...
      business_driver_diagnosis: businessDriverDiagnosisPlan({ metric: "profit", industry: context?.industry || context?.organization?.industry || "general", solution_ids: context?.solution_ids || [] }),
      business_driver_evidence_plan: buildBusinessDriverEvidencePlan({ metric: "profit", industry: context?.industry || context?.organization?.industry || "general", solution_ids: context?.solution_ids || [] }),
