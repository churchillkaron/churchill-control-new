...
import { createBusinessExternalDiagnosisClosureTool, AVANTIQO_BUSINESS_EXTERNAL_DIAGNOSIS_CLOSURE_TOOL_CONTRACT } from "./AvantiqoBusinessExternalDiagnosisClosureToolRuntime.js";
...
export async function runBusinessIntelligenceAgent({
  ...
  const externalEvidenceCollection = externalResearchPlan?.research_allowed === true
    ...
    : null;
  const externalClosureTool = externalEvidenceCollection
    ? createBusinessExternalDiagnosisClosureTool({
        metric,
        industry,
        solution_ids: solutionIds,
        internal_evidence_batch: internalEvidenceBatch,
  ...
  return AvantiqoIntelligenceSupervisorRuntime.run({
    ...
    context: {
      ...
      business_external_evidence_collection: externalEvidenceCollection,
      business_external_evidence_collection_contract: AVANTIQO_BUSINESS_EXTERNAL_EVIDENCE_COLLECTOR_CONTRACT,
      business_external_evidence_packets: externalEvidenceCollection?.packets || [],
      business_external_diagnosis_closure_tool_contract: AVANTIQO_BUSINESS_EXTERNAL_DIAGNOSIS_CLOSURE_TOOL_CONTRACT,
    ...
    memories,
    tools: [...buildReadOnlyTools(organizationId), ...governedReadTools, ...comparisonTools, ...(externalClosureTool ? [externalClosureTool] : [])],
    authorization: {
