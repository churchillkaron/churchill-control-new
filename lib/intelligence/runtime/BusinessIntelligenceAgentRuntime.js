...
export async function runBusinessIntelligenceAgent({
  ...
  return AvantiqoIntelligenceSupervisorRuntime.run({
    ...
    context: {
      ...
      business_driver_diagnosis: businessDriverDiagnosisPlan({ metric, industry: context?.industry || context?.organization?.industry || "general", solution_ids: context?.solution_ids || [] }),
      business_driver_evidence_plan: buildBusinessDriverEvidencePlan({ metric, industry: context?.industry || context?.organization?.industry || "general", solution_ids: context?.solution_ids || [] }),
      business_evidence_execution_plan: buildBusinessEvidenceExecutionPlan({ metric, industry: context?.industry || context?.organization?.industry || "general", solution_ids: context?.solution_ids || [] }),
