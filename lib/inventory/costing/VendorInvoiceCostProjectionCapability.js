...
export function createVendorInvoiceCostProjectionCapability(){
  const manifest=defineCapability({
    ...
    operatorVerification:{capability_key:"supply_chain.purchase_costs.verify_vendor_invoice",payload_keys:["vendor_invoice_id"],derivation:"declared_exact_vendor_invoice_cost_projection_verifier"},
