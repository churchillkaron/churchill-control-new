...
export function createGoodsReceiptCapability() {
  const manifest = defineCapability({
    ...
    permissions: ["procurement.manage"], events: ["supply_chain.goods_receipt.received"],
    ...
    operatorVerification: { capability_key: "supply_chain.goods_receipts.read", payload_from_result: { id: ["goods_receipt.id", "goods_receipt_id", "id"] }, derivation: "declared_result_bound_record_verifier" },
