...
export async function prepareInventoryAttachment({ file = {}, organizationId, entityId = null } = {}) {
  ...
  return {
    recognized: true, type: "inventory_import", status: "REVIEW_ONLY_NO_GOVERNED_BULK_IMPORT",
    ...
    source_attachment_sha256: text(file.sha256, 128) || null, write_capability_available: false,
