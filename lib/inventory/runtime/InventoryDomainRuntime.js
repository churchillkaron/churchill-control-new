...
export const InventoryDomainRuntime = {
  ...
  capabilities: {
    ...
    supplier_prices: {
      ...
      verifyImport: async () => (await import("@/lib/inventory/procurement/suppliers/SupplierPriceImportVerificationCapability")).createSupplierPriceImportVerificationCapability(),
    },
    purchase_costs: {
      apply_vendor_invoice: async () => createVendorInvoiceCostProjectionCapability(),
      verify_vendor_invoice: async () => (await import("@/lib/inventory/runtime/SupplyChainBusinessWriteVerificationCapabilities")).createVendorInvoiceCostVerificationCapability(),
    },
    recipes: {
      upsert: async () => createRecipeUpsertCapability(),
      verify: async () => (await import("@/lib/inventory/runtime/SupplyChainBusinessWriteVerificationCapabilities")).createRecipeVerificationCapability(),
    },
    production_batches: {
