...
export function createInventoryItemsImportCapability() {
  const manifest = defineCapability({
    ...
    permissions: ["procurement.manage"], events: ["supply_chain.inventory_items.imported"],
    ...
    operatorVerification: { capability_key: "supply_chain.inventory_items.verifyImport", payload_array_from_result: { created_ids: { path: "import.created", item_path: "id", allow_empty: true }, existing_ids: { path: "import.existing", item_path: "id", allow_empty: true } }, derivation: "declared_result_bound_collection_verifier" },
    inputSchema: {
