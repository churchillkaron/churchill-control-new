const DEFINITIONS = [
  ...
  ["google_ads","Google Ads","paid_media","google_ads","marketing.google.ads.manage","google-ads","ACTIVE",["search"],["WEBSITE","LEADS","CALLS"],["SEARCH","RESPONSIVE"]],
  ...
  ["email","Email","owned_channel","email","communication.email.send","email","ACTIVE_IF_CONFIGURED",["email"],["WEBSITE","REPLY","BOOKING","PURCHASE"],["HTML","TEXT","NEWSLETTER","AUTOMATION"]],
  ["whatsapp","WhatsApp Business","owned_channel","whatsapp","communication.whatsapp.send","whatsapp","ACTIVE_IF_CONFIGURED",["whatsapp"],["CONVERSATION","BOOKING","PURCHASE","SUPPORT"],["TEMPLATE","TEXT","IMAGE","VIDEO","DOCUMENT"]],
  ["line","LINE Official Account","owned_channel","line","communication.line.send","line","ACTIVE_IF_CONFIGURED",["line"],["CONVERSATION","FOLLOW","WEBSITE","PURCHASE"],["TEXT","IMAGE","VIDEO","FLEX","RICH_MESSAGE"]],
  ["sms","SMS","owned_channel","sms","communication.sms.send","sms","ACTIVE_IF_CONFIGURED",["sms"],["WEBSITE","CALL","REPLY"],["TEXT"]],
  ...
  ["telegram","Telegram","owned_channel","telegram","communication.telegram.send","telegram","ACTIVE_IF_CONFIGURED",["telegram"],["CONVERSATION","CHANNEL","WEBSITE"],["TEXT","IMAGE","VIDEO","DOCUMENT"]],
  ["organic_social","Organic Social","organic","multi","marketing.social.publish","social-publishing","ACTIVE_IF_CONFIGURED",["facebook","instagram","threads","tiktok","youtube","linkedin","x","pinterest","google_business","line","telegram"],["ENGAGEMENT","WEBSITE","CONVERSATION"],["TEXT","IMAGE","VIDEO","STORY","REEL","SHORT"]],
...
export const MARKETING_CHANNEL_CATALOG = CHANNELS;
