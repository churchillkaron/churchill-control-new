  ...
  async preflight({ plan, channel }) {
    ...
    return {
      ...
      provider_payload_summary: {
        ...
        page_asset_id: translated.pageAssetId,
        instagram_asset_id: translated.instagramAssetId,
        whatsapp_asset_id: translated.whatsappAssetId,
        ...
        daily_budget_minor: translated.adSet.daily_budget,
