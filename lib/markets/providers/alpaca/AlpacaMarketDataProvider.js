...
export async function getStockSnapshot({ organizationId, symbol, feed = "iex" }) {
  ...
  return {
    ...
    latest_trade_at: latestTrade.t || null,
    latest_trade_id: latestTrade.i === undefined || latestTrade.i === null ? null : String(latestTrade.i),
    ...
    latest_quote_at: latestQuote.t || null,
    latest_quote_fingerprint: latestQuote.t
      ? fingerprint([
          "alpaca", feed, ticker, latestQuote.t, latestQuote.bp, latestQuote.bs,
          latestQuote.ap, latestQuote.as, latestQuote.bx, latestQuote.ax,
          latestQuote.c, latestQuote.z,
        ])
      : null,
