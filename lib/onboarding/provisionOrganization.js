...
export async function provisionOrganization(
  ...
  const wallet = await WalletRuntime.getOrCreate({
    ...
    currency: entity.currency || payload?.finance?.currency || "THB",
  });
  ...
  const restaurantWorkCenters = industry === "restaurant"
    ? await ensureRestaurantWorkCenters({
