...
const RETAIL_POS_APPLICATION = Object.freeze({
  ...
  presentation: Object.freeze({
    ...
    readinessTitle: "Retail settlement binding required",
    readinessDescription:
      "Catalog, stock visibility and draft sales orders are active. Finance settlement and confirmation-time stock reservation remain required before transactions can be completed.",
  }),
});
