...
const RETAIL_POS_APPLICATION = Object.freeze({
  ...
  modeOverrides: Object.freeze({
    sell: Object.freeze({ component: "retail-readiness" }),
    checkout: Object.freeze({ component: "retail-readiness" }),
    orders: Object.freeze({ component: "retail-readiness" }),
  ...
  presentation: Object.freeze({
    ...
    readinessTitle: "Retail transaction bindings required",
    readinessDescription:
      "Connect canonical catalog items, inventory availability, sales orders and finance settlement before retail transactions are activated.",
  }),
});
