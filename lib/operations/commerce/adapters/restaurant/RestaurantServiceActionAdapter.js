...
const POLICY_ACTIONS = Object.freeze({
  ...
  ASSIGN_ITEMS_TO_GROUP: "ASSIGN_ITEMS_TO_GROUP",
  UPDATE_BILL_GROUP: "ASSIGN_ITEMS_TO_GROUP",
  MOVE_GUESTS: "MOVE_GUESTS",
  MOVE_ASSIGNMENT: "MOVE_SEAT",
  MOVE_SEAT: "MOVE_SEAT",
  TRANSFER_CONTEXT: "TRANSFER_TABLE",
  TRANSFER_TABLE: "TRANSFER_TABLE",
  MERGE_CONTEXTS: "MERGE_TABLES",
  MERGE_TABLES: "MERGE_TABLES",
  CLOSE_CONTEXT: "CLOSE_TABLE",
...
export async function executeRestaurantServiceAction({
  ...
  const policyAction = POLICY_ACTIONS[normalizedAction];
  ...
  if (normalizedAction === "CHANGE_CUSTOMER") {
    ...
    return {
      ...
      execution: {
        requestId:
          execution.context?.requestId || null,
        correlationId:
          execution.context?.correlationId || null,
