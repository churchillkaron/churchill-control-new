...
const PAYMENT_CORRECTION_ROLES = new Set([
  "MANAGER",
  "GENERAL_MANAGER",
  "OWNER",
  "ORGANIZATION_OWNER",
...
const ACTION_POLICY = Object.freeze({
  ...
  PAYMENT_CORRECTION: Object.freeze({
    roles: PAYMENT_CORRECTION_ROLES,
    permissions: Object.freeze([]),
    exact_roles: true,
    fallback: false,
  }),
  ...
  VOID_ORDER_ITEM: Object.freeze({
    roles: SUPERVISOR_ROLES,
    permissions: Object.freeze([
      "operations.pos.manage",
      "operations.pos.override",
      "operations.pos.*",
      "restaurant.order.void",
      "restaurant.order.override",
      "restaurant.manager",
      "restaurant.*",
    ]),
    fallback: false,
  }),
  COMP_ORDER_ITEM: Object.freeze({
    roles: SUPERVISOR_ROLES,
    permissions: Object.freeze([
      "operations.pos.manage",
      "operations.pos.override",
      "operations.pos.*",
      "restaurant.order.comp",
      "restaurant.order.override",
      "restaurant.manager",
      "restaurant.*",
    ]),
...
export function canExecutePOSAction({ access, action } = {}) {
  ...
  if (!policy.exact_roles && FULL_ACCESS_ROLES.has(snapshot.role)) return true;
