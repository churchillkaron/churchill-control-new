...
import RetailPOSAdapter from "@/lib/operations/commerce/adapters/retail/RetailPOSAdapter";
import RetailPOSReadinessAdapter from "@/lib/operations/commerce/adapters/retail/RetailPOSReadinessAdapter";
import RetailReceiptAdapter from "@/lib/operations/commerce/adapters/retail/RetailReceiptAdapter";
...
import POSCashMovementAdapter from "@/lib/operations/commerce/adapters/shared/POSCashMovementAdapter";
import POSCashTransferAdapter from "@/lib/operations/commerce/adapters/shared/POSCashTransferAdapter";
import POSBankDepositAdapter from "@/lib/operations/commerce/adapters/shared/POSBankDepositAdapter";
import POSPettyCashAdapter from "@/lib/operations/commerce/adapters/shared/POSPettyCashAdapter";
...
const APPLICATIONS = Object.freeze([
  Object.freeze({
    ...
    adapter: Object.freeze({
      ...
      cashMovements: POSCashMovementAdapter,
      cashTransfers: POSCashTransferAdapter,
      bankDeposits: POSBankDepositAdapter,
      pettyCash: POSPettyCashAdapter,
  ...
  Object.freeze({
    ...
    adapter: Object.freeze({
      ...
      orders: RetailPOSAdapter,
      receipts: RetailReceiptAdapter,
      cashSessions: POSCashSessionAdapter,
      paymentCorrections: POSPaymentCorrectionAdapter,
      cashMovements: POSCashMovementAdapter,
      cashTransfers: POSCashTransferAdapter,
