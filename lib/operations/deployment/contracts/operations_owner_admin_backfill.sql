...
--
-- This SQL records the Operations owner/admin backfill contract that is
-- already deployed in production. It intentionally lives outside
-- supabase/migrations so it cannot become a new pending migration.
