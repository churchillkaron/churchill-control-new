...
} from "./CanonicalOperationsCapabilityCatalog";
import { getOperationsCapability } from "./OperationsCapabilityCatalog";
import { getOperationsCommerceCapability } from "./CommerceCapabilityCatalog";
...
export function buildOperationsRuntime(
  ...
  return Object.freeze({
    ...
    catalogue: CANONICAL_OPERATIONS_CAPABILITY_CATALOG,
    capabilities,
    repositories,
    getCapability,
    requireCapability,
...
export function getOperationsRuntimeCapability(capabilityId) {
  return getCanonicalOperationsCapability(capabilityId);
}
