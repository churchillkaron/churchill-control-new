...
function assertStudioVisualGenerationCertified(task = {}) {
  ...
  if (stillImageVisualGeneration(task)) {
    const stillPrevisualization =
      task.input?.requirements?.still_previsualization_blueprint || {};
    ...
    const stillProductionAuthority =
      task.input?.requirements?.still_production_authority || {};
