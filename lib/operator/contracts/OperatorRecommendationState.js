...
function normalizedProofDependency(value = {}) {
  ...
  return {
    ...
    result_fingerprint: text(source.result_fingerprint, 128) || null,
...
export function normalizeOperatorRecommendation(value = {}) {
  ...
  return {
    ...
    ...(proof ? { proof } : {}),
    ...(Object.keys(object(candidate.outcome_learning)).length
      ? { outcome_learning: object(candidate.outcome_learning) }
      : {}),
...
export function agreementWithOperatorRecommendation(
  ...
  const pendingExecution = {
    ...
    ...(boundRecommendation.outcome_learning
      ? { outcome_learning: boundRecommendation.outcome_learning }
      : {}),
