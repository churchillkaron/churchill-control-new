...
function governedRunPendingPresentation(agreementState, pendingExecution) {
  ...
  if (runStatus === "awaiting_confirmation") {
    return {
      ...
      detail: `${capabilityKey} is prepared only and is waiting for your exact confirmation. Nothing has executed yet.`,
  ...
  return {
    tone: "pending",
    label: "Awaiting approval",
    detail: `${capabilityKey} is prepared only. Nothing has executed yet.`,
    business_effect_verified: false,
  };
}
