...
export async function resolveBusinessDiagnosisPeriods({organizationId,entityId=null,baselinePeriodId=null,currentPeriodId=null,now=new Date(),loadPeriods=periodRows}={}){
...
export async function runBusinessPartnerBusinessDiagnosis(options={},dependencies={}){
  ...
  return {
    ...
    business_diagnosis:{contract:AVANTIQO_BUSINESS_PARTNER_BUSINESS_DIAGNOSIS_CONTRACT,class:receipt.diagnosis_class||diagnosisClass,periods,receipt_fingerprint:receipt.receipt_fingerprint||null,audit_projection_fingerprint:receipt.audit_projection_fingerprint||null,final_evidence_state:receipt.final_evidence_state||null,residual_material:receipt.residual_material===true,answer_boundary_status:receipt.answer_boundary_status||null,answer_unsupported_recommendation_outcome_detected:receipt.answer_unsupported_recommendation_outcome_detected===true,authority_effect:"NONE"},
