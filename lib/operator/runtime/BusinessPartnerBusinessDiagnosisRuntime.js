...
export async function runBusinessPartnerBusinessDiagnosis(options={},dependencies={}){
  ...
  if(liveProof.status!=="VERIFIED"||liveAnswerProof.status!=="VERIFIED") throw businessDiagnosisProofIntegrityError("BUSINESS_PARTNER_LIVE_RETURN");
  return {
