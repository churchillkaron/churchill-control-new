import { buildBusinessDiagnosisAuditProjectionFromReceipt, verifyBusinessDiagnosisAuditProjection } from "../../intelligence/runtime/AvantiqoBusinessDiagnosisReceiptRuntime.js";
...
export async function runBusinessPartnerBusinessDiagnosis(options={},dependencies={}){
  ...
  if(liveProof.status!=="VERIFIED") throw new Error("BUSINESS_DIAGNOSIS_LIVE_PROOF_MISMATCH");
  return {
