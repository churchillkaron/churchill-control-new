...
const GOVERNANCE = /APPROVAL|PERMISSION|AUTHORIZ|WALLET|BILLING|QUOTA|RATE_LIMIT/i;
const EXTERNAL = /PROVIDER.*UNAVAILABLE|EXTERNAL.*UNAVAILABLE|OUTAGE|NETWORK|DNS|503|502|504/i;
