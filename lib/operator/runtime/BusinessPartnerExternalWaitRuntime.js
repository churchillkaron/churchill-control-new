...
export async function registerBusinessPartnerExternalWait({ context = {}, run, step, wait_for = {} } = {}) {
  ...
  const row = {
    ...
    metadata: { contract: BUSINESS_PARTNER_EXTERNAL_WAIT_CONTRACT, authorization_effect:"NONE" },
...
export const BusinessPartnerExternalWaitRuntime = Object.freeze({contract:BUSINESS_PARTNER_EXTERNAL_WAIT_CONTRACT, register:registerBusinessPartnerExternalWait, consumeEvent:consumeBusinessPartnerExternalEvent});
