...
const CONTRACT = "AVANTIQO_INTELLIGENCE_CONTEXT_FINGERPRINT_V1";
...
export function intelligenceContextFingerprint({
  projectCheckpoint = {}, durableMemory = [], attachments = [], recentConversation = [], toolDescriptors = [],
} = {}) {
  const staticContext = { project_checkpoint: projectCheckpoint, durable_memory: durableMemory, attachments };
  ...
  return {
    ...
    volatile_context_fingerprint: fingerprint(volatileContext),
