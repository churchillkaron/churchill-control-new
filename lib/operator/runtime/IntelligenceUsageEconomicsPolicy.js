...
export function summarizeIntelligenceUsage(rows = []) {
  const summary = { calls: 0, fast_calls: 0, deep_calls: 0, input_tokens: 0, output_tokens: 0, estimated_context_tokens: 0, supplier_cost: 0, customer_price: 0, average_context_tokens: 0, fingerprinted_calls: 0, repeated_static_context_calls: 0, stable_context_reuse_ratio: 0 };
