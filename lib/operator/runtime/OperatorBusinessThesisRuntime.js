  ...
  try {
    const execution = await ServiceExecutionRuntime.execute({
      ...
      metadata: {
        ...
        autonomous_cognition: context?.metadata?.autonomous_cognition === true,
        autonomous_watch_version:
          text(context?.metadata?.autonomous_watch_version) || null,
        source: text(context?.metadata?.source) || null,
      },
      category: "AI",
    });
