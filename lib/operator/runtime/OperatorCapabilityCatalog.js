import { inferredVerificationDeclaration } from "./OperatorCapabilityVerificationDeclaration.mjs";
import {
  getDomainRuntime,
...
async function buildCatalog() {
  ...
  return catalog.map((item) => ({
    ...item,
    operator_verification: item.declared_operator_verification || inferredVerificationDeclaration(item, catalog),
  }));
}
