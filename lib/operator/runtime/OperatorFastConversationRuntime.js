...
const STRATEGIC_FOLLOW_UP_PATTERN = /\b(what should (?:we|i) do|what do you (?:suggest|recommend|think)|what(?:'s| is) your (?:suggestion|recommendation|advice|view)|how should (?:we|i) proceed|what next|next step)\b/i;
