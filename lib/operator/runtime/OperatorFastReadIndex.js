...
export const OPERATOR_FAST_READ_INDEX = Object.freeze([
  ...
  read({ key: "finance.customer_invoices.read", domain: "finance", capability: "customer_invoices", endpoint: "/api/finance/customer-invoices", scope: "entity", description: "Read current customer invoices, invoice status, customer details, line items, PDF preview and paid receipt preview.", aliases: ["customer invoice", "customer invoices", "latest invoice", "latest customer invoice", "show invoice", "show invoice preview", "invoice pdf", "paid receipt", "receipt preview"], queryFields:["id","invoice_id","partyId","party_id","include_lines","limit"] }),
