...
export function normalizeHumanBusinessPartnerUnderstanding(value) {
  ...
  return {
    ...
    execution_domain: ["none", "business", "product_engineering"].includes(executionDomain) ? executionDomain : "none",
    engineering_scope: ["single", "portfolio"].includes(engineeringScope) ? engineeringScope : null,
    engineering_mode: ["inspect", "change"].includes(engineeringMode) ? engineeringMode : null,
