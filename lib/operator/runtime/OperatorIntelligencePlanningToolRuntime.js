...
const CONTRACT = "AVANTIQO_OPERATOR_INTELLIGENCE_PLANNING_TOOLS_V13";
...
function createPlanGraphTool() {
  return {
    name: PLAN_TOOL_NAME,
    description: [
      "Build, assess, boundedly revise, deliberate, stress-test, validate, prioritize uncertainty, assess readiness, build structured provenance, assess contingency readiness, build a falsifiable decision outcome contract, assess later verified outcomes, assess commitment, or verify hierarchical goal and inherited-constraint consistency for governed Avantiqo Intelligence planning.",
    ...
    parameters: {
      type: "object",
      properties: {
        operation: { type: "string", enum: ["build", "assess", "revise", "deliberate", "stress_test", "validate_decision", "prioritize_uncertainty", "assess_readiness", "build_provenance", "assess_contingency", "build_outcome_contract", "assess_outcome", "assess_commitment", "assess_goal_constraints"] },
        goal: { type: "string" },
