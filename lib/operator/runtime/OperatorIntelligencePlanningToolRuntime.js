...
const CONTRACT = "AVANTIQO_OPERATOR_INTELLIGENCE_PLANNING_TOOLS_V5";
...
function createPlanGraphTool() {
  return {
    name: PLAN_TOOL_NAME,
    description: [
      "Build, assess, boundedly revise, deliberatively compare alternatives, stress-test decision robustness, or assess decision validity over time for a governed Avantiqo Intelligence plan graph.",
    ...
    parameters: {
      ...
      properties: {
        operation: {
          type: "string",
          enum: ["build", "assess", "revise", "deliberate", "stress_test", "validate_decision"],
        },
        goal: { type: "string" },
