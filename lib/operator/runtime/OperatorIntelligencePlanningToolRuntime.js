...
const CONTRACT = "AVANTIQO_OPERATOR_INTELLIGENCE_PLANNING_TOOLS_V4";
...
function createPlanGraphTool() {
  return {
    name: PLAN_TOOL_NAME,
    description: [
      "Build, assess, boundedly revise, deliberatively compare alternatives, or stress-test decision robustness for a governed Avantiqo Intelligence plan graph.",
    ...
    parameters: {
      ...
      properties: {
        operation: {
          type: "string",
          enum: ["build", "assess", "revise", "deliberate", "stress_test"],
        },
        goal: { type: "string" },
