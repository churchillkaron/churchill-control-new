...
export function externalResearchRequested(value) {
  ...
  if (FRONTIER_RESEARCH_PATTERN.test(message)) return true;
  ...
  return [
    {
      ...
      async execute(args = {}) {
        ...
        try {
          ...
          await safeLiveProgress(context, {
            lane: "intelligence",
            phase: "LIVE_READ_COMPLETE",
            status: "running",
            description: `Current evidence read completed: ${capabilityKey}.`,
            capability_key: capabilityKey,
            action: "read",
            read_only: true,
            mutation_possible: false,
          ...
          if (typeof onReadReceipt === "function") {
