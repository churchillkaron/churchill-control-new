...
const EXPLICIT_DEEP_PATTERN = /\b(think deeply|deep analysis|analy[sz]e deeply|full analysis|strategy|strategic|architecture|root cause|investigate|debug|challenge|autonomous|tradeoff|trade off|pros and cons|compare|comparison|decide|decision|what should|how should|which option|what would you do)\b/i;
