import { OperatorIntelligencePlanningToolRuntime } from "./OperatorIntelligencePlanningToolRuntime.js";
...
export function compileOwnedCognitivePlan(brief = {}) {
  ...
  const plan = OperatorIntelligencePlanningToolRuntime.buildPlan({
    goal,
    brief: source,
