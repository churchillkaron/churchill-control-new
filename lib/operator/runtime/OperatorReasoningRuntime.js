...
function actionResolutionRepairRequired(parsed, request) {
...
function fastVoiceFallbackReason(parsed, request) {
  ...
  if (actionResolutionRepairRequired(parsed, request)) {
...
`;
  ...
  const actionResolution = actionResolutionRepairRequired(parsed, request);
