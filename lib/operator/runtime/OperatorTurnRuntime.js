...
const VERIFIED_MUTATION_OUTCOME_CONTRACT =
  "AVANTIQO_OPERATOR_VERIFIED_MUTATION_OUTCOME_V2";
  ...
  return {
    ...
    decision: {
      ...
      response_text: state.verification_present
        ? "The action call returned, but I could not verify the business effect. I will not claim it completed or repeat the mutation automatically. Please review the current record state before retrying."
