...
function postCommitContinuationText(recommendation) {
  ...
  return focus
    ? `The verified commit is complete. Product Intelligence reassessed current main and selected the next bounded objective: ${focus} Say “next”, “continue”, or “do it” when you want me to run that next engineering cycle.`
    : "The verified commit is complete. Product Intelligence selected one next bounded engineering cycle. Say “next”, “continue”, or “do it” when you want me to run it.";
}
