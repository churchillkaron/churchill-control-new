...
function autonomousRunStatusText(run) {
  ...
  if (status === "awaiting_approval") {
    return "The requested action is paused for approval. I still have the exact pending action and will recheck approval before executing it.";
  }
  if (status === "executing") {
