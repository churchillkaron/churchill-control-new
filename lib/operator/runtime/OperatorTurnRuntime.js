...
function autonomousRunStatusText(run) {
  ...
  if (status === "awaiting_approval") {
    return "The action is confirmed but paused for approval. I still have the exact pending action and approval request and will recheck that same approval before executing it.";
  }
  if (status === "executing") {
...
function runResumeTurn({
  ...
  if (status === "awaiting_confirmation") {
    ...
    responseText = "The run is waiting for its exact stored approval request. I will recheck that request before executing the pending action.";
  } else {
