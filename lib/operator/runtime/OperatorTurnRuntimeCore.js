...
function businessPartnerRecoveryResumeAction(agreementState = {}) {
  ...
  if (!verifiedSelfHealing && !verifiedConfigurationRecovery && !verifiedTransientRecovery) return null;
        ...
        return {
          ...
          decision: {
            response_text: needsConfirmation
              ? "The repaired capability is now available. I restored the exact original action and it is ready for its normal confirmation."
              : `The repaired capability is now available, but its current governance still blocks execution (${blocked}).`,
