  ...
  return (Array.isArray(alerts) ? alerts : []).map((alert) => ({
    ...
    recommended_next_step:
      alert.alert_kind === "MISSED_CALL"
        ...
        : alert.alert_kind === "FOLLOW_UP" && alert.metadata?.business_partner_recovery
          ? "Let Business Partner continue the exact follow-up through its registered recovery path."
