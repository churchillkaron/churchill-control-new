...
export async function readSecretaryExecutiveBriefingV4({ context, payload = {} } = {}) {
  ...
  // V3 secretary_owned_count already includes executable Secretary follow-ups.
  // V4 exposes those rows in secretary_follow_through but must not count them twice.
