...
function humanMessage(reason, followUp) {
  ...
  if (normalized.startsWith("SECRETARY_COVERAGE_ROUTING_REVIEW_REQUIRED")) return "Avantiqo did not execute this external follow-up because temporary Secretary coverage is ambiguous or the delegated operator is unavailable. The canonical owner must review the handoff before any external action proceeds.";
