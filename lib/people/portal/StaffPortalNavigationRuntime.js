...
export const STAFF_PORTAL_STANDARD_NAVIGATION = Object.freeze([
  ...
  { key: "training", label: "Training", href: "/staff/training", icon: "Award" },
...
export function buildStaffPortalNavigation({
  ...
  const primarySurface = resolveStaffOperationalSurface({
  ...
  const adaptiveOperational = primarySurface?.href && primarySurface.id !== "my-day"
    ? [{
        key: `adaptive-${primarySurface.id}`,
        label: primarySurface.label,
        href: primarySurface.href,
        icon: primarySurface.id === "waiter-pos" || primarySurface.id === "pos" ? "CreditCard"
          : primarySurface.id === "kitchen" ? "ChefHat"
            : primarySurface.id === "housekeeping" ? "BedDouble"
              : primarySurface.id === "front-desk" ? "Bell"
                : primarySurface.id === "security-work" ? "ShieldCheck"
                  : primarySurface.id === "transport-work" ? "Route"
                    : primarySurface.id === "workshop-jobs" ? "Wrench"
                      : primarySurface.id === "school-work" ? "BriefcaseBusiness"
                        : "Activity",
        operational: true,
