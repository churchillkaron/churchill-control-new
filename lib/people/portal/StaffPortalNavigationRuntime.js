...
import { resolveStaffOperationalSurface } from "@/lib/operations/workforce/StaffOperationalSurfaceResolver";
...
export const STAFF_PORTAL_STANDARD_NAVIGATION = Object.freeze([
  ...
  { key: "schedule", label: "Schedule", href: "/staff/schedule", icon: "CalendarDays" },
  { key: "training", label: "Training", href: "/staff/training", icon: "GraduationCap" },
...
const ROLE_OPERATIONAL_SURFACES = Object.freeze([
  { key: "pos", label: "POS", route: "operations/pos", icon: "CreditCard", industries: ["restaurant", "bar", "nightclub", "food_beverage", "food-and-beverage", "retail", "shop", "store"], roles: ["WAITER", "CASHIER", "FOH"], departments: ["FOH", "SERVICE"] },
  { key: "bar", label: "Bar", route: "operations/bar", icon: "Wine", industries: ["restaurant", "bar", "nightclub", "food_beverage", "food-and-beverage"], roles: ["BAR", "BARTENDER"], departments: ["BAR"] },
  { key: "kitchen", label: "Kitchen", route: "operations/kitchen", icon: "ChefHat", industries: ["restaurant", "bar", "nightclub", "food_beverage", "food-and-beverage"], roles: ["KITCHEN", "CHEF", "COOK"], departments: ["KITCHEN", "BOH"] },
  { key: "front-desk", label: "Front Desk", route: "operations/front-desk", icon: "Bell", industries: ["hotel", "hospitality", "resort"], roles: ["FRONT_DESK", "RECEPTION", "RECEPTIONIST"], departments: ["FRONT_DESK", "RECEPTION"] },
  { key: "housekeeping", label: "Housekeeping", route: "operations/housekeeping", icon: "BedDouble", industries: ["hotel", "hospitality", "resort"], roles: ["HOUSEKEEPING", "HOUSEKEEPER"], departments: ["HOUSEKEEPING"] },
  { key: "maintenance", label: "Maintenance", route: "operations/maintenance", icon: "Wrench", industries: ["hotel", "hospitality", "resort"], roles: ["MAINTENANCE", "TECHNICIAN"], departments: ["MAINTENANCE", "ENGINEERING"] },
  { key: "concierge", label: "Concierge", route: "operations/concierge", icon: "ConciergeBell", industries: ["hotel", "hospitality", "resort"], roles: ["CONCIERGE"], departments: ["CONCIERGE"] },
  { key: "field-service", label: "My Field Work", route: "operations/field-service/technician", icon: "Route", industries: ["pest_control", "pest-control", "field_service", "services"], roles: ["TECHNICIAN", "FIELD_TECHNICIAN", "OPERATOR"], departments: ["FIELD_SERVICE"] },
]);
...
const OPERATIONAL_MODULES = Object.freeze([
  ...
  },
  {
    ...
    industries: ["restaurant", "bar", "nightclub", "food_beverage", "food-and-beverage"],
  },
  {
    key: "hotel",
    label: "Hotel",
    ...
    industries: ["hotel", "hospitality", "resort"],
  },
  {
    key: "pest-control",
    label: "Field Service",
    ...
    industries: ["pest_control", "pest-control", "field_service", "services"],
  },
  {
    key: "retail",
    label: "Retail",
  ...
  },
  {
    ...
    industries: ["construction", "contractor"],
  },
  {
    key: "documents",
    label: "Documents",
...
export function buildStaffPortalNavigation({
  ...
  const adaptiveSurface = resolveStaffOperationalSurface({
    organizationId: organizationKey,
    organization,
    staff,
    role: roleKey,
  });
  const adaptiveOperational = adaptiveSurface?.href && adaptiveSurface.href !== "/staff/my-day"
    ? [{
        key: adaptiveSurface.id || "adaptive-work",
        label: adaptiveSurface.label || "Work",
        href: adaptiveSurface.href,
        icon: adaptiveSurface.id === "waiter-pos" || adaptiveSurface.id === "pos" ? "CreditCard"
          : adaptiveSurface.id === "kitchen" ? "ChefHat"
            : adaptiveSurface.id === "housekeeping" ? "BedDouble"
              : adaptiveSurface.id === "front-desk" ? "Bell"
                : adaptiveSurface.id === "security-work" ? "ShieldCheck"
                  : adaptiveSurface.id === "transport-work" ? "Route"
                    : adaptiveSurface.id === "workshop-jobs" ? "Wrench"
                      : adaptiveSurface.id === "school-work" ? "BriefcaseBusiness"
                        : "Activity",
        operational: true,
        source: "adaptive_role_context",
      }]
    : [];
  ...
  for (const item of [...adaptiveOperational, ...roleOperational, ...permissionOperational]) {
