...
const PEOPLE_WORKFORCE_WORKSPACES = [
  ...
  },
  {
    ...
    route: "/people/qualifications",
    description:
      "Define governed qualifications, verify staff credential evidence and control service eligibility without duplicating People authority in Operations.",
    order: 45,
    status: "active",
    type: "business-workspace",
    document: "StaffQualification",
  },
  {
