...
export function createPeopleEmployeeCreateCapability() {
  const manifest = defineCapability({
    ...
    permissions: ["management.manage"], events: ["people.employee.created"], tags: ["people","employee","directory","employment","staff","hire"],
    operatorAliases: ["add employee", "add an employee", "add staff", "add a staff member", "create employee", "create staff member", "hire employee", "onboard employee"],
    operatorExamples: ["Add a new employee to this company.", "Create a staff member with their name and email."],
