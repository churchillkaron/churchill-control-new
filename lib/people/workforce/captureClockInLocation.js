export function captureClockInLocation({ timeoutMs = 15000 } = {}) {
  return new Promise((resolve, reject) => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        if (error?.code === 1) {
          reject(new Error("Location permission is required to start your shift"));
          return;
        }
...
export default captureClockInLocation;
