...
export function createBusinessPartnerExternalWaitCapability() {
  const manifest = defineCapability({
    ...
    description:"Persist a Business Partner mission checkpoint until one exact external event arrives. The event is evidence only and never mutation authority.",
