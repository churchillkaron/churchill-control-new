...
import {
  recordBusinessPartnerRepairProductEvidence,
...
export function createBusinessPartnerSelfHealingCapability() {
  ...
  async function execute({ context, payload = {} }) {
    ...
    result.product_evidence = await recordBusinessPartnerRepairProductEvidence({
      context,
      failed_action: failed,
      repair_result: result,
      failure_code: text(payload.error_code, 300) || null,
    });
    return result;
  }
