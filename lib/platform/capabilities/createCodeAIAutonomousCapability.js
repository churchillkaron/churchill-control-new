    ...
    inputSchema: {
      ...
      properties: {
        ...
        objective_context: {
          type: "object",
          description:
            "Optional bounded Product Intelligence provenance for the selected objective. This is inspection context only and never permission, approval, commit, deployment or migration authority.",
          properties: {
