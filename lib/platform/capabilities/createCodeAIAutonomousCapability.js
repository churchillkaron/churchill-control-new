    ...
    inputSchema: {
      ...
      properties: {
        ...
        execution_key: {
          ...
          description:
            "Opaque caller-chosen correlation key. It has no authorization effect. Reuse the exact same key in platform.code_ai_autonomous_status.verify when this action is executed inside a durable Operator mission.",
        },
