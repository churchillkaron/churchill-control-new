...
export function createCodeAIAutonomousCapability() {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        warm_session_idle_ms: {
          ...
          default: 600000,
          description:
            "Requested bounded warm-session idle window for interactive coding continuity. The fast-start runtime records this policy signal; infrastructure ownership remains governed separately.",
        },
        max_iterations: {
          type: "integer",
          minimum: 1,
  ...
  async function execute({ context, payload = {} }) {
    ...
    result.fast_start_contract = CODE_AI_EMPLOYEE_FAST_START_CONTRACT;
