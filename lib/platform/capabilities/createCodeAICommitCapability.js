import {
  ...
  promoteVerifiedCodeMissionReviewCommit,
...
import {
  assertCodeAIEngineeringOSCommitReady,
...
async function persistVerifiedCommitState({ context, executionKey, result, missionState }) {
  try {
...
export function createCodeAICommitCapability() {
  ...
  async function execute({ context, payload = {} }) {
    ...
    assertCodeAIEngineeringOSCommitReady(missionState);
    assertCodeAIEngineeringPrecisionCommitReady(missionState);
    ...
    if (result?.verified === true) {
      ...
      result = missionState?.review_delivery?.verified === true
        ? await promoteVerifiedCodeMissionReviewCommit({
            mission_state: missionState,
          })
        : await commitVerifiedCodeMission({
            mission_state: missionState,
