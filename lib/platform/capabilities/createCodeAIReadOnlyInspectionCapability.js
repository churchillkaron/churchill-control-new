...
import { readBusinessPartnerProductSurfaceEvidence } from "@/lib/operator/runtime/BusinessPartnerProductSurfaceEvidenceRuntime.js";
...
export function createCodeAIReadOnlyInspectionCapability() {
  ...
  async function execute({ context, payload = {} }) {
    if (context?.metadata?.evidenceOnly === true) {
      return readBusinessPartnerProductSurfaceEvidence({
