...
export function createOperatorAttentionCapability() {
  const manifest = defineCapability({
    ...
    description:
      "Build a proactive synthetic-intelligence business-partner brief from live registered read capabilities, organization context, and evidence-backed synthesis. Surface what matters now, what is changing, material risks, opportunities, and the strongest recommended next move. This capability is read-only: it may recommend registered actions but never executes, stages, confirms, approves, publishes, messages, pays, or mutates business state.",
    permissions: [],
    events: [],
    tags: [
      "platform",
    ...
    operatorAliases: [
      ...
      "what would you do if you were running this with me",
      "run the business with me",
      "be my business partner",
      "act like my business partner",
      "think ahead for me",
      "be proactive",
      "tell me what I am not seeing",
      "challenge my thinking",
      "what am I missing",
      "what should we do next as a business",
    ...
    operatorExamples: [
      ...
      "Be proactive and tell me what I am not seeing.",
      "Challenge my thinking and tell me the strongest next move.",
