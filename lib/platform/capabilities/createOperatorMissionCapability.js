...
function missionStepFailureEvidence(error, entry, phase) {
  ...
  return {
    ...
    action_identity_evidence: Array.isArray(error?.action_identity_evidence)
      ? error.action_identity_evidence.map((value) => text(value, 600)).filter(Boolean).slice(0, 50)
      : [],
