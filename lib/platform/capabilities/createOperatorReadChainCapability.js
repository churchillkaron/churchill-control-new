    ...
    inputSchema: {
      ...
      properties: {
        ...
        follow_up: {
          type: "object",
          description:
            "Optional exact non-read action explicitly requested by the user and dependent on the read evidence. It is staged for verification and confirmation only; it is never executed by this capability. verify_after may name one exact registered read that should confirm the action's business effect after execution.",
          required: ["capability_key"],
          properties: {
            capability_key: { type: "string" },
