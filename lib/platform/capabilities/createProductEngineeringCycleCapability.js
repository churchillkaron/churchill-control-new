    ...
    inputSchema: {
      ...
      properties: {
        ...
        continuation_focus: {
          ...
          maxLength: 2000,
          description:
            "Optional explicit broader area to carry into the single fresh post-commit reassessment. Leave absent to let Product Intelligence choose the next objective from current main without bias from the completed cycle.",
        },
        repository_url: {
          type: "string",
          maxLength: 500,
