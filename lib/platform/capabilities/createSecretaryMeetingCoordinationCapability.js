...
function schema(action) {
  ...
  if (action === "rescheduleBooked") {
    return {
      ...
      required: ["coordination_id", "starts_at", "ends_at", "evidence_id"],
      additionalProperties: false,
    };
  }
  if (action === "cancelBooked") {
    return {
      ...
      required: ["coordination_id", "evidence_id"],
      additionalProperties: false,
    };
  }
  return {
    type: "object",
    properties: { coordination_id: { type: "string" }, evidence_id: { type: "string" } },
    required: ["coordination_id", "evidence_id"],
    additionalProperties: false,
  };
}
