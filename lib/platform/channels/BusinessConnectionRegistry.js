...
export const BUSINESS_CONNECTION_REGISTRY = [
  {
    ...
    authModel: "OAUTH",
    platformRequirements: ["META_APP_ID", "META_APP_SECRET", ANY("META_GRAPH_API_VERSION", "META_GRAPH_VERSION")],
  },
  {
    id: "threads",
    name: "Threads",
  ...
  },
  {
    ...
    name: "TikTok",
    category: "Social media",
    description: "Connect the TikTok account used for publishing and performance insight.",
