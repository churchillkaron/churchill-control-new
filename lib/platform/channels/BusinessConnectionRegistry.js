...
export const BUSINESS_CONNECTION_REGISTRY = [
  {
    ...
    customerSetup: customerSetup("PROVIDER_AUTHORIZATION", "Sign in with Meta and choose the business assets"),
  },
  {
    id: "threads",
    name: "Threads",
  ...
  },
  {
    ...
    platformSetup: setup({
      summary: "One Avantiqo Shopify app authorizes customer stores.",
      callbackPaths: ["/api/shopify/auth/callback", "/api/shopify/webhooks"],
      steps: ["Configure the Avantiqo Shopify app, OAuth redirect URL and webhook destinations."],
    }),
    customerSetup: customerSetup("STORE_APPROVAL", "Enter the store address and approve Avantiqo in Shopify"),
  },
  {
    id: "tripadvisor",
    name: "Tripadvisor",
