...
const CUSTOMER_UI = {
  ...
  "line-business": { mergeId: "line", name: "LINE", category: "Messaging", description: "Connect the organization LINE Official Account for customer communication.", connectionProviders: ["line"], assetProviders: ["line"], assetTypes: ["line_official_account"], connectPath: "/api/line/auth", detailAnchor: null, availability: "active" },
