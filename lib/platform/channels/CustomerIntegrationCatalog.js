...
const CUSTOMER_UI = {
  facebook: {
    ...
    description: "Connect the business Facebook Page and Instagram account Avantiqo should manage.",
  ...
  "google-ads": {
    ...
    description: "Connect or activate the advertiser account used for paid campaigns.",
  ...
  "line-business": {
    ...
    name: "LINE",
    category: "Messaging",
    description: "Connect the organization LINE account for customer communication.",
...
const SUPPLEMENTAL = [
  {
    ...
    description: "Connect a business mailbox for customer communication and automated workflows.",
    connectionProviders: ["email"],
    connectPath: null,
    detailAnchor: null,
    availability: "planned",
  },
...
export function listCustomerIntegrations() {
  ...
  for (const channel of listChannels()) {
    ...
    rows.push({
      ...
      connectionProviders: ui.connectionProviders || [],
      assetProviders: ui.assetProviders || [],
      assetTypes: ui.assetTypes || [],
      connectPath: ui.connectPath || null,
      detailAnchor: ui.detailAnchor || null,
      availability: ui.availability || "planned",
    });
  }
