...
import FinanceCustomerPrepaymentManagementEngine from "@/components/workspace/engines/FinanceCustomerPrepaymentManagementEngine";
...
const CLIENT_ENGINES = {
  ...
  finance_customer_prepayment_management: FinanceCustomerPrepaymentManagementEngine,
  import: ImportEngine,
  export: ExportEngine,
  ai: AIEngine,
  ...
  channel_provision: ChannelConnectionEngine,
};
