...
const ExpenseAccountLookup = createAccountClassLookup({
  types: ["EXPENSE"],
  categories: ["COST_OF_SALES", "COGS", "OPERATING_EXPENSE", "FINANCIAL_EXPENSE", "OTHER_EXPENSE"],
});
const LiabilityAccountLookup = createAccountClassLookup({
  types: ["LIABILITY", "CURRENT_LIABILITY", "NON_CURRENT_LIABILITY"],
  categories: ["LIABILITY", "LIABILITIES", "CURRENT_LIABILITY", "NON_CURRENT_LIABILITY"],
});
const AccountsPayableAccountLookup = createAccountClassLookup({
  types: ["LIABILITY", "CURRENT_LIABILITY", "NON_CURRENT_LIABILITY"],
  categories: ["LIABILITY", "LIABILITIES", "CURRENT_LIABILITY", "NON_CURRENT_LIABILITY"],
  nameIncludes: ["ACCOUNTS PAYABLE", "TRADE PAYABLE"],
  requireNameMatch: true,
});
const DeferredRevenueAccountLookup = createAccountClassLookup({
  types: ["LIABILITY", "CURRENT_LIABILITY", "NON_CURRENT_LIABILITY"],
  categories: ["LIABILITY", "LIABILITIES", "CURRENT_LIABILITY", "NON_CURRENT_LIABILITY"],
  nameIncludes: ["DEFERRED REVENUE", "UNEARNED REVENUE", "CONTRACT LIABILITY"],
  requireNameMatch: true,
});
const BankGlAccountLookup = createAccountClassLookup({
  types: ["ASSET", "CASH", "CURRENT_ASSET"],
  categories: ["ASSET", "ASSETS", "CURRENT_ASSET"],
  nameIncludes: ["BANK", "CASH", "DEPOSIT"],
  requireNameMatch: true,
});
...
const REGISTRY = {
  ...
  "accounts_payable_accounts": AccountsPayableAccountLookup,
  "deferred_revenue_accounts": DeferredRevenueAccountLookup,
