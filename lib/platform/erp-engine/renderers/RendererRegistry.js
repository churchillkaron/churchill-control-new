...
import FinanceReportRuntimeWorkCenter from "@/components/workspace/finance/FinanceReportRuntimeWorkCenter";
import FinanceOperationalWorkCenter from "@/components/workspace/finance/FinanceOperationalWorkCenter";
...
function RegisteredMasterDataRuntimeWorkCenter(props) {
  ...
  if (String(capability?.id || "").toLowerCase() === "trial_balance") {
    return createElement(FinanceReportRuntimeWorkCenter, {
      ...base,
      capability: {
        ...capability,
...
function RegisteredFinanceReportRuntimeWorkCenter(props) {
  ...
  return createElement(FinanceReportRuntimeWorkCenter, baseFinanceProps(props, capability));
}
...
function RegisteredFinanceOperationalWorkCenter(props) {
  ...
  return createElement(FinanceOperationalWorkCenter, baseFinanceProps(props, capability));
}
