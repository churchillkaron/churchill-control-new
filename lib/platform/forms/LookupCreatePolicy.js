const MASTER_CREATE = Object.freeze({
  ...
  accounts_payable_accounts: { label: "Accounts Payable Account", route: "/finance/chart-of-accounts" },
  deferred_revenue_accounts: { label: "Deferred Revenue Account", route: "/finance/chart-of-accounts" },
