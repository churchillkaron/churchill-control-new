...
import {
  getFinanceFixedAssetFormContract,
} from "./FinanceFixedAssetFormContract";
import {
...
export function getForm(formId) {
  ...
  const fixedAssetForm = getFinanceFixedAssetFormContract(formId);
  if (fixedAssetForm) return fixedAssetForm;
