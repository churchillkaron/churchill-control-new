...
import {
  enforceFinanceWriteTargetFormContract,
} from "./FinanceWriteTargetFormContract";
import {
  enforceFinanceChartOfAccountsFormContract,
} from "./FinanceChartOfAccountsFormContract";
...
export function getForm(formId) {
  ...
  const writeTargetFields = enforceFinanceWriteTargetFormContract(
    formId,
    vendorPaymentFields
  );

  return enforceFinanceChartOfAccountsFormContract(
    formId,
    writeTargetFields
  );
}
