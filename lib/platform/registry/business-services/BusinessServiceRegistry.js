...
export const SERVICE_CATALOG = [
  {
    ...
    services: [
      ...
      },
      {
        id: "code-ai",
        name: "Code AI",
        description: "Software engineering assistance, code generation, repository analysis, debugging, and refactoring.",
        requires: ["CODE_AI"],
        default_enabled: true,
        package: "core",
      },
      ...
      },
      {
        id: "ocr",
        name: "OCR",
        description: "Extract and classify structured data from receipts, invoices, menus, IDs, and documents.",
        requires: ["OCR"],
    ...
    services: [
      {
        id: "facebook",
        name: "Facebook",
        description: "Facebook pages, posts, comments, campaigns, insights, and Messenger conversations.",
        requires: ["FACEBOOK"],
        execution_capabilities: [
      ...
      },
      {
        id: "instagram",
        name: "Instagram",
        description: "Instagram publishing, media, comments, campaigns, insights, and professional-account messaging.",
        requires: ["INSTAGRAM"],
        execution_capabilities: [
      ...
      },
      {
        id: "linkedin",
        name: "LinkedIn",
        description: "LinkedIn business publishing through an organization-authorized social identity.",
        requires: ["LINKEDIN"],
        execution_capabilities: [
      ...
      },
      {
        id: "threads",
        name: "Threads",
        description: "Threads publishing, replies and insights through an organization-authorized social identity.",
        requires: ["THREADS"],
        execution_capabilities: [
      ...
      },
      {
        id: "x",
        name: "X",
        description: "X publishing through an organization-authorized account.",
        requires: ["X"],
        execution_capabilities: [
          "marketing.x.publish",
        ],
      ...
      },
      {
        id: "tiktok",
        name: "TikTok",
        description: "TikTok creator-aware publishing with explicit privacy consent and asynchronous status tracking.",
        requires: ["TIKTOK"],
        execution_capabilities: [
      ...
      },
      {
        id: "pinterest",
        name: "Pinterest",
        description: "Pinterest organic publishing and board discovery through an organization-authorized Pinterest account.",
        requires: ["PINTEREST"],
        execution_capabilities: [
          "marketing.pinterest.publish",
          "marketing.pinterest.boards.read",
        ],
        default_enabled: false,
        package: "core",
      },
      {
        id: "youtube",
        name: "YouTube",
        description: "YouTube channel publishing and channel analytics through an organization-authorized Google identity.",
        requires: ["YOUTUBE"],
        execution_capabilities: [
      ...
      },
      {
        ...
        description: "Google Business Profile location discovery, reviews, replies, posts, photos, and local visibility.",
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        id: "email",
        name: "Email",
        description: "Connected business mailboxes for inbound synchronization, push wake-ups, replies, transactional email, campaigns, notifications, and document delivery.",
        requires: ["EMAIL"],
        execution_capabilities: [
          "communication.email.send",
          "communication.email.sync",
          "communication.email.subscribe",
        ],
        default_enabled: true,
        package: "core",
      },
