      ...
      groups: [
        {
          ...
          order: 10,
          items: [
            { id: "connected_services", name: "Avantiqo Services", route: "/services/connected-services", description: "Manage Avantiqo capabilities, intelligence services, usage and platform consumption.", order: 10, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", document: "AvantiqoService", status: "active",
...
ui:{ runtime:"wallet", api:"/api/platform/wallet" } },
            ...
            { id: "pricing", name: "Pricing", route: "/services/pricing", description: "Manage pricing and provider costs.", order: 40, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", document: "ServicePricing", status: "planned", ui:{ runtime:"pricing", api:"/api/platform/services/pricing" } },
            { id: "billing", name: "Billing", route: "/services/billing", description: "Customer billing and pass-through costs.", order: 50, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", document: "ServiceBilling", status: "planned", ui:{ runtime:"billing", api:"/api/platform/services/billing" } },
            { id: "budgets", name: "Budgets", route: "/services/budgets", description: "Usage budgets and spend limits.", order: 60, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", document: "ServiceBudget", status: "planned", ui:{ runtime:"budgets", api:"/api/platform/services/budgets" } },
            { id: "policies", name: "Policies", route: "/services/policies", description: "Execution policies and guardrails.", order: 70, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", document: "ServicePolicy", status: "planned", ui:{ runtime:"policies", api:"/api/platform/services/policies" } },
            { id: "health", name: "Health", route: "/services/health", description: "Provider health and operational status.", order: 80, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", document: "ServiceHealth", status: "planned", ui:{ runtime:"health", api:"/api/platform/services/health" } },
            { id: "logs", name: "Logs", route: "/services/logs", description: "Audit logs and execution history.", order: 90, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", document: "ServiceAuditLog", status: "planned", ui:{ runtime:"logs", api:"/api/platform/services/logs" } }
          ],
        },
        {
          id: "ai_intelligence",
          ...
          items: [
            {
              id:"ai_services",
              name:"AI Services",
              route:"/services/connected-services/ai",
              description:"AI providers, capabilities, usage and costs.",
              order:10,
              type:"business-workspace"
            }
          ],
          ...
          items: [
            {
              ...
              route:"/services/connected-services/communication",
              description:"Communication providers and channels.",
              order:10,
              type:"business-workspace"
            }
          ],
          ...
          items: [
            {
              ...
              route:"/services/connected-services/marketing",
              description:"Marketing, social and advertising providers.",
              order:10,
              type:"business-workspace"
            }
          ],
        },
        {
          ...
          order: 50,
          items: [
            { id: "stripe", name: "Stripe", route: "/services/stripe", description: "Stripe payments and billing.", order: 10, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", provider: "stripe", document: "ProviderConnection", status: "active" },
            { id: "paypal", name: "PayPal", route: "/services/paypal", description: "PayPal payments.", order: 20, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", provider: "paypal", document: "ProviderConnection", status: "planned" },
            { id: "adyen", name: "Adyen", route: "/services/adyen", description: "Adyen payments.", order: 30, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", provider: "adyen", document: "ProviderConnection", status: "planned" },
            { id: "square", name: "Square", route: "/services/square", description: "Square payments.", order: 40, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", provider: "square", document: "ProviderConnection", status: "planned" },
            { id: "wise", name: "Wise", route: "/services/wise", description: "Wise transfers and FX.", order: 50, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", provider: "wise", document: "ProviderConnection", status: "planned" }
          ],
        },
        {
          id: "crm_commerce",
          ...
          order: 60,
          items: [
            { id: "hubspot", name: "HubSpot", route: "/services/hubspot", description: "HubSpot CRM.", order: 10, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", provider: "hubspot", document: "ProviderConnection", status: "planned" },
            { id: "salesforce", name: "Salesforce", route: "/services/salesforce", description: "Salesforce CRM.", order: 20, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", provider: "salesforce", document: "ProviderConnection", status: "planned" },
            { id: "shopify", name: "Shopify", route: "/services/shopify", description: "Shopify commerce.", order: 30, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", provider: "shopify", document: "ProviderConnection", status: "planned" },
            { id: "woocommerce", name: "WooCommerce", route: "/services/woocommerce", description: "WooCommerce commerce.", order: 40, type: "business-workspace", renderer:"ServiceRuntimeWorkCenter", provider: "woocommerce", document: "ProviderConnection", status: "planned" },
