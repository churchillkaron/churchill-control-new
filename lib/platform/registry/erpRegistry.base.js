...
export const ERP_REGISTRY = {
  ...
  solutions: [
    ...
    { id: "markets", name: "Avantiqo Markets", route: "/solutions/markets", order: 90 },
  ],
      ...
      groups: [
        {
          ...
          items: [
            ...
            { id: "alerts", name: "Alerts", route: "/dashboard", description: "Review operational and financial alerts in the command center.", order: 20 },
          ...
          items: [
            {
              id: "sales_orders",
              name: "Sales Orders",
              route: "/commercial/sales/orders",
              description: "Create and confirm inventory, service and mixed customer orders.",
              order: 10,
              status: "active",
              ...
              create: {
                ...
                type: "document",
                id: "sales-order",
                endpoint: "/api/commercial/sales/orders",
                label: "+ Sales Order",
                title: "Sales Order",
              },
              runtime: {
                renderer: "CommercialSalesRuntimeWorkCenter",
                listApi: "/api/commercial/sales/orders",
              },
              data: {
                capability: "commercial_sales_order",
                repository: "SalesOrderService",
                identity: "sales_order_id",
              },
            },
            {
              id: "quotes",
              name: "Quotations",
              route: "/commercial/sales/quotes",
              description: "Prepare, send, accept and convert customer quotations.",
              order: 20,
              status: "active",
              type: "business-workspace",
              document: "Quotation",
              create: {
                ...
                type: "document",
                id: "quotation",
                endpoint: "/api/commercial/sales/quotations",
                label: "+ Quotation",
                title: "Quotation",
              },
              runtime: {
                renderer: "CommercialSalesRuntimeWorkCenter",
                listApi: "/api/commercial/sales/quotations",
              },
              data: {
                capability: "commercial_quotation",
                repository: "QuotationRepository",
                applicationService: "QuotationService",
                identity: "quotation_id",
              },
            },
  ...
  data:{
    capability:"customer_party",
    repository:"CustomerService",
    applicationService:"upsertCustomerParty",
    identity:"party_id"
  },
    ...
    },
    {
      ...
      label:"Archive Customer"
        ...
        },
        {
          ...
          order: 40,
          items: [
            { id: "reviews", name: "Reviews", route: "/commercial/reviews", description: "Manage reviews and reputation.", order: 10, status: "active" },
        ...
        },
        {
          ...
          items: [
            ...
            { id: "customer_invoices", name: "Customer Invoices", route: "/finance/customer-invoices", description: "Create and review customer invoices.", order: 20, status: "active" },
...
rowMenu:[
            ...
            },
            {
              ...
              route: "/procurement/supplier-network",
              description: "Discover published supplier shops and product catalogs without exposing customer-specific commercial data.",
              order: 14,
              type: "business-workspace",
              document: "SupplierNetwork",
            },
            {
              id: "supplier_portal_access",
              name: "Supplier Portal Access",
              route: "/procurement/supplier-access",
              description: "Invite suppliers into customer-scoped external portal access without internal workspace membership.",
              order: 15,
              type: "business-workspace",
              document: "SupplierPortalAccess",
            },
            {
              id: "supplier_prices",
...
enabled:true,
  type: "document",
                  ...
                  api: "/api/procurement/purchase-requests/create"
},
ui:{
topMenu:[
                { id: "new", type: "create" },
...
api:"/api/finance/chart-of-accounts/upsert",
                  label: "+ Account",
                  title: "Account",
                  inputSchema:{ type:"object", required:["account_code","account_name","account_type"], properties:{ account_code:{type:"string"}, account_name:{type:"string"}, account_type:{type:"string",enum:["ASSET","LIABILITY","EQUITY","REVENUE","EXPENSE"]}, account_category:{type:"string"}, normal_balance:{type:"string",enum:["DEBIT","CREDIT"]} }, additionalProperties:false }
},
ui:{
topMenu:[
                { id: "new", type: "create" },
...
inputSchema:{ type:"object", required:["posting_date","currency_code","exchange_rate","lines","idempotency_key"], properties:{ posting_date:{type:"string"}, document_date:{type:["string","null"]}, journal_type:{type:"string"}, reference:{type:["string","null"]}, source_module:{type:"string"}, source_document:{type:"string"}, source_document_id:{type:["string","null"]}, description:{type:["string","null"]}, currency_code:{type:"string"}, exchange_rate:{type:"number",exclusiveMinimum:0}, lines:{type:"array",minItems:1,items:{type:"object"}}, idempotency_key:{type:"string"} }, additionalProperties:false }
},
...
rowMenu:[
 ...
 api: "/api/finance/dimensions/runtime", rowsKey: "costCenters",  search: ["name","code","type"], name: r => r.name || "Unnamed Dimension", subtitle: r => [r.type || "-", r.code || "-"] }, runtime:{renderer:"MasterDataRuntimeWorkCenter",listApi:"/api/finance/dimensions/runtime"}, data:{capability:"cost_center"} },
            { id: "opening_balances", name: "Opening Balances", route: "/finance/opening-balances", description: "Load opening balances for new entities and clients.", order: 70, type: "business-workspace", document: "OpeningBalance", status: "active" },
            { id: "recurring_journals", name: "Recurring Journals", route: "/finance/recurring-journals", description: "Manage recurring journals and scheduled postings.", order: 80, type: "business-workspace", document: "RecurringJournal", status: "active" }
          ],
        },
        {
          id: "order_to_cash",
...
label:"+ Customer",
title:"Customer",
inputSchema:{ type:"object", required:["customer_name"], properties:{ customer_name:{type:"string"}, customer_phone:{type:["string","null"]}, customer_email:{type:["string","null"]}, party_type:{type:"string"}, entity_type:{type:"string"}, legal_name:{type:["string","null"]}, tax_id:{type:["string","null"]}, registration_number:{type:["string","null"]}, status:{type:"string"}, payment_terms:{type:["string","null"]}, credit_limit:{type:"number",minimum:0}, currency:{type:["string","null"]}, customer_tier:{type:["string","null"]}, preferred_payment_method:{type:["string","null"]}, external_reference:{type:["string","null"]}, billing_address:{type:["object","string","null"]}, shipping_address:{type:["object","string","null"]}, contacts:{type:"array",items:{type:"object"}}, tags:{type:"array",items:{type:"string"}}, addresses:{type:"array",items:{type:"object"}}, phones:{type:"array",items:{type:"string"}}, country_code:{type:["string","null"],minLength:2,maxLength:2}, language:{type:["string","null"]}, preferred_channel:{type:["string","null"]} }, additionalProperties:false }
},
...
rowMenu:[
 ...
 api: "/api/commercial/customers", rowsKey: "customers",  search: ["customer_name","customer_email","customer_phone","tax_id","tier","status"], name: r => r.customer_name || r.name || "Unnamed Customer", subtitle: r => [r.customer_email || r.email || "-", r.customer_phone || r.phone || "-"] },
...
rowMenu:[
                ...
                { id: "duplicate", type: "duplicate", label: "Duplicate as New Invoice" },
                { id: "attachments", type: "attachments" },
                { id: "history", type: "history" }
              ],
...
ui:{
 ...
 api: "/api/finance/customer-payments/list", rowsKey: "payments",  search: ["payment_number","customer_name","status","method"], name: r => r.payment_number || "Customer Payment", subtitle: r => [r.customer_name || "-", r.status || "-"] } },
            { id: "collections", name: "Collections", route: "/finance/collections", description: "Manage collections and overdue balances.", order: 50, type: "business-workspace", document: "CollectionCase", status: "active" },
            { id: "customer_statements", name: "Customer Statements", route: "/finance/customer-statements", description: "Generate and review customer statements.", order: 60, type: "business-workspace", document: "CustomerStatement", status: "active" },
            { id: "revenue_recognition", name: "Revenue Recognition", route: "/finance/revenue-recognition", description: "Recognize revenue according to rules.", order: 70, type: "business-workspace", document: "RevenueRecognitionSchedule", status: "active" }
          ],
        },
        {
          id: "procure_to_pay",
...
enabled:true,
  type: "document",
                  ...
                  label: "+ Vendor",
                  title: "Vendor",
                  inputSchema:{ type:"object", required:["legal_name"], properties:{ vendor_code:{type:["string","null"]}, legal_name:{type:"string"}, display_name:{type:["string","null"]}, tax_id:{type:["string","null"]}, email:{type:["string","null"]}, phone:{type:["string","null"]}, address:{type:["string","object","null"]}, payment_terms:{type:["string","null"]}, default_expense_account:{type:["string","null"]}, default_ap_account:{type:["string","null"]}, risk_level:{type:"string"}, notes:{type:["string","null"]}, is_active:{type:"boolean"}, is_blocked:{type:"boolean"} }, additionalProperties:false }
},
contextScope:"organization",
ui:{
topMenu:[
...
enabled:true,
  type: "document",
                  ...
                  inputSchema:{ type:"object", required:["supplier_party_id","items"], properties:{ supplier_party_id:{type:"string"}, warehouse_id:{type:["string","null"]}, purchase_request_id:{type:["string","null"]}, items:{type:"array",minItems:1,items:{type:"object",properties:{ item_id:{type:["string","null"]}, item_name:{type:["string","null"]}, name:{type:["string","null"]}, qty:{type:["number","string"]}, quantity:{type:["number","string"]}, unit_price:{type:["number","string"]}, price:{type:["number","string"]} },additionalProperties:false}}, ordered_by:{type:"string"}, approved_by:{type:["string","null"]}, currency:{type:"string"}, expected_delivery_date:{type:["string","null"]}, notes:{type:["string","null"]}, idempotency_key:{type:["string","null"]} }, additionalProperties:false }
},
contextScope:"entity",
data:{ identity:"purchase_order_id" },
ui:{
topMenu:[
                { id: "new", type: "create" },
                { id: "reports", type: "reports" },
...
enabled:true,
  type: "document",
                  id: "receipt",
                  api: "/api/procurement/receiving",
                  label: "+ Receipt",
                  title: "Receipt",
                  inputSchema:{ type:"object", required:["purchase_order_id"], properties:{ purchase_order_id:{type:"string"}, received_by:{type:"string"} }, additionalProperties:false }
},
contextScope:"entity",
data:{ identity:"goods_receipt_id" },
ui:{
topMenu:[
                { id: "new", type: "create" },
                { id: "reports", type: "reports" },
...
contextScope:"entity",
data:{ identity:"vendor_invoice_id" },
ui:{
topMenu:[
                { id: "new", type: "create" },
                { id: "reports", type: "reports" },
...
ui:{ api: "/api/finance/payments/list", rowsKey: "payables", search: ["reference_number","vendor_name","status"], name: r => r.reference_number || "Vendor Payment", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
            { id: "vendor_statements", name: "Vendor Statements", route: "/finance/vendor-statements", description: "Generate and review vendor statements.", order: 80, type: "business-workspace", document: "VendorStatement", status: "active" }
          ],
        },
        {
          id: "treasury",
...
enabled:true,
  type: "document",
                  ...
                  label: "+ Bank Account",
                  title: "Bank Account",
                  inputSchema:{ type:"object", required:["bank_name","account_name","account_number","currency_code"], properties:{ bank_name:{type:"string"}, account_name:{type:"string"}, account_number:{type:"string"}, currency_code:{type:"string",minLength:3,maxLength:3}, branch_name:{type:["string","null"]}, account_type:{type:["string","null"]}, finance_account_id:{type:["string","null"]}, is_default:{type:"boolean"}, active:{type:"boolean"}, is_active:{type:"boolean"} }, additionalProperties:false }
},
contextScope:"entity",
ui:{
topMenu:[
...
actions:[
  ...
  },
  {
    ...
    label:"Archive Account"
            ...
            { id: "cash_management", name: "Cash Management", route: "/finance/cash-management", description: "Manage cash positions and liquidity.", order: 20, type: "business-workspace", document: "CashPosition", status: "active" },
            { id: "bank_statements", name: "Bank Statements", route: "/finance/bank-statements", description: "Import and review bank statements.", order: 30, type: "business-workspace", document: "BankStatement", status: "active", create:{ enabled:true, type:"document", id:"bank_statement_import", label:"+ Import Statement", title:"Bank Statement", api:"/api/finance/bank-statements/import" }, contextScope:"entity", data:{ identity:"statement_import_id" } },
...
ui:{ api: "/api/finance/treasury/liquidity", rowsKey: "rows",   search: ["label","type","period"], name: r => r.label || "Cash Flow", subtitle: r => [r.type || "-", r.period || "-"] } },
            { id: "bank_reconciliation", name: "Bank Reconciliation", route: "/finance/bank-reconciliation", description: "Reconcile bank statements.", order: 50, type: "business-workspace", document: "BankReconciliation", status: "active" },
...
ui:{ api: "/api/finance/payments/list", rowsKey: "payables", search: ["reference_number","vendor_name","invoice_number","status"], name: r => r.reference_number || "Payment", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
            { id: "fx_revaluation", name: "FX Revaluation", route: "/finance/fx-revaluation", description: "Run and review foreign exchange revaluation.", order: 70, type: "business-workspace", document: "FXRevaluation", status: "active" }
          ],
        },
        {
          id: "compliance",
...
rowMenu:[
 ...
 api: "/api/finance/tax/runtime", rowsKey: "reports",  search: ["name","status","period"], name: r => r.name || "Tax Work", subtitle: r => [r.status || "-", r.period || "-"] } },
            { id: "vat_returns", name: "VAT Returns", route: "/finance/vat-returns", description: "Prepare, submit and track VAT returns.", order: 20, type: "business-workspace", document: "VATReturn", status: "active" },
...
enabled:true,
  type: "document",
                  ...
                  label: "+ Tax Code",
                  title: "Tax Code",
                  inputSchema:{ type:"object", required:["code","name","regime","accounting_standard"], properties:{ code:{type:"string"}, name:{type:"string"}, regime:{type:"string"}, accounting_standard:{type:"string"}, tax_type:{type:"string"}, rate:{type:"number",minimum:0}, effective_from:{type:["string","null"]}, effective_to:{type:["string","null"]}, is_active:{type:"boolean"} }, additionalProperties:false }
},
contextScope:"organization",
ui:{
topMenu:[
...
enabled:true,
  type: "document",
                  ...
                  label: "+ Asset",
                  title:"Asset",
                  inputSchema:{ type:"object", required:["asset_name","purchase_cost"], properties:{ asset_name:{type:"string"}, asset_category:{type:["string","null"]}, purchase_date:{type:["string","null"]}, purchase_cost:{type:"number",exclusiveMinimum:0}, useful_life_years:{type:"number",exclusiveMinimum:0}, salvage_value:{type:"number",minimum:0}, depreciation_method:{type:"string"}, supplier_party_id:{type:["string","null"]}, cost_center_id:{type:["string","null"]}, notes:{type:["string","null"]} }, additionalProperties:false }
},
contextScope:"entity",
ui:{
topMenu:[
...
actions:[
  ...
  },
  {
    ...
    api:"/api/finance/fixed-assets/archive"
            ...
            { id: "depreciation", name: "Depreciation", route: "/finance/depreciation", description: "Run and review depreciation.", order: 50, type: "business-workspace", document: "DepreciationRun", status: "active" },
...
data:{
 ...
 applicationService:"PeriodCloseApplicationService"
            ...
            { id: "statutory_filings", name: "Statutory Filings", route: "/finance/statutory-filings", description: "Prepare and track statutory reports and government submissions.", order: 90, type: "business-workspace", document: "StatutoryFiling", status: "active" }
          ],
        },
        {
          id: "enterprise",
...
label:"+ Legal Entity",
title:"Legal Entity",
inputSchema:{ type:"object", required:["code","legal_name","country","currency","timezone","locale"], properties:{ code:{type:"string"}, legal_name:{type:"string"}, display_name:{type:["string","null"]}, registration_number:{type:["string","null"]}, tax_id:{type:["string","null"]}, country:{type:"string",minLength:2,maxLength:2}, currency:{type:"string",minLength:3,maxLength:3}, timezone:{type:"string"}, locale:{type:"string"}, address:{type:["string","null"]}, phone:{type:["string","null"]}, email:{type:["string","null"]}, parent_entity_id:{type:["string","null"]}, is_holding_company:{type:"boolean"}, is_default_accounting_entity:{type:"boolean"}, is_active:{type:"boolean"} }, additionalProperties:false }
},
contextScope:"organization",
...
enabled:true,
  type: "document",
                  ...
                  label: "+ Cost Center",
                  title: "Cost Center",
                  inputSchema:{ type:"object", required:["code","name"], properties:{ code:{type:"string"}, name:{type:"string"}, type:{type:"string",enum:["OPERATIONAL","ADMINISTRATIVE","SALES","SERVICE","PROJECT","SHARED_SERVICE","OTHER"]}, parent_cost_center_id:{type:["string","null"]}, department_id:{type:["string","null"]}, manager_user_id:{type:["string","null"]}, description:{type:["string","null"]} }, additionalProperties:false }
},
contextScope:"entity",
ui:{
topMenu:[
...
enabled:true,
  type: "document",
                  ...
                  label: "+ Currency",
                  title: "Currency",
                  inputSchema:{ type:"object", required:["code","name"], properties:{ code:{type:"string",minLength:3,maxLength:3}, name:{type:"string"}, symbol:{type:["string","null"]}, decimal_places:{type:"integer",minimum:0,maximum:6}, is_active:{type:"boolean"} }, additionalProperties:false }
},
contextScope:"organization",
ui:{
topMenu:[
...
label:"+ Intercompany",
title:"Intercompany",
inputSchema:{ type:"object", required:["from_legal_entity_id","to_legal_entity_id","transaction_type","reference_number","transaction_date","posting_date","description","transaction_currency","amount","from_intercompany_account_id","from_offset_account_id","from_intercompany_side","to_intercompany_account_id","to_offset_account_id","to_intercompany_side","idempotency_key"], properties:{ from_legal_entity_id:{type:"string"}, to_legal_entity_id:{type:"string"}, transaction_type:{type:"string"}, reference_number:{type:"string"}, transaction_date:{type:"string"}, posting_date:{type:"string"}, due_date:{type:["string","null"]}, description:{type:"string"}, transaction_currency:{type:"string"}, amount:{type:"number",exclusiveMinimum:0}, from_exchange_rate:{type:["number","null"],exclusiveMinimum:0}, to_exchange_rate:{type:["number","null"],exclusiveMinimum:0}, from_intercompany_account_id:{type:"string"}, from_offset_account_id:{type:"string"}, from_intercompany_side:{type:"string"}, to_intercompany_account_id:{type:"string"}, to_offset_account_id:{type:"string"}, to_intercompany_side:{type:"string"}, idempotency_key:{type:"string"} }, additionalProperties:false }
},
contextScope:"organization",
ui:{
topMenu:[
...
data:{
  identity:"intercompany_transaction_id",
 capability:"intercompany",
...
enabled:true,
  type: "document",
                  ...
                  label: "+ Payment Term",
                  title: "Payment Term",
                  inputSchema:{ type:"object", required:["code","name","days"], properties:{ code:{type:"string"}, name:{type:"string"}, days:{type:"number",minimum:0}, description:{type:["string","null"]} }, additionalProperties:false }
},
contextScope:"organization",
ui:{
topMenu:[
...
label:"+ Budget",
title:"New Budget",
inputSchema:{ type:"object", required:["period_id","category","amount"], properties:{ period_id:{type:"string"}, currency_code:{type:"string"}, category:{type:"string"}, amount:{type:"number",minimum:0} }, additionalProperties:false }
},
contextScope:"entity",
ui:{
topMenu:[
...
permissions:{
  view:"finance.statements.view"
            ...
            { id: "report_builder", name: "Report Builder", route: "/finance/report-builder", description: "Build custom finance reports.", order: 40, type: "business-workspace", document: "ReportTemplate", status: "active" },
            { id: "scheduled_reports", name: "Scheduled Reports", route: "/finance/scheduled-reports", description: "Schedule recurring finance reports.", order: 50, type: "business-workspace", document: "ScheduledReport", status: "active" }
          ],
        },
        {
          id: "administration",
          ...
          order: 90,
          items: [
            { id: "organization_profile", name: "Organization Profile", route: "/finance/organization-profile", description: "Configure client/company accounting profile.", order: 10, type: "business-workspace", document: "FinanceOrganizationProfile", status: "active" },
            { id: "accounting_settings", name: "Accounting Settings", route: "/finance/accounting-settings", description: "Configure accounting behavior for this organization.", order: 20, type: "business-workspace", document: "AccountingSettings", status: "active" },
            { id: "number_sequences", name: "Number Sequences", route: "/finance/number-sequences", description: "Configure document numbering.", order: 30, type: "business-workspace", document: "NumberSequence", status: "active" },
            { id: "posting_rules", name: "Posting Rules", route: "/finance/posting-rules", description: "Configure posting and automation rules.", order: 40, type: "business-workspace", document: "PostingRule", status: "active" },
            { id: "approval_workflows", name: "Approval Workflows", route: "/finance/approval-workflows", description: "Configure approvals and controls.", order: 50, type: "business-workspace", document: "ApprovalWorkflow", status: "active" },
            { id: "government_connections", name: "Government Connections", route: "/finance/government-connections", description: "Connect tax authorities, VAT submission and statutory portals.", order: 60, type: "business-workspace", document: "GovernmentConnection", status: "active" },
            { id: "banking_integrations", name: "Banking Integrations", route: "/finance/banking-integrations", description: "Connect banking APIs and statement feeds.", order: 70, type: "business-workspace", document: "BankingIntegration", status: "active" },
            { id: "exchange_rates", name: "Exchange Rates", route: "/finance/exchange-rates", description: "Manage exchange rate sources and rates.", order: 80, type: "business-workspace", document: "ExchangeRate", status: "active" },
            { id: "e_invoicing", name: "E-Invoicing", route: "/finance/e-invoicing", description: "Configure e-invoicing networks and rules.", order: 90, type: "business-workspace", document: "EInvoicingSettings", status: "active" },
            { id: "document_templates", name: "Document Templates", route: "/finance/document-templates", description: "Configure finance document templates.", order: 100, type: "business-workspace", document: "DocumentTemplate", status: "active" },
            { id: "finance_permissions", name: "Finance Access", route: "/finance/permissions", description: "Assign organisation-scoped Finance roles to staff and external accountants.", order: 110, type: "business-workspace", document: "FinanceAccessAssignment",
...
permissions:{
  ...
  grant:"finance.permissions.grant"
      ...
      groups: [
        ...
        },
        {
          ...
          items: [
            ...
            { id: "compensation", name: "Compensation", route: "/people/compensation", description: "Configure salary, hourly rates, payroll frequency and payment profiles.", order: 15 },
            { id: "payroll_settings", name: "Payroll Settings", route: "/settings/payroll", description: "Configure payroll country, currency and calculation rules.", order: 17 },
      ...
      groups: [
        {
          ...
          items: [
            ...
            { id: "planning", name: "Planning", route: "/projects/planning", description: "Plan project schedules.", status: "planned", order: 20 },
            { id: "tasks", name: "Tasks", route: "/projects/tasks", description: "Manage project tasks.", status: "planned", order: 30 },
            { id: "time", name: "Time", route: "/projects/time", description: "Track project time.", status: "planned", order: 40 },
            { id: "costs", name: "Costs", route: "/projects/costs", description: "Track project costs.", status: "planned", order: 50 },
          ],
        },
      ],
    },
      ...
      groups: [
        {
          ...
          items: [
            ...
            { id: "outcome_engine", name: "Outcome Engine", route: "/analytics/outcomes", description: "Detect measurable business loss, prove supported causes and prepare governed interventions.", order: 50, status: "active", type: "business-workspace", document: "OutcomeFinding", runtime: { renderer: "OutcomeEngineWorkspace", listApi: "/api/platform/intelligence/outcomes" }, data: { capability: "analytics_outcome_engine", sources: ["customer_invoices", "vendor_invoices"] }, permissions: { view: "analytics.outcomes.view" } },
          ],
        },
      ],
    },
      ...
      groups: [
        {
          ...
          items: [
            ...
            { id: "finance_ai", name: "Finance AI", route: "/intelligence/finance", description: "Analyze finance and accounting.", status: "planned", order: 20 },
            { id: "operations_ai", name: "Operations AI", route: "/intelligence/operations", description: "Analyze operations and service.", status: "planned", order: 30 },
            { id: "marketing_ai", name: "Marketing AI", route: "/intelligence/marketing", description: "Generate campaigns and insights.", status: "planned", order: 40 },
          ],
        },
        {
          id: "automation",
          ...
          order: 20,
          items: [
            { id: "agents", name: "Agents", route: "/intelligence/agents", description: "Manage AI agents.", status: "planned", order: 10 },
            { id: "workflows", name: "Workflows", route: "/intelligence/workflows", description: "Automate business workflows.", status: "planned", order: 20 },
            { id: "knowledge", name: "Knowledge", route: "/intelligence/knowledge", description: "Manage AI knowledge.", status: "planned", order: 30 },
          ],
        },
      ],
    },
    ...
    administration: {
      ...
      description: "Manage organizational structure, user access, integrations and business connections.",
      groups: [
        {
        ...
        },
        {
          ...
          order: 10,
          items: [
            { id: "users", name: "Users", route: "/settings/users", description: "Manage users.", order: 10 }
          ],
        },
        {
          id: "platform",
...
export function getWorkspaceItemByRoute(route) {
  ...
  const workspaces = ERP_REGISTRY.workspaces || {};
  const routeWorkspaceId = cleanRoute.split("/").filter(Boolean)[0] || null;
  const orderedWorkspaces = Object.entries(workspaces).sort(([leftId], [rightId]) => {
    if (leftId === routeWorkspaceId) return -1;
    if (rightId === routeWorkspaceId) return 1;
    return 0;
  });

  for (const [workspaceKey, workspace] of orderedWorkspaces) {
    for (const group of workspace.groups || []) {
      for (const item of group.items || []) {
        const itemRoute =
          String(item.route || "")
