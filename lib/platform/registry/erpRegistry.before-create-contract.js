        ...
        },
        {
          ...
          items: [
            ...
            { id: "marketing_dashboard", name: "Dashboard", route: "/commercial/marketing/dashboard", description: "Review marketing performance.", order: 20, status: "active" },
            {
              ...
              workspaces: [
                { id:"mission", title:"Mission", engine:"mission", renderer:"dynamic" },
                { id:"director", title:"AI Director", engine:"director", renderer:"dynamic" },
                { id:"research", title:"Research", engine:"research", renderer:"dynamic" },
                { id:"planning", title:"Planning", engine:"planning", renderer:"dynamic" },
                { id:"actors", title:"Actors", engine:"actor", renderer:"dynamic" },
                { id:"assets", title:"Assets", engine:"asset", renderer:"dynamic" },
                { id:"voices", title:"Voices", engine:"voice", renderer:"dynamic" },
                { id:"music", title:"Music", engine:"music", renderer:"dynamic" },
                { id:"scenes", title:"Scenes", engine:"scene", renderer:"dynamic" },
                { id:"shots", title:"Shots", engine:"shot", renderer:"dynamic" },
                { id:"timeline", title:"Timeline", engine:"timeline", renderer:"dynamic" },
                { id:"render", title:"Rendering", engine:"render", renderer:"dynamic" },
                { id:"qa", title:"Quality", engine:"qa", renderer:"dynamic" },
                { id:"publishing", title:"Publishing", engine:"publishing", renderer:"dynamic" },
                { id:"learning", title:"Learning", engine:"learning", renderer:"dynamic" }
              ]
            },
      ...
      groups: [
        {
          ...
          order: 10,
          items: [
            { id: "chart_of_accounts", name: "Chart of Accounts", route: "/finance/chart-of-accounts", description: "Maintain account structure.", order: 10, type: "business-workspace", document: "Account", ui:{ api: "/api/finance/chart-of-accounts", rowsKey: "accounts", primaryAction: {
                  type: "document",
                  id: "account",
                  label: "+ Account",
                  title: "Account"
                }, search: ["account_code","account_name","account_type","category","status"], name: r => r.account_name || r.name || "Unnamed Account", subtitle: r => [r.account_code || "-", r.account_type || "-"] }, actions: [] },
...
ui:{ api: "/api/finance/general-ledger", rowsKey: "entries",   search: ["account_code","account_name","reference","description","created_at"], name: r => r.account_name || r.reference || "Ledger Entry", subtitle: r => [r.account_code || "-", r.created_at || "-"] } },
            { id: "journals", name: "Journals", route: "/finance/journals", description: "Create, review and reverse journal entries.", order: 30, type: "business-workspace", document: "JournalEntry", ui:{ api: "/api/finance/journals", rowsKey: "journals", primaryAction: {
                  type: "document",
                  id: "journal",
                  label: "+ Journal",
                  title: "Journal"
                }, search: ["journal_number","reference","description","status"], name: r => r.journal_number || r.reference || "Journal", subtitle: r => [r.status || "-", r.created_at || "-"] } },
...
ui:{ api: "/api/finance/trial-balance", rowsKey: "rows",   search: ["account_code","account_name","account_type"], name: r => r.account_name || "Trial Balance Line", subtitle: r => [r.account_code || "-", r.account_type || "-"] } },
            { id: "fiscal_periods", name: "Fiscal Periods", route: "/finance/fiscal-periods", description: "Manage fiscal periods and locks.", order: 50, type: "business-workspace", document: "FiscalPeriod", ui:{ api: "/api/finance/periods", rowsKey: "periods", primaryAction: {
                  type: "document",
                  id: "fiscal_period",
                  label: "+ Fiscal Period",
                  title: "Fiscal Period"
                }, search: ["name","code","status"], name: r => r.name || "Unnamed Period", subtitle: r => [r.start_date || "-", r.end_date || "-"] }, actions: [] },
            { id: "dimensions", name: "Dimensions", route: "/finance/dimensions", description: "Manage departments, cost centers and reporting dimensions.", order: 60, type: "business-workspace", document: "Dimension", ui:{ api: "/api/finance/dimensions/runtime", rowsKey: "dimensions", primaryAction: {
                  type: "document",
                  id: "dimension",
                  label: "+ Dimension",
                  title: "Dimension"
                }, search: ["name","code","type"], name: r => r.name || "Unnamed Dimension", subtitle: r => [r.type || "-", r.code || "-"] }, actions: [] },
...
ui:{ api: "/api/finance/accounts-receivable/list", rowsKey: "receivables",   search: ["customer_name","invoice_number","status","due_date"], name: r => r.customer_name || r.invoice_number || "Receivable", subtitle: r => [r.invoice_number || "-", r.status || "-"] } },
            { id: "customer_payments", name: "Customer Payments", route: "/finance/customer-payments", description: "Receive and allocate customer payments.", order: 40, type: "business-workspace", document: "CustomerPayment", launchFrom: ["customers","accounts_receivable"], ui:{ api: "/api/finance/customer-payments/list", rowsKey: "payments", primaryAction: {
                  type: "document",
                  id: "payment",
                  label: "+ Payment",
                  title: "Payment"
                }, search: ["payment_number","customer_name","status","method"], name: r => r.payment_number || "Customer Payment", subtitle: r => [r.customer_name || "-", r.status || "-"] } },
        ...
        },
        {
          ...
          order: 30,
          items: [
            { id: "vendors", name: "Vendors", route: "/finance/vendors", description: "Manage vendor finance records.", order: 10, type: "business-workspace", document: "Vendor", ui:{ api: "/api/finance/vendors", rowsKey: "vendors", primaryAction: {
                  type: "document",
                  id: "vendor",
                  label: "+ Vendor",
                  title: "Vendor"
                }, search: ["vendor_name","name","legal_name","vendor_email","email","vendor_phone","phone","tax_id","category","payment_terms","status"], name: r => r.vendor_name || r.name || r.legal_name || "Unnamed Vendor", subtitle: r => [r.vendor_code || r.code || "-", r.vendor_email || r.email || "-", r.vendor_phone || r.phone || "-"] }, actions: [ { type: "section", label: "Purchasing" }, { label: "New Bill", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/vendor-bills/new?vendorId=${row.id}` }, { label: "New Payment", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/vendor-payments/new?vendorId=${row.id}` }, { label: "Statement", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/vendor-statements?vendorId=${row.id}` }, { type: "section", label: "Maintenance" }, { label: "Edit Vendor", type: "select" }, { label: "Archive Vendor", danger: true } ] },
            { id: "purchase_orders", name: "Purchase Orders", route: "/finance/purchase-orders", description: "Review purchase commitments.", order: 20, type: "business-workspace", document: "PurchaseOrder", ui:{ api: "/api/procurement/purchase-orders/list", rowsKey: "purchaseOrders", primaryAction: {
                  type: "document",
                  id: "purchase_order",
                  label: "+ Purchase Order",
                  title: "Purchase Order"
                }, search: ["purchase_order_number","vendor_name","status"], name: r => r.purchase_order_number || "Purchase Order", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
            { id: "goods_receipts", name: "Goods Receipts", route: "/finance/goods-receipts", description: "Review received goods.", order: 30, type: "business-workspace", document: "GoodsReceipt", ui:{ api: "/api/procurement/receiving/list", rowsKey: "receipts", primaryAction: {
                  type: "document",
                  id: "receipt",
                  label: "+ Receipt",
                  title: "Receipt"
                }, search: ["receipt_number","vendor_name","status"], name: r => r.receipt_number || "Goods Receipt", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
            { id: "vendor_bills", name: "Vendor Bills", route: "/finance/vendor-bills", description: "Manage vendor bills and supplier invoices.", order: 40, type: "business-workspace", document: "VendorBill", ui:{ api: "/api/finance/vendor-invoices/list", rowsKey: "invoices", primaryAction: {
                  type: "document",
                  id: "vendor_bill",
                  label: "+ Vendor Bill",
                  title: "Vendor Bill"
                }, search: ["invoice_number","vendor_name","status","due_date"], name: r => r.invoice_number || "Vendor Bill", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
...
ui:{ api: "/api/finance/payments/list", rowsKey: "payables",   search: ["vendor_name","invoice_number","status","due_date"], name: r => r.vendor_name || r.invoice_number || "Payable", subtitle: r => [r.invoice_number || "-", r.status || "-"] } },
            { id: "vendor_payments", name: "Vendor Payments", route: "/finance/vendor-payments", description: "Prepare and execute vendor payments.", order: 70, type: "business-workspace", document: "VendorPayment", launchFrom: ["vendors","accounts_payable"], ui:{ api: "/api/finance/payments/list", rowsKey: "payables", primaryAction: {
                  type: "document",
                  id: "payment_run",
                  label: "+ Payment Run",
                  title: "Payment Run"
                }, search: ["reference_number","vendor_name","status"], name: r => r.reference_number || "Vendor Payment", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
...
ui:{ api: "/api/finance/treasury/liquidity", rowsKey: "rows",   search: ["label","type","period"], name: r => r.label || "Cash Flow", subtitle: r => [r.type || "-", r.period || "-"] } },
            ...
            { id: "payments", name: "Payments", route: "/finance/payments", description: "Manage outgoing and incoming payments.", order: 60, type: "business-workspace", document: "Payment", ui:{ api: "/api/finance/payments/list", rowsKey: "payables", primaryAction: {
                  type: "document",
                  id: "payment",
                  label: "+ Payment",
                  title: "Payment"
                }, search: ["reference_number","vendor_name","invoice_number","status"], name: r => r.reference_number || "Payment", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
        ...
        },
        {
          ...
          order: 50,
          items: [
            { id: "tax", name: "Tax", route: "/finance/tax", description: "Manage VAT, tax balances and tax work.", order: 10, type: "business-workspace", document: "TaxWorkItem", ui:{ api: "/api/finance/tax/runtime", rowsKey: "reports", primaryAction: {
                  type: "document",
                  id: "tax_work",
                  label: "+ Tax Work",
                  title: "Tax Work"
                }, search: ["name","status","period"], name: r => r.name || "Tax Work", subtitle: r => [r.status || "-", r.period || "-"] } },
            ...
            { id: "tax_codes", name: "Tax Codes", route: "/finance/tax-codes", description: "Manage tax codes.", order: 30, type: "business-workspace", document: "TaxCode", ui:{ api: "/api/finance/tax-codes", rowsKey: "taxCodes", primaryAction: {
                  type: "document",
                  id: "tax_code",
                  label: "+ Tax Code",
                  title: "Tax Code"
                }, search: ["code","name","rate"], name: r => r.name || "Unnamed Tax Code", subtitle: r => [String(r.rate || 0) + "%"] }, actions: [] },
            { id: "fixed_assets", name: "Fixed Assets", route: "/finance/fixed-assets", description: "Manage fixed assets.", order: 40, type: "business-workspace", document: "FixedAsset", ui:{ api: "/api/finance/fixed-assets/list", rowsKey: "assets", primaryAction: {
                  type: "document",
                  id: "asset",
                  label: "+ Asset",
                  title: "Asset"
                }, search: ["asset_number","name","category","status"], name: r => r.name || r.asset_name || "Fixed Asset", subtitle: r => [r.asset_number || "-", r.status || "-"] } },
...
ui:{ api: "/api/finance/audit-trail", rowsKey: "events",   search: ["event_type","actor","entity","created_at"], name: r => r.event_type || "Audit Event", subtitle: r => [r.actor || "-", r.created_at || "-"] } },
            { id: "period_close", name: "Period Close", route: "/finance/close", description: "Run month-end and year-end close.", order: 70, type: "business-workspace", document: "PeriodClose", ui:{ api: "/api/finance/close/runtime", rowsKey: "rows", primaryAction: {
                  type: "document",
                  id: "close_run",
                  label: "+ Close Run",
                  title: "Close Run"
                }, search: ["period","status"], name: r => r.period || "Close Run", subtitle: r => [r.status || "-"] } },
...
ui:{ api: "/api/finance/year-end/status", rowsKey: "items",   search: ["name","status"], name: r => r.name || "Year End Item", subtitle: r => [r.status || "-"] } },
        ...
        },
        {
          ...
          order: 60,
          items: [
            { id: "legal_entities", name: "Legal Entities", route: "/finance/legal-entities", description: "Manage legal entities.", order: 10, type: "business-workspace", document: "LegalEntity", ui:{ api: "/api/finance/legal-entities/list", rowsKey: "entities", primaryAction: {
                  type: "document",
                  id: "legal_entity",
                  label: "+ Legal Entity",
                  title: "Legal Entity"
                }, search: ["name","legal_name","code","country","tax_number","tax_id","registration_number"], name: r => r.name || r.legal_name || "Unnamed Entity", subtitle: r => [r.country || "-", r.code || "-"] }, actions: [] },
            { id: "cost_centers", name: "Cost Centers", route: "/finance/cost-centers", description: "Manage cost centers.", order: 20, type: "business-workspace", document: "CostCenter", ui:{ api: "/api/finance/cost-centers/list", rowsKey: "costCenters", primaryAction: {
                  type: "document",
                  id: "cost_center",
                  label: "+ Cost Center",
                  title: "Cost Center"
                }, search: ["code","name","type","manager"], name: r => r.name || "Unnamed Cost Center", subtitle: r => [r.code || "-", r.type || "-"] }, actions: [] },
            { id: "currencies", name: "Currencies", route: "/finance/currencies", description: "Manage currencies.", order: 30, type: "business-workspace", document: "Currency", ui:{ api: "/api/finance/currencies", rowsKey: "currencies", primaryAction: {
                  type: "document",
                  id: "currency",
                  label: "+ Currency",
                  title: "Currency"
                }, search: ["code","name","symbol"], name: r => r.name || "Unnamed Currency", subtitle: r => [String(r.code || "-"), String(r.symbol || "-")] }, actions: [] },
            { id: "intercompany", name: "Intercompany", route: "/finance/intercompany", description: "Manage intercompany activity.", order: 40, type: "business-workspace", document: "IntercompanyTransaction", ui:{ api: "/api/finance/intercompany/runtime", rowsKey: "transactions", primaryAction: {
                  type: "document",
                  id: "intercompany",
                  label: "+ Intercompany",
                  title: "Intercompany"
                }, search: ["transaction_number","from_entity","to_entity","status"], name: r => r.transaction_number || "Intercompany Transaction", subtitle: r => [r.from_entity || "-", r.to_entity || "-"] } },
            { id: "payment_terms", name: "Payment Terms", route: "/finance/payment-terms", description: "Manage payment terms.", order: 50, type: "business-workspace", document: "PaymentTerm", ui:{ api: "/api/finance/payment-terms", rowsKey: "paymentTerms", primaryAction: {
                  type: "document",
                  id: "payment_term",
                  label: "+ Payment Term",
                  title: "Payment Term"
                }, search: ["name","code","days"], name: r => r.name || "Unnamed Payment Term", subtitle: r => [String(r.days || 0) + " days"] }, actions: [] },
            { id: "consolidation", name: "Consolidation", route: "/finance/consolidation", description: "Consolidate financial results.", order: 60, type: "business-workspace", document: "ConsolidationRun", ui:{ api: "/api/finance/consolidation", rowsKey: "rows", primaryAction: {
                  type: "document",
                  id: "consolidation",
                  label: "+ Consolidation",
                  title: "Consolidation"
                }, search: ["name","status","period"], name: r => r.name || "Consolidation", subtitle: r => [r.status || "-", r.period || "-"] } }
          ],
        },
        {
          id: "management",
...
ui:{
  ...
  subtitle:r=>[r.period||"-",r.status||"-"]
            ...
            { id: "forecasting", name: "Forecasting", route: "/finance/forecast", description: "Prepare forecasts.", order: 20, type: "business-workspace", document: "Forecast", ui:{ api: "/api/finance/forecast", rowsKey: "rows", primaryAction: {
                  type: "document",
                  id: "forecast",
                  label: "+ Forecast",
                  title: "Forecast"
                }, search: ["name","period","status"], name: r => r.name || "Forecast", subtitle: r => [r.period || "-", r.status || "-"] } },
...
ui:{ api: "/api/finance/kpis", rowsKey: "rows",   search: ["name","category"], name: r => r.name || "KPI", subtitle: r => [r.category || "-"] } },
...
ui:{ api: "/api/finance/executive-dashboard/kpi", rowsKey: "rows",   search: ["name","category"], name: r => r.name || "Executive Metric", subtitle: r => [r.category || "-"] } },
...
ui:{ api: "/api/finance/health", rowsKey: "issues",   search: ["type","entry","severity"], name: r => r.type || "Health Issue", subtitle: r => [r.entry || "-", r.severity || "-"] } },
...
ui:{ api: "/api/finance/insights", rowsKey: "insights",   search: ["title","severity","category"], name: r => r.title || "Insight", subtitle: r => [r.category || "-", r.severity || "-"] } }
          ],
        },
        {
          id: "reporting",
...
ui:{ api: "/api/finance/reports/profit-loss", rowsKey: "rows",   search: ["name","period","statement_type"], name: r => r.name || "Financial Statement", subtitle: r => [r.period || "-", r.statement_type || "-"] } },
