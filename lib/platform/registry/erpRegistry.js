    ...
    services: {
      ...
      groups: [

        {
          ...
          items: [

            {
              ...
              description: "Available Avantiqo capabilities, intelligence services and consumption.",
              order: 10,
              type: "business-workspace",
...

        {
          ...
          description:"AI capabilities provided by Avantiqo.",
          order:20,
          ...
          items:[

            {
              ...
              description:"AI assistants, reasoning and generation capabilities.",
              order:10,
              type:"business-workspace",
              renderer:"ServiceRuntimeWorkCenter",
              document:"AIService"
...

            {
              ...
              description:"Design Studio, image, video, voice and creative generation.",
              order:20,
              type:"business-workspace",
              renderer:"ServiceRuntimeWorkCenter",
              document:"CreativeService"
            },
...

            {
              ...
              description:"OCR, classification and document understanding.",
              order:30,
              type:"business-workspace",
              renderer:"ServiceRuntimeWorkCenter",
...

            {
              ...
              description:"Campaign intelligence, publishing and growth automation.",
              order:40,
              type:"business-workspace",
              renderer:"ServiceRuntimeWorkCenter",
              document:"MarketingService"
            }
...

        {
          ...
          description:"AI agents, communication and workflow automation.",
          order:30,
