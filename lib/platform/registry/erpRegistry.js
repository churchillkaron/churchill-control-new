...
rowMenu:[
 ...
 api: "/api/finance/chart-of-accounts", rowsKey: "accounts",  search: ["account_code","account_name","account_type","category","status"], name: r => r.account_name || r.name || "Unnamed Account", subtitle: r => [r.account_code || "-", r.account_type || "-"] }, actions: [] },
...
ui:{ api: "/api/finance/trial-balance", rowsKey: "rows",   search: ["account_code","account_name","account_type"], name: r => r.account_name || "Trial Balance Line", subtitle: r => [r.account_code || "-", r.account_type || "-"] } },
 ...
 api: "/api/finance/periods", rowsKey: "periods",  search: ["name","code","status"], name: r => r.name || "Unnamed Period", subtitle: r => [r.start_date || "-", r.end_date || "-"] }, actions: [] },
...
rowMenu:[
 ...
 api: "/api/finance/dimensions/runtime", rowsKey: "dimensions",  search: ["name","code","type"], name: r => r.name || "Unnamed Dimension", subtitle: r => [r.type || "-", r.code || "-"] }, actions: [] },
...
ui:{ api: "/api/finance/payments/list", rowsKey: "payables",   search: ["vendor_name","invoice_number","status","due_date"], name: r => r.vendor_name || r.invoice_number || "Payable", subtitle: r => [r.invoice_number || "-", r.status || "-"] } },
 ...
 api: "/api/finance/payments/list", rowsKey: "payables",  search: ["reference_number","vendor_name","status"], name: r => r.reference_number || "Vendor Payment", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
...
ui:{ api: "/api/finance/treasury/liquidity", rowsKey: "rows",   search: ["label","type","period"], name: r => r.label || "Cash Flow", subtitle: r => [r.type || "-", r.period || "-"] } },
 ...
 api: "/api/finance/payments/list", rowsKey: "payables",  search: ["reference_number","vendor_name","invoice_number","status"], name: r => r.reference_number || "Payment", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
...
rowMenu:[
 ...
 api: "/api/finance/tax-codes", rowsKey: "taxCodes",  search: ["code","name","rate"], name: r => r.name || "Unnamed Tax Code", subtitle: r => [String(r.rate || 0) + "%"] }, actions: [] },
...
ui:{ api: "/api/finance/audit-trail", rowsKey: "events",   search: ["event_type","actor","entity","created_at"], name: r => r.event_type || "Audit Event", subtitle: r => [r.actor || "-", r.created_at || "-"] } },
            { id: "period_close", name: "Period Close", route: "/finance/close", description: "Run month-end and year-end close.", order: 70, type: "business-workspace", document: "PeriodClose", create:{
 ...
 api: "/api/finance/close/runtime", rowsKey: "rows",  search: ["period","status"], name: r => r.period || "Close Run", subtitle: r => [r.status || "-"] } },
...
ui:{ api: "/api/finance/year-end/status", rowsKey: "items",   search: ["name","status"], name: r => r.name || "Year End Item", subtitle: r => [r.status || "-"] } },
 ...
 api: "/api/finance/legal-entities/list", rowsKey: "entities",  search: ["name","legal_name","code","country","tax_number","tax_id","registration_number"], name: r => r.name || r.legal_name || "Unnamed Entity", subtitle: r => [r.country || "-", r.code || "-"] }, actions: [] },
...
rowMenu:[
 ...
 api: "/api/finance/cost-centers/list", rowsKey: "costCenters",  search: ["code","name","type","manager"], name: r => r.name || "Unnamed Cost Center", subtitle: r => [r.code || "-", r.type || "-"] }, actions: [] },
...
rowMenu:[
 ...
 api: "/api/finance/currencies", rowsKey: "currencies",  search: ["code","name","symbol"], name: r => r.name || "Unnamed Currency", subtitle: r => [String(r.code || "-"), String(r.symbol || "-")] }, actions: [] },
...
rowMenu:[
 ...
 api: "/api/finance/payment-terms", rowsKey: "paymentTerms",  search: ["name","code","days"], name: r => r.name || "Unnamed Payment Term", subtitle: r => [String(r.days || 0) + " days"] }, actions: [] },
...
runtime:{
  renderer:"MasterDataRuntimeWorkCenter",
  listApi:"/api/finance/reports/profit-loss"
},
      ...
      groups: [
        {
          ...
          items: [
            ...
            { id: "wallet", name: "Wallet", route: "/services/wallet", description: "Manage organization wallet.", order: 20, type: "business-workspace", renderer: "ServiceRuntimeWorkCenter", document: "ServiceWallet", status: "active",
create:{
enabled:true,
type:"capability",
id:"wallet_topup",
...
action:"TopUp",
form:"wallet-topup",
endpoint:"/api/ubte/execute"
},
ui:{ runtime:"wallet", api:"/api/platform/wallet" } },
            { id: "usage", name: "Usage", route: "/services/usage", description: "Review provider and platform usage.", order: 30, type: "business-workspace", renderer: "ServiceRuntimeWorkCenter", document: "ServiceUsage", status: "active", ui:{ runtime:"usage", api:"/api/platform/usage" } },
