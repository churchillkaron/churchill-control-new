...
export const ERP_REGISTRY = {
  ...
  workspaces: {
        ...
        },
        {
          ...
          items: [
            ...
            { id: "marketing_dashboard", name: "Dashboard", route: "/commercial/marketing/dashboard", description: "Review marketing performance.", order: 20, status: "active" },
            {
              ...
              navigation: [
                { id: "mission_control", name: "Mission Control", route: "/commercial/design" },
                { id: "brief", name: "Brief", route: "/commercial/design/brief" },
                { id: "research", name: "Research", route: "/commercial/design/research" },
                { id: "strategy", name: "Strategy", route: "/commercial/design/strategy" },
                { id: "concept", name: "Concept", route: "/commercial/design/concept" },
                { id: "storyboard", name: "Storyboard", route: "/commercial/design/storyboard" },
                { id: "production", name: "Production", route: "/commercial/design/production" },
                { id: "timeline", name: "Timeline", route: "/commercial/design/timeline" },
                { id: "assets", name: "Assets", route: "/commercial/design/assets" },
                { id: "render", name: "Render", route: "/commercial/design/render" },
                { id: "publish", name: "Publishing", route: "/commercial/design/publish" }
              ]
            },
      ...
      groups: [
        {
          ...
          items: [
            ...
            { id: "supplier_prices", name: "Supplier Prices", route: "/procurement/pricing", order: 20 },
            {
              ...
              ui: {
                ...
                primaryActionLabel: "+ Purchase Request",
                search: [
                  "request_number",
                  "requester",
                  "department",
        ...
        },
        {
          ...
          items: [
            ...
            { id: "put_away", name: "Put Away", route: "/receiving/put-away", order: 20 },
      ...
      groups: [
        {
          ...
          order: 10,
          items: [
            { id: "chart_of_accounts", name: "Chart of Accounts", route: "/finance/chart-of-accounts", description: "Maintain account structure.", order: 10, type: "business-workspace", document: "Account", ui: { api: "/api/finance/chart-of-accounts", rowsKey: "accounts", primaryActionLabel: "+ Account", search: ["account_code","account_name","account_type","category","status"], name: r => r.account_name || r.name || "Unnamed Account", subtitle: r => [r.account_code || "-", r.account_type || "-"] }, actions: [] },
            { id: "general_ledger", name: "General Ledger", route: "/finance/ledger", description: "Review ledger activity and balances.", order: 20, type: "business-workspace", document: "LedgerEntry", ui: { api: "/api/finance/general-ledger", rowsKey: "entries", primaryActionLabel: null, allowCreate: false, search: ["account_code","account_name","reference","description","created_at"], name: r => r.account_name || r.reference || "Ledger Entry", subtitle: r => [r.account_code || "-", r.created_at || "-"] } },
            { id: "journals", name: "Journals", route: "/finance/journals", description: "Create, review and reverse journal entries.", order: 30, type: "business-workspace", document: "JournalEntry", ui: { api: "/api/finance/journals", rowsKey: "journals", primaryActionLabel: "+ Journal", search: ["journal_number","reference","description","status"], name: r => r.journal_number || r.reference || "Journal", subtitle: r => [r.status || "-", r.created_at || "-"] } },
            { id: "trial_balance", name: "Trial Balance", route: "/finance/trial-balance", description: "Review trial balance by period.", order: 40, type: "business-workspace", document: "TrialBalanceLine", ui: { api: "/api/finance/trial-balance", rowsKey: "rows", primaryActionLabel: null, allowCreate: false, search: ["account_code","account_name","account_type"], name: r => r.account_name || "Trial Balance Line", subtitle: r => [r.account_code || "-", r.account_type || "-"] } },
            { id: "fiscal_periods", name: "Fiscal Periods", route: "/finance/fiscal-periods", description: "Manage fiscal periods and locks.", order: 50, type: "business-workspace", document: "FiscalPeriod", ui: { api: "/api/finance/periods", rowsKey: "periods", primaryActionLabel: "+ Fiscal Period", search: ["name","code","status"], name: r => r.name || "Unnamed Period", subtitle: r => [r.start_date || "-", r.end_date || "-"] }, actions: [] },
            { id: "dimensions", name: "Dimensions", route: "/finance/dimensions", description: "Manage departments, cost centers and reporting dimensions.", order: 60, type: "business-workspace", document: "Dimension", ui: { api: "/api/finance/dimensions/runtime", rowsKey: "dimensions", primaryActionLabel: "+ Dimension", search: ["name","code","type"], name: r => r.name || "Unnamed Dimension", subtitle: r => [r.type || "-", r.code || "-"] }, actions: [] },
        ...
        },
        {
          ...
          order: 20,
          items: [
            { id: "customers", name: "Customers", route: "/finance/customers", description: "Manage finance customer records.", order: 10, type: "business-workspace", document: "Customer", ui: { api: "/api/finance/customers", rowsKey: "customers", primaryActionLabel: "+ Customer", search: ["customer_name","customer_email","customer_phone","tax_id","tier","status"], name: r => r.customer_name || r.name || "Unnamed Customer", subtitle: r => [r.customer_email || r.email || "-", r.customer_phone || r.phone || "-"] }, actions: [ { type: "section", label: "Sales" }, { label: "New Invoice", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/customer-invoices/new?customerId=${row.id}` }, { label: "Invoices", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/customer-invoices?customerId=${row.id}` }, { label: "New Payment", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/customer-payments/new?customerId=${row.id}` }, { type: "section", label: "Accounting" }, { label: "Statement", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/customer-statements?customerId=${row.id}` }, { label: "Collections", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/collections?customerId=${row.id}` }, { type: "section", label: "Maintenance" }, { label: "Edit Customer", type: "select" }, { label: "Archive Customer", danger: true } ] },
            { id: "customer_invoices", name: "Customer Invoices", route: "/finance/customer-invoices", description: "Create, review, post and send customer invoices.", order: 20, type: "business-workspace", document: "CustomerInvoice", launchFrom: ["customers","accounts_receivable","commercial/customers"], ui: { api: "/api/finance/customer-invoices/list", rowsKey: "invoices", primaryActionLabel: "+ Invoice", search: ["invoice_number","customer_name","status","due_date"], name: r => r.invoice_number || "Customer Invoice", subtitle: r => [r.customer_name || "-", r.status || "-"] } },
            { id: "accounts_receivable", name: "Accounts Receivable", route: "/finance/ar", description: "Review receivable balances and activity.", order: 30, type: "business-workspace", document: "Receivable", ui: { api: "/api/finance/accounts-receivable/list", rowsKey: "receivables", primaryActionLabel: null, allowCreate: false, search: ["customer_name","invoice_number","status","due_date"], name: r => r.customer_name || r.invoice_number || "Receivable", subtitle: r => [r.invoice_number || "-", r.status || "-"] } },
            { id: "customer_payments", name: "Customer Payments", route: "/finance/customer-payments", description: "Receive and allocate customer payments.", order: 40, type: "business-workspace", document: "CustomerPayment", launchFrom: ["customers","accounts_receivable"], ui: { api: "/api/finance/customer-payments/list", rowsKey: "payments", primaryActionLabel: "+ Payment", search: ["payment_number","customer_name","status","method"], name: r => r.payment_number || "Customer Payment", subtitle: r => [r.customer_name || "-", r.status || "-"] } },
        ...
        },
        {
          ...
          order: 30,
          items: [
            { id: "vendors", name: "Vendors", route: "/finance/vendors", description: "Manage vendor finance records.", order: 10, type: "business-workspace", document: "Vendor", ui: { api: "/api/finance/vendors", rowsKey: "vendors", primaryActionLabel: "+ Vendor", search: ["vendor_name","name","legal_name","vendor_email","email","vendor_phone","phone","tax_id","category","payment_terms","status"], name: r => r.vendor_name || r.name || r.legal_name || "Unnamed Vendor", subtitle: r => [r.vendor_code || r.code || "-", r.vendor_email || r.email || "-", r.vendor_phone || r.phone || "-"] }, actions: [ { type: "section", label: "Purchasing" }, { label: "New Bill", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/vendor-bills/new?vendorId=${row.id}` }, { label: "New Payment", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/vendor-payments/new?vendorId=${row.id}` }, { label: "Statement", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/vendor-statements?vendorId=${row.id}` }, { type: "section", label: "Maintenance" }, { label: "Edit Vendor", type: "select" }, { label: "Archive Vendor", danger: true } ] },
            { id: "purchase_orders", name: "Purchase Orders", route: "/finance/purchase-orders", description: "Review purchase commitments.", order: 20, type: "business-workspace", document: "PurchaseOrder", ui: { api: "/api/procurement/purchase-orders/list", rowsKey: "purchaseOrders", primaryActionLabel: "+ Purchase Order", search: ["purchase_order_number","vendor_name","status"], name: r => r.purchase_order_number || "Purchase Order", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
            { id: "goods_receipts", name: "Goods Receipts", route: "/finance/goods-receipts", description: "Review received goods.", order: 30, type: "business-workspace", document: "GoodsReceipt", ui: { api: "/api/procurement/receiving/list", rowsKey: "receipts", primaryActionLabel: "+ Receipt", search: ["receipt_number","vendor_name","status"], name: r => r.receipt_number || "Goods Receipt", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
            { id: "vendor_bills", name: "Vendor Bills", route: "/finance/vendor-bills", description: "Manage vendor bills and supplier invoices.", order: 40, type: "business-workspace", document: "VendorBill", ui: { api: "/api/finance/vendor-invoices/list", rowsKey: "invoices", primaryActionLabel: "+ Vendor Bill", search: ["invoice_number","vendor_name","status","due_date"], name: r => r.invoice_number || "Vendor Bill", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
            { id: "invoice_matching", name: "Invoice Matching", route: "/finance/invoice-matching", description: "Match invoices, purchase orders and goods receipts.", order: 50, type: "business-workspace", document: "InvoiceMatch", ui: { api: "/api/finance/invoice-matching/runtime", rowsKey: "matches", primaryActionLabel: null, allowCreate: false, search: ["invoice_number","purchase_order_number","status"], name: r => r.invoice_number || "Invoice Match", subtitle: r => [r.purchase_order_number || "-", r.status || "-"] } },
            { id: "accounts_payable", name: "Accounts Payable", route: "/finance/ap", description: "Manage payables and vendor balances.", order: 60, type: "business-workspace", document: "Payable", ui: { api: "/api/finance/payments/list", rowsKey: "payables", primaryActionLabel: null, allowCreate: false, search: ["vendor_name","invoice_number","status","due_date"], name: r => r.vendor_name || r.invoice_number || "Payable", subtitle: r => [r.invoice_number || "-", r.status || "-"] } },
            { id: "vendor_payments", name: "Vendor Payments", route: "/finance/vendor-payments", description: "Prepare and execute vendor payments.", order: 70, type: "business-workspace", document: "VendorPayment", launchFrom: ["vendors","accounts_payable"], ui: { api: "/api/finance/payments/list", rowsKey: "payables", primaryActionLabel: "+ Payment Run", search: ["reference_number","vendor_name","status"], name: r => r.reference_number || "Vendor Payment", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
        ...
        },
        {
          ...
          order: 40,
          items: [
            { id: "bank_accounts", name: "Bank Accounts", route: "/finance/bank-accounts", description: "Manage bank accounts.", order: 10, type: "business-workspace", document: "BankAccount", ui: { api: "/api/finance/bank-accounts", rowsKey: "bankAccounts", primaryActionLabel: "+ Bank Account", search: ["bank_name","account_name","account_number","currency_code","branch_name"], name: r => r.account_name || "Unnamed Account", subtitle: r => [r.bank_name || "-", r.account_number || "-"] }, actions: [ { type: "section", label: "Banking" }, { label: "Transactions", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/bank-transactions?accountId=${row.id}` }, { label: "Payments", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/payments?accountId=${row.id}` }, { label: "Reconciliation", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/bank-reconciliation?accountId=${row.id}` }, { label: "Statement", href: ({ organizationId, row }) => `/workspace/${organizationId}/finance/bank-statements?accountId=${row.id}` }, { type: "section", label: "Import / Export" }, { label: "Import Statement", type: "import" }, { label: "Export", type: "export" }, { type: "section", label: "Maintenance" }, { label: "Edit Account", type: "select" }, { label: "Archive Account", danger: true } ] },
            ...
            { id: "cash_flow", name: "Cash Flow", route: "/finance/cash-flow", description: "Monitor cash inflows and outflows.", order: 40, type: "business-workspace", document: "CashFlowLine", ui: { api: "/api/finance/treasury/liquidity", rowsKey: "rows", primaryActionLabel: null, allowCreate: false, search: ["label","type","period"], name: r => r.label || "Cash Flow", subtitle: r => [r.type || "-", r.period || "-"] } },
            ...
            { id: "payments", name: "Payments", route: "/finance/payments", description: "Manage outgoing and incoming payments.", order: 60, type: "business-workspace", document: "Payment", ui: { api: "/api/finance/payments/list", rowsKey: "payables", primaryActionLabel: "+ Payment", search: ["reference_number","vendor_name","invoice_number","status"], name: r => r.reference_number || "Payment", subtitle: r => [r.vendor_name || "-", r.status || "-"] } },
        ...
        },
        {
          ...
          order: 50,
          items: [
            { id: "tax", name: "Tax", route: "/finance/tax", description: "Manage VAT, tax balances and tax work.", order: 10, type: "business-workspace", document: "TaxWorkItem", ui: { api: "/api/finance/tax/runtime", rowsKey: "reports", primaryActionLabel: "+ Tax Work", search: ["name","status","period"], name: r => r.name || "Tax Work", subtitle: r => [r.status || "-", r.period || "-"] } },
            ...
            { id: "tax_codes", name: "Tax Codes", route: "/finance/tax-codes", description: "Manage tax codes.", order: 30, type: "business-workspace", document: "TaxCode", ui: { api: "/api/finance/tax-codes", rowsKey: "taxCodes", primaryActionLabel: "+ Tax Code", search: ["code","name","rate"], name: r => r.name || "Unnamed Tax Code", subtitle: r => [String(r.rate || 0) + "%"] }, actions: [] },
            { id: "fixed_assets", name: "Fixed Assets", route: "/finance/fixed-assets", description: "Manage fixed assets.", order: 40, type: "business-workspace", document: "FixedAsset", ui: { api: "/api/finance/fixed-assets/list", rowsKey: "assets", primaryActionLabel: "+ Asset", search: ["asset_number","name","category","status"], name: r => r.name || r.asset_name || "Fixed Asset", subtitle: r => [r.asset_number || "-", r.status || "-"] } },
            ...
            { id: "audit_trail", name: "Audit Trail", route: "/finance/audit-trail", description: "Review finance audit history.", order: 60, type: "business-workspace", document: "AuditEvent", ui: { api: "/api/finance/audit-trail", rowsKey: "events", primaryActionLabel: null, allowCreate: false, search: ["event_type","actor","entity","created_at"], name: r => r.event_type || "Audit Event", subtitle: r => [r.actor || "-", r.created_at || "-"] } },
            { id: "period_close", name: "Period Close", route: "/finance/close", description: "Run month-end and year-end close.", order: 70, type: "business-workspace", document: "PeriodClose", ui: { api: "/api/finance/close/runtime", rowsKey: "rows", primaryActionLabel: "+ Close Run", search: ["period","status"], name: r => r.period || "Close Run", subtitle: r => [r.status || "-"] } },
            { id: "year_end", name: "Year End", route: "/finance/year-end", description: "Prepare year-end processing.", order: 80, type: "business-workspace", document: "YearEndClose", ui: { api: "/api/finance/year-end/status", rowsKey: "items", primaryActionLabel: null, allowCreate: false, search: ["name","status"], name: r => r.name || "Year End Item", subtitle: r => [r.status || "-"] } },
        ...
        },
        {
          ...
          order: 60,
          items: [
            { id: "legal_entities", name: "Legal Entities", route: "/finance/legal-entities", description: "Manage legal entities.", order: 10, type: "business-workspace", document: "LegalEntity", ui: { api: "/api/finance/legal-entities/list", rowsKey: "entities", primaryActionLabel: "+ Legal Entity", search: ["name","legal_name","code","country","tax_number","tax_id","registration_number"], name: r => r.name || r.legal_name || "Unnamed Entity", subtitle: r => [r.country || "-", r.code || "-"] }, actions: [] },
            { id: "cost_centers", name: "Cost Centers", route: "/finance/cost-centers", description: "Manage cost centers.", order: 20, type: "business-workspace", document: "CostCenter", ui: { api: "/api/finance/cost-centers/list", rowsKey: "costCenters", primaryActionLabel: "+ Cost Center", search: ["code","name","type","manager"], name: r => r.name || "Unnamed Cost Center", subtitle: r => [r.code || "-", r.type || "-"] }, actions: [] },
            { id: "currencies", name: "Currencies", route: "/finance/currencies", description: "Manage currencies.", order: 30, type: "business-workspace", document: "Currency", ui: { api: "/api/finance/currencies", rowsKey: "currencies", primaryActionLabel: "+ Currency", search: ["code","name","symbol"], name: r => r.name || "Unnamed Currency", subtitle: r => [String(r.code || "-"), String(r.symbol || "-")] }, actions: [] },
            { id: "intercompany", name: "Intercompany", route: "/finance/intercompany", description: "Manage intercompany activity.", order: 40, type: "business-workspace", document: "IntercompanyTransaction", ui: { api: "/api/finance/intercompany/runtime", rowsKey: "transactions", primaryActionLabel: "+ Intercompany", search: ["transaction_number","from_entity","to_entity","status"], name: r => r.transaction_number || "Intercompany Transaction", subtitle: r => [r.from_entity || "-", r.to_entity || "-"] } },
            { id: "payment_terms", name: "Payment Terms", route: "/finance/payment-terms", description: "Manage payment terms.", order: 50, type: "business-workspace", document: "PaymentTerm", ui: { api: "/api/finance/payment-terms", rowsKey: "paymentTerms", primaryActionLabel: "+ Payment Term", search: ["name","code","days"], name: r => r.name || "Unnamed Payment Term", subtitle: r => [String(r.days || 0) + " days"] }, actions: [] },
            { id: "consolidation", name: "Consolidation", route: "/finance/consolidation", description: "Consolidate financial results.", order: 60, type: "business-workspace", document: "ConsolidationRun", ui: { api: "/api/finance/consolidation", rowsKey: "rows", primaryActionLabel: "+ Consolidation", search: ["name","status","period"], name: r => r.name || "Consolidation", subtitle: r => [r.status || "-", r.period || "-"] } }
          ],
        },
        {
          id: "management",
          ...
          order: 70,
          items: [
            { id: "budgeting", name: "Budgeting", route: "/finance/budgeting", description: "Manage budgets.", order: 10, type: "business-workspace", document: "Budget", ui: { api: "/api/finance/budgeting/runtime", rowsKey: "rows", primaryActionLabel: "+ Budget", search: ["name","period","status"], name: r => r.name || "Budget", subtitle: r => [r.period || "-", r.status || "-"] } },
            { id: "forecasting", name: "Forecasting", route: "/finance/forecast", description: "Prepare forecasts.", order: 20, type: "business-workspace", document: "Forecast", ui: { api: "/api/finance/forecast", rowsKey: "rows", primaryActionLabel: "+ Forecast", search: ["name","period","status"], name: r => r.name || "Forecast", subtitle: r => [r.period || "-", r.status || "-"] } },
            { id: "finance_kpis", name: "KPIs", route: "/finance/kpis", description: "Review finance KPIs.", order: 30, type: "business-workspace", document: "FinanceKPI", ui: { api: "/api/finance/kpis", rowsKey: "rows", primaryActionLabel: null, allowCreate: false, search: ["name","category"], name: r => r.name || "KPI", subtitle: r => [r.category || "-"] } },
            { id: "executive_dashboard", name: "Executive Dashboard", route: "/finance/executive-dashboard", description: "Open finance executive reporting.", order: 40, type: "business-workspace", document: "ExecutiveDashboard", ui: { api: "/api/finance/executive-dashboard/kpi", rowsKey: "rows", primaryActionLabel: null, allowCreate: false, search: ["name","category"], name: r => r.name || "Executive Metric", subtitle: r => [r.category || "-"] } },
            { id: "financial_health", name: "Financial Health", route: "/finance/health", description: "Validate accounting integrity and finance health.", order: 50, type: "business-workspace", document: "FinanceHealthCheck", ui: { api: "/api/finance/health", rowsKey: "issues", primaryActionLabel: null, allowCreate: false, search: ["type","entry","severity"], name: r => r.type || "Health Issue", subtitle: r => [r.entry || "-", r.severity || "-"] } },
            { id: "ai_insights", name: "AI Insights", route: "/finance/insights", description: "AI-assisted finance insights and recommendations.", order: 60, type: "business-workspace", document: "FinanceInsight", ui: { api: "/api/finance/insights", rowsKey: "insights", primaryActionLabel: null, allowCreate: false, search: ["title","severity","category"], name: r => r.title || "Insight", subtitle: r => [r.category || "-", r.severity || "-"] } }
          ],
        },
        {
          id: "reporting",
          ...
          order: 80,
          items: [
            { id: "financial_statements", name: "Financial Statements", route: "/finance/statements", description: "Balance sheet, P&L and cash flow.", order: 10, type: "business-workspace", document: "FinancialStatement", ui: { api: "/api/finance/reports/profit-loss", rowsKey: "rows", primaryActionLabel: null, allowCreate: false, search: ["name","period","statement_type"], name: r => r.name || "Financial Statement", subtitle: r => [r.period || "-", r.statement_type || "-"] } },
        ...
        },
        {
          ...
          items: [
            ...
            { id: "finance_permissions", name: "Finance Permissions", route: "/finance/permissions", description: "Manage finance roles and access.", order: 110, type: "business-workspace", document: "FinancePermission", status: "planned" }
          ],
        }
      ],
    },
    ...
    services: {
      title: "Services",
      description: "Connect providers, manage usage, wallet, billing, automations and service operations.",
      groups: [
        {
          id: "platform",
          name: "Platform Services",
          description: "Wallet, usage, billing, health and platform service controls.",
          order: 10,
          items: [
            { id: "connected_services", name: "Connected Services", route: "/services/connected-services", description: "Manage connected platform services.", order: 10, type: "business-workspace", document: "ConnectedService", status: "active" },
            { id: "wallet", name: "Wallet", route: "/services/wallet", description: "Manage organization wallet.", order: 20, type: "business-workspace", document: "ServiceWallet", status: "active" },
            { id: "usage", name: "Usage", route: "/services/usage", description: "Review provider and platform usage.", order: 30, type: "business-workspace", document: "ServiceUsage", status: "active" },
            { id: "pricing", name: "Pricing", route: "/services/pricing", description: "Manage pricing and provider costs.", order: 40, type: "business-workspace", document: "ServicePricing", status: "planned" },
            { id: "billing", name: "Billing", route: "/services/billing", description: "Customer billing and pass-through costs.", order: 50, type: "business-workspace", document: "ServiceBilling", status: "planned" },
            { id: "budgets", name: "Budgets", route: "/services/budgets", description: "Usage budgets and spend limits.", order: 60, type: "business-workspace", document: "ServiceBudget", status: "planned" },
            { id: "policies", name: "Policies", route: "/services/policies", description: "Execution policies and guardrails.", order: 70, type: "business-workspace", document: "ServicePolicy", status: "planned" },
            { id: "health", name: "Health", route: "/services/health", description: "Provider health and operational status.", order: 80, type: "business-workspace", document: "ServiceHealth", status: "planned" },
            { id: "logs", name: "Logs", route: "/services/logs", description: "Audit logs and execution history.", order: 90, type: "business-workspace", document: "ServiceAuditLog", status: "planned" }
          ],
        },
        {
          id: "ai_intelligence",
          name: "AI & Intelligence",
          description: "AI providers, models, usage and intelligence services.",
          order: 20,
          items: [
            { id: "openai", name: "OpenAI", route: "/services/openai", description: "Connect and manage OpenAI.", order: 10, type: "business-workspace", provider: "openai", document: "ProviderConnection", status: "active" },
            { id: "anthropic", name: "Anthropic", route: "/services/anthropic", description: "Connect and manage Anthropic.", order: 20, type: "business-workspace", provider: "anthropic", document: "ProviderConnection", status: "active" },
            { id: "google_ai", name: "Google AI", route: "/services/google-ai", description: "Connect and manage Google AI.", order: 30, type: "business-workspace", provider: "google-ai", document: "ProviderConnection", status: "active" },
            { id: "azure_ai", name: "Azure AI", route: "/services/azure-ai", description: "Connect and manage Azure AI.", order: 40, type: "business-workspace", provider: "azure-ai", document: "ProviderConnection", status: "planned" },
            { id: "mistral", name: "Mistral", route: "/services/mistral", description: "Connect and manage Mistral.", order: 50, type: "business-workspace", provider: "mistral", document: "ProviderConnection", status: "planned" },
            { id: "ollama", name: "Ollama", route: "/services/ollama", description: "Connect and manage local models.", order: 60, type: "business-workspace", provider: "ollama", document: "ProviderConnection", status: "planned" }
          ],
        },
        {
          id: "communication",
          name: "Communication",
          description: "Messaging, email, SMS and customer communication providers.",
          order: 30,
          items: [
            { id: "email", name: "Email", route: "/services/email", description: "Email providers and routing.", order: 10, type: "business-workspace", document: "ProviderConnection", status: "planned" },
            { id: "sms", name: "SMS", route: "/services/sms", description: "SMS providers and message delivery.", order: 20, type: "business-workspace", document: "ProviderConnection", status: "planned" },
            { id: "whatsapp", name: "WhatsApp", route: "/services/whatsapp", description: "WhatsApp messaging.", order: 30, type: "business-workspace", provider: "twilio", document: "ProviderConnection", status: "planned" },
            { id: "telegram", name: "Telegram", route: "/services/telegram", description: "Telegram messaging.", order: 40, type: "business-workspace", provider: "telegram", document: "ProviderConnection", status: "planned" },
            { id: "line", name: "LINE", route: "/services/line", description: "LINE messaging.", order: 50, type: "business-workspace", provider: "line", document: "ProviderConnection", status: "planned" },
            { id: "messenger", name: "Messenger", route: "/services/messenger", description: "Facebook Messenger.", order: 60, type: "business-workspace", provider: "meta", document: "ProviderConnection", status: "planned" },
            { id: "sendgrid", name: "SendGrid", route: "/services/sendgrid", description: "SendGrid email delivery.", order: 70, type: "business-workspace", provider: "sendgrid", document: "ProviderConnection", status: "planned" },
            { id: "resend", name: "Resend", route: "/services/resend", description: "Resend email delivery.", order: 80, type: "business-workspace", provider: "resend", document: "ProviderConnection", status: "planned" }
          ],
        },
        {
          id: "marketing_social",
          name: "Marketing & Social",
          description: "Social media, advertising, reputation and publishing channels.",
          order: 40,
          items: [
            { id: "facebook", name: "Facebook", route: "/services/facebook", description: "Facebook pages and publishing.", order: 10, type: "business-workspace", provider: "meta", document: "ProviderConnection", status: "active" },
            { id: "instagram", name: "Instagram", route: "/services/instagram", description: "Instagram publishing and insights.", order: 20, type: "business-workspace", provider: "meta", document: "ProviderConnection", status: "active" },
            { id: "linkedin", name: "LinkedIn", route: "/services/linkedin", description: "LinkedIn pages and campaigns.", order: 30, type: "business-workspace", provider: "linkedin", document: "ProviderConnection", status: "planned" },
            { id: "tiktok", name: "TikTok", route: "/services/tiktok", description: "TikTok content and ads.", order: 40, type: "business-workspace", provider: "tiktok", document: "ProviderConnection", status: "planned" },
            { id: "x", name: "X", route: "/services/x", description: "X publishing and monitoring.", order: 50, type: "business-workspace", provider: "x", document: "ProviderConnection", status: "planned" },
            { id: "youtube", name: "YouTube", route: "/services/youtube", description: "YouTube channel and publishing.", order: 60, type: "business-workspace", provider: "youtube", document: "ProviderConnection", status: "planned" },
            { id: "google_business", name: "Google Business", route: "/services/google-business", description: "Google Business Profile.", order: 70, type: "business-workspace", provider: "google-business", document: "ProviderConnection", status: "active" },
            { id: "tripadvisor", name: "TripAdvisor", route: "/services/tripadvisor", description: "TripAdvisor reviews and reputation.", order: 80, type: "business-workspace", provider: "tripadvisor", document: "ProviderConnection", status: "planned" }
          ],
        },
        {
          id: "payments",
          name: "Payments",
          description: "Payment processors, payouts and financial service providers.",
          order: 50,
          items: [
            { id: "stripe", name: "Stripe", route: "/services/stripe", description: "Stripe payments and billing.", order: 10, type: "business-workspace", provider: "stripe", document: "ProviderConnection", status: "active" },
            { id: "paypal", name: "PayPal", route: "/services/paypal", description: "PayPal payments.", order: 20, type: "business-workspace", provider: "paypal", document: "ProviderConnection", status: "planned" },
            { id: "adyen", name: "Adyen", route: "/services/adyen", description: "Adyen payments.", order: 30, type: "business-workspace", provider: "adyen", document: "ProviderConnection", status: "planned" },
            { id: "square", name: "Square", route: "/services/square", description: "Square payments.", order: 40, type: "business-workspace", provider: "square", document: "ProviderConnection", status: "planned" },
            { id: "wise", name: "Wise", route: "/services/wise", description: "Wise transfers and FX.", order: 50, type: "business-workspace", provider: "wise", document: "ProviderConnection", status: "planned" }
          ],
        },
        {
          id: "crm_commerce",
          name: "CRM & Commerce",
          description: "CRM, ecommerce, accounting and customer platforms.",
          order: 60,
          items: [
            { id: "hubspot", name: "HubSpot", route: "/services/hubspot", description: "HubSpot CRM.", order: 10, type: "business-workspace", provider: "hubspot", document: "ProviderConnection", status: "planned" },
            { id: "salesforce", name: "Salesforce", route: "/services/salesforce", description: "Salesforce CRM.", order: 20, type: "business-workspace", provider: "salesforce", document: "ProviderConnection", status: "planned" },
            { id: "shopify", name: "Shopify", route: "/services/shopify", description: "Shopify commerce.", order: 30, type: "business-workspace", provider: "shopify", document: "ProviderConnection", status: "planned" },
            { id: "woocommerce", name: "WooCommerce", route: "/services/woocommerce", description: "WooCommerce commerce.", order: 40, type: "business-workspace", provider: "woocommerce", document: "ProviderConnection", status: "planned" },
            { id: "quickbooks", name: "QuickBooks", route: "/services/quickbooks", description: "QuickBooks accounting sync.", order: 50, type: "business-workspace", provider: "quickbooks", document: "ProviderConnection", status: "planned" },
            { id: "xero", name: "Xero", route: "/services/xero", description: "Xero accounting sync.", order: 60, type: "business-workspace", provider: "xero", document: "ProviderConnection", status: "planned" }
          ],
        },
        {
          id: "storage_productivity",
          name: "Storage & Productivity",
          description: "Files, documents, productivity suites and collaboration.",
          order: 70,
          items: [
            { id: "google_drive", name: "Google Drive", route: "/services/google-drive", description: "Google Drive storage.", order: 10, type: "business-workspace", provider: "google-drive", document: "ProviderConnection", status: "planned" },
            { id: "google_workspace", name: "Google Workspace", route: "/services/google-workspace", description: "Google Workspace.", order: 20, type: "business-workspace", provider: "google-workspace", document: "ProviderConnection", status: "planned" },
            { id: "microsoft_365", name: "Microsoft 365", route: "/services/microsoft-365", description: "Microsoft 365.", order: 30, type: "business-workspace", provider: "microsoft-365", document: "ProviderConnection", status: "planned" },
            { id: "s3", name: "S3", route: "/services/s3", description: "S3-compatible storage.", order: 40, type: "business-workspace", provider: "s3", document: "ProviderConnection", status: "planned" },
            { id: "slack", name: "Slack", route: "/services/slack", description: "Slack collaboration.", order: 50, type: "business-workspace", provider: "slack", document: "ProviderConnection", status: "planned" },
            { id: "teams", name: "Teams", route: "/services/teams", description: "Microsoft Teams.", order: 60, type: "business-workspace", provider: "teams", document: "ProviderConnection", status: "planned" }
          ],
        },
        {
          id: "identity_automation",
          name: "Identity & Automation",
          description: "Identity providers, automation, webhooks and APIs.",
          order: 80,
          items: [
            { id: "google", name: "Google", route: "/services/google", description: "Google identity and OAuth.", order: 10, type: "business-workspace", provider: "google", document: "ProviderConnection", status: "active" },
            { id: "microsoft", name: "Microsoft", route: "/services/microsoft", description: "Microsoft identity and OAuth.", order: 20, type: "business-workspace", provider: "microsoft", document: "ProviderConnection", status: "planned" },
            { id: "auth0", name: "Auth0", route: "/services/auth0", description: "Auth0 identity.", order: 30, type: "business-workspace", provider: "auth0", document: "ProviderConnection", status: "planned" },
            { id: "okta", name: "Okta", route: "/services/okta", description: "Okta identity.", order: 40, type: "business-workspace", provider: "okta", document: "ProviderConnection", status: "planned" },
            { id: "zapier", name: "Zapier", route: "/services/zapier", description: "Zapier automation.", order: 50, type: "business-workspace", provider: "zapier", document: "ProviderConnection", status: "planned" },
            { id: "make", name: "Make", route: "/services/make", description: "Make automation.", order: 60, type: "business-workspace", provider: "make", document: "ProviderConnection", status: "planned" },
            { id: "webhooks", name: "Webhooks", route: "/services/webhooks", description: "Webhook endpoints and event delivery.", order: 70, type: "business-workspace", provider: "avantiqo-webhooks", document: "ProviderConnection", status: "planned" },
            { id: "custom_api", name: "Custom API", route: "/services/custom-api", description: "Custom API connections.", order: 80, type: "business-workspace", document: "ProviderConnection", status: "planned" }
          ],
        }
      ],
    },
