...
} from "../../../intelligence/runtime/AvantiqoProvisionalKnowledgeShadowRuntime.js";
import {
...
} from "./OperatorMechanismResearchSpendGuard.js";
...
export async function runOperatorMechanismResearch({
  ...
  const synthesisResult = await AvantiqoStructuredIntelligenceSupervisorRuntime.run({
    ...
    metadata: {
      ...
      mechanism_research_contract: OPERATOR_MECHANISM_RESEARCH_CONTRACT,
      mechanism_research_spend_guard_contract: spendAuthorization.contract,
      mechanism_research_spend_approved: spendAuthorization.spend_approved,
  ...
  return {
    ...
    governance: {
      ...
      implementation_reference_is_evidence_not_answer: true,
      external_evidence_untrusted: true,
      synthesis_spend_guard_contract: spendAuthorization.contract,
      synthesis_spend_approved: spendAuthorization.spend_approved,
      synthesis_spend_authorization_effect: spendAuthorization.authorization_effect,
