...
export async function compareOperatorResearchEvidence({
  ...
  // Evidence reconciliation is a core learning dependency. Keep it on the proven
  // Deep lane instead of the experimental bounded Fast path so Fast availability
  // can never stop continuous learning from retaining verified public knowledge.
