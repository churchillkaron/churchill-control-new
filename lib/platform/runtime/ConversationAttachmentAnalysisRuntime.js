...
const UNIVERSAL_VISUAL_ANALYSIS_INSTRUCTION = [
  ...
  "For recipes or recipe cards, preserve dish_code/menu_item_code when visibly present and return ingredients/recipe_items with exact visible item_code or SKU, quantity, unit/UOM, and usable yield percentage when explicitly present. Never invent an inventory code from an ingredient name, never infer a unit that is not evidenced, and never invent a yield percentage.",
