...
export const PlatformDomainRuntime = {
  ...
  capabilities: {
    ...
    secretary_meeting_closeout: {
      ...
      reviseMinutes: async () => createSecretaryMeetingCloseoutCapability("reviseMinutes"),
    ...
    secretary_travel_operations: {
      ...
      recordCancellation: async () => createSecretaryTravelOperationsCapability("recordCancellation"),
