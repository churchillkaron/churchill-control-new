...
export async function loadOrganizationPolicy({ organizationId }) {
  ...
  const faceVerificationRequired = explicitBoolean(
    workforce?.face_verification_required,
    false
  );
  ...
  return {
    ...
    workforce: {
      ...
      face_liveness_required: faceVerificationRequired
        ? true
        : explicitBoolean(workforce?.face_liveness_required, true),
    },
  };
}
...
export async function saveOrganizationPolicy({
  ...
  const faceVerificationRequired = Boolean(
    workforce.face_verification_required
  );
  ...
  const nextWorkforce = {
    ...
    gps_clock_in_required:
      Boolean(workforce.gps_clock_in_required) || faceVerificationRequired,
