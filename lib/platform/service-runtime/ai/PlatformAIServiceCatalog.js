export const PLATFORM_AI_SERVICES = [
  ...
  {
    id: "ai.audio.vocal-role-separate",
    name: "Vocal Role Separation",
    category: "ai",
    requires: ["SEPARATE_VOCAL_ROLES"],
  },
  {
    id: "ai.audio.vocal-correct",
    name: "Vocal Pitch & Timing Correction",
    category: "ai",
    requires: ["VOCAL_CORRECTION"],
  },
  {
    id: "ai.audio.singing-voice-convert",
    name: "Authorized Singing Voice Conversion",
    category: "ai",
    requires: ["SINGING_VOICE_CONVERSION"],
  },
  {
    id: "ai.audio.elastic-warp",
    name: "Elastic Audio Warp",
    category: "ai",
    requires: ["ELASTIC_AUDIO_WARP"],
  },
  {
    id: "ai.audio.mix",
    name: "Audio Mix",
