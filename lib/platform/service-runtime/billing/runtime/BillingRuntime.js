...
} from "../../../contracts/finance/FinanceBillingContract.js";
import {
  resolveFinanceExchangeRate,
} from "../../../../finance/currencies/FinanceExchangeRateResolver.js";
...
async function processUsage({ usage_id }) {
  const usage = await getBillingById(usage_id);
  ...
  const line = await BillingRepository.createLine({
    ...
    metadata: {
      ...
      service_usage_created_at: usage.created_at || null,
      source: "SERVICE_USAGE",
    },
  });
