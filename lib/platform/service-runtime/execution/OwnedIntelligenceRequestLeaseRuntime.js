...
const DEFAULT_OPEN_PROPAGATION_SETTLE_MS = 0;
...
async function patchWorkers(endpointId, workersMax, config) {
  ...
  if (workersMax === 1) {
    const settleMs = Math.max(0, Math.min(5000, Number(
