...
export const AVANTIQO_OWNED_MODEL_CATALOG = Object.freeze({
  "avantiqo-intelligence": Object.freeze({
    models: Object.freeze({
      ...
      "Qwen/Qwen3-30B-A3B-Instruct-2507": Object.freeze({
        license: "apache-2.0",
        license_verified: true,
  ...
  "avantiqo-image": Object.freeze({
    models: Object.freeze({
      ...
      "qwen2.5vl:3b": Object.freeze({
        license: "apache-2.0",
        license_verified: true,
        source: "https://ollama.com/library/qwen2.5vl:3b",
        runtime_compatible: true,
        local_edge_runtime: true,
        quantization: "Q4_K_M",
        capabilities: Object.freeze([
          "document.ocr",
          "document.classify",
  ...
  "avantiqo-video": Object.freeze({
    models: Object.freeze({
      "Lightricks/LTX-2.5": Object.freeze({
        license: "ltx-2.x-community-license-agreement",
        license_verified: true,
        source: "https://huggingface.co/Lightricks/LTX-2.5",
        runtime_compatible: true,
        commercial_use_terms_require_eligibility_or_separate_license: true,
        capabilities: Object.freeze([
          "ai.video.generate",
      ...
      "JunhaoZhuang/FlashVSR-v1.1": Object.freeze({
        license: "apache-2.0",
        license_verified: true,
        source: "https://huggingface.co/JunhaoZhuang/FlashVSR-v1.1",
        runtime_compatible: true,
  ...
  "avantiqo-audio": Object.freeze({
    models: Object.freeze({
      "OpenMOSS-Team/MOSS-SoundEffect-v2.0": Object.freeze({
        license: "apache-2.0",
        license_verified: true,
        source: "https://huggingface.co/OpenMOSS-Team/MOSS-SoundEffect-v2.0",
        runtime_compatible: true,
        runtime_family: "MOSS_SOUNDEFFECT_V2",
        runtime_variant: "1.3B_FLOW_MATCHING",
        quality_profile: "MOSS_SOUNDEFFECT_V2_48KHZ_MODAL_V1",
        infrastructure_provider: "MODAL",
        capabilities: Object.freeze(["ai.sfx.generate"]),
...
function isOwnedMediaCapability(capability) {
  ...
  if (requested === "ai.image.analyze") return false;
...
export function ownedPricingCertification({ provider, capability, pricing } = {}) {
  ...
  const pricingModelCertification =
    AVANTIQO_OWNED_MODEL_CATALOG[providerId]?.models?.[pricingModel] || null;
  const intelligencePricingModelBound = providerId !== "avantiqo-intelligence" || Boolean(
    pricingModelCertification?.license_verified === true &&
    pricingModelCertification?.runtime_compatible === true &&
    pricingModelCertification.capabilities.includes(requestedCapability)
  );
  ...
  const checks = {
    ...
    ...(providerId === "avantiqo-intelligence"
      ? { intelligence_pricing_model_bound: intelligencePricingModelBound }
      : {}),
    ...(mediaRequired
      ? {
