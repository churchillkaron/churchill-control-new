  ...
  "avantiqo-video": Object.freeze({
    models: Object.freeze({
      ...
      "Wan-AI/Wan2.2-I2V-A14B-Diffusers": Object.freeze({
        ...
        runtime_compatible: true,
        capabilities: Object.freeze(["ai.video.image_to_video"]),
      }),
    }),
  }),
  // Audio remains intentionally uncertified. The current worker is an
  // AudioLDM2 adapter; ACE-Step is a strong commercially permissive music
  // candidate, but certifying it before implementing the matching runtime
  // adapter would be false. External audio remains the governed fallback.
  "avantiqo-audio": Object.freeze({
    candidates: Object.freeze({
      "ACE-Step/Ace-Step1.5": Object.freeze({
        ...
        target_capabilities: Object.freeze(["ai.music.generate"]),
      }),
    }),
    models: Object.freeze({}),
  }),
