...
import {
  prepareRunwayProviderInput,
} from "./runway/RunwayProviderInputRuntime";
...
async function preparedProviderInput({
  ...
  if (provider !== "runway") return structured;
  return prepareRunwayProviderInput(structured);
}
...
export async function executeProvider({
  ...
  const preparedInput = await preparedProviderInput({
    provider,
    capability,
    model,
    input,
