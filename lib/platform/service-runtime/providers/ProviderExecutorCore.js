...
import "./lipsync/ManagedLipSyncProviderRegistration.js";
import "./meta/ManagedMetaCredentialRegistration.js";
...
import {
  ...
  serializeCreativeProviderNegativeInstruction,
  hasStructuredCreativeInstruction,
} from "../../../creative/execution/runtime/CreativeProviderInstructionSerializer.js";
import { prepareRunwayProviderInputByProbe } from "./runway/RunwayProviderMediaProbeRuntime.js";
import { prepareOpenAIVideoAnalysisInput } from "./openai/OpenAIVideoAnalysisFrameRuntime.js";
import { assertProviderExecutionFunded } from "../execution/ProviderExecutionFundingGuard.js";
import { assertProviderSettlementFunded } from "../execution/ProviderSettlementFundingGuard.js";
...
const RUNTIME_LOADERS = {
  ...
  avantiqo_video: () =>
    import("./avantiqo-video/AvantiqoVideoProviderV2.js")
      .then(module => module.AvantiqoVideoProviderV2),
  avantiqo_audio: () =>
    import("./avantiqo-audio/AvantiqoAudioProvider.js")
      .then(module => module.AvantiqoAudioProvider),
  avantiqo_voice: () =>
    import("./avantiqo-voice/AvantiqoVoiceProviderV2.js")
      .then(module => module.AvantiqoVoiceProviderV2),
  avantiqo_code: () =>
    import("./avantiqo-code/AvantiqoCodeProviderV2.js")
      .then(module => module.AvantiqoCodeProviderV2),
  ...
  stripe: () => import("./stripe/StripeProvider.js").then(module => module.StripeProvider),
  ...
  pinterest: () => import("./pinterest/PinterestProvider.js").then(module => module.PinterestProvider),
  youtube: () => import("./youtube/YouTubeProvider.js").then(module => module.YouTubeProvider),
  tripadvisor: () => import("./tripadvisor/TripadvisorProvider.js").then(module => module.TripadvisorProvider),
  linkedin: () => import("./linkedin/LinkedInProvider.js").then(module => module.LinkedInProvider),
  line: () => import("./line/LINEProvider.js").then(module => module.LINEProvider),
  whatsapp: () => import("./whatsapp/WhatsAppProvider.js").then(module => module.WhatsAppProvider),
  telegram: () => import("./telegram/TelegramProvider.js").then(module => module.TelegramProvider),
  sms: () => import("./sms/SMSProvider.js").then(module => module.SMSProvider),
  google: () => import("./google/GoogleProvider.js").then(module => module.GoogleProvider),
  google_ads_managed: () => import("./google/GoogleAdsManagedProvider.js").then(module => module.GoogleAdsManagedProvider),
  ...
  meta: () => import("./meta/MetaProvider.js").then(module => module.MetaProvider),
  openai: () => import("./openai/OpenAIProviderSanitizedRuntime.js").then(module => module.OpenAIProvider),
  flux: () => import("./flux/FluxProvider.js").then(module => module.FluxProvider),
  runway: () => import("./runway/RunwayProvider.js").then(module => module.RunwayProvider),
  ...
  managed_lipsync: () => import("./lipsync/ManagedLipSyncProvider.js").then(module => module.ManagedLipSyncProvider),
};
...
async function executionCredential(provider, context = {}) {
  if (provider === "avantiqo-intelligence") return null;
...
function settlementCredentialRequired(provider, jobId) {
  if (provider === "avantiqo-intelligence") return false;
  return true;
}
...
function providerInput({ capability, model, input, context, credential }) {
  ...
  const explicitProviderPrompt =
    typeof structuredInput.provider_prompt === "string" &&
    structuredInput.provider_prompt.trim()
      ? structuredInput.provider_prompt.trim()
      : null;
  if (explicitProviderPrompt) {
    return {
      ...structuredInput,
      prompt: explicitProviderPrompt,
      provider_prompt: explicitProviderPrompt,
      prompt_serialization_contract: {
        contract: "CREATIVE_PROVIDER_INSTRUCTION_SERIALIZATION_V1",
        boundary: "EXECUTION_TRANSPORT_ONLY",
        persisted: false,
        source: "EXPLICIT_GOVERNED_PROVIDER_PROMPT",
      },
    };
  }
  const instruction = serializeCreativeProviderInstruction(structuredInput);
  const negativeInstruction = serializeCreativeProviderNegativeInstruction(structuredInput);
  return {
    ...structuredInput,
    prompt: instruction,
    provider_prompt: instruction,
    ...(negativeInstruction ? { negative_prompt: negativeInstruction } : {}),
    prompt_serialization_contract: {
      contract: "CREATIVE_PROVIDER_INSTRUCTION_SERIALIZATION_V1",
      boundary: "EXECUTION_TRANSPORT_ONLY",
      persisted: false,
...
export async function cancelProvider({ provider, job_id, input = {}, context = {} }) {
  if (!provider) throw new Error("provider required");
  if (!job_id) throw new Error("job_id required");

  await assertProviderSettlementFunded({ provider, job_id, context });
  const runtime = await loadProviderRuntime(provider);
  const cancelFunction = runtime.cancel || runtime.cancelJob || runtime.cancelExecution;
  if (typeof cancelFunction !== "function") {
    throw new Error(`Provider cancellation runtime unavailable: ${provider}`);
  }

  const credential = settlementCredentialRequired(provider, job_id)
    ? await executionCredential(provider, context)
    : null;
  const safeCredentialOverlay = credentialOverlay(credential);
  const selectedCredentialId = credential?.credential_id || context?.credential_id || null;

  return cancelFunction.call(runtime, {
    ...input,
    job_id,
