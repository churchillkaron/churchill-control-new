export const PROVIDER_REGISTRY = {
  ...
  alpaca: {
    ...
    connectionModel:"api_key",
    capabilities:[
      "markets.market_data.read",
      "markets.news.read",
      "markets.paper_broker.connect",
    ],
    countries:["*"],
    currencies:["USD"],
    runtime:"alpaca",
    ...
    metadata:{
      ...
      supplier_billing_required:true,
      streaming_market_data:true,
      streaming_news:true,
