...
export async function resolveProvider({
  ...
  // Canonical owned-first rule: if the Avantiqo engine is runnable, priced and
  // not blocked by governance/failover policy, external providers are not
  // considered primary candidates. They remain available only when the owned
  // candidate is unavailable or deliberately blocked after a governed failure.
