...
export async function resolveProvider({
  ...
  // Canonical owned-first rule: only a technically, commercially and
  // economically certified Avantiqo engine can suppress external providers.
  // A provisional price or unapproved foundation model is never enough.
