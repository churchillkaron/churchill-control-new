...
export const AvantiqoAudioProvider = {
  ...
  async getStatus(input = {}) {
    if (text(input.job_id || input.jobId || input.provider_job_id).startsWith(AVANTIQO_MUSIC_LOCAL_NODE_JOB_PREFIX)) return AvantiqoMusicLocalNodeProvider.getStatus(input);
