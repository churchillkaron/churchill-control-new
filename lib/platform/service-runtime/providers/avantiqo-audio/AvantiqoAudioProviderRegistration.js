...
const primaryAudioRuntimeAvailable = Boolean(
  ...
  baseCertifiedCapabilities.length,
);
...
PROVIDER_REGISTRY[PROVIDER_ID] = {
  ...
  metadata: {
    ...
    separator_runtime: {
      ...
      production_routing_allowed: capabilities.includes("ai.audio.stems"),
      certification_required: true,
    ...
    vocal_correction_runtime: {
      ...
      production_routing_allowed: capabilities.includes(VOCAL_CORRECTION_CAPABILITY),
      certification_required: true,
      source_audio_required: true,
