...
export const AvantiqoMusicLocalNodeProvider = {
  ...
  async execute(input = {}) {
    ...
    return {
      ...
      model: config.model,
      output: {
        provider_job_id: `${JOB_PREFIX}${inserted.id}`,
        status: "queued",
