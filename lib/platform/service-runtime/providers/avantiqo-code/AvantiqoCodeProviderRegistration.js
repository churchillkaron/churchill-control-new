...
const runtimeAvailable = Boolean(
  engineEnabled &&
  (modalConfigured || localComputeConfigured) &&
...
PROVIDER_REGISTRY[PROVIDER_ID] = {
  ...
  metadata: {
    ...
    infrastructure_provider: localComputeConfigured ? "AVANTIQO_LOCAL_NODE_V1" : "MODAL_H100_ASYNC_V1",
    infrastructure_candidates: localComputeConfigured ? ["AVANTIQO_LOCAL_NODE_V1", "MODAL_H100_ASYNC_V1"] : ["MODAL_H100_ASYNC_V1"],
    modal_only_execution: false,
    modal_only_capabilities: ["ai.code.invent"],
    local_first_capabilities: ["ai.code.generate","ai.code.edit","ai.code.refactor","ai.code.review","ai.code.debug","ai.code.test","ai.web.build","ai.web.repair","ai.app.build","ai.integration.build"],
    ...
    runtime_configuration: {
      ...
      modal_primary_when_configured: false,
