...
const foundationModels = unique([generationModel, editModel, inpaintModel, outpaintModel, upscaleModel, analyzeModel, ...(localComputeConfigured ? [localDocumentVisionModel] : [])]);
...
PROVIDER_REGISTRY[PROVIDER_ID] = {
  ...
  metadata: {
    ...
    runtime_configuration: {
      ...
      transport: localComputeConfigured ? "supabase-pull-queue-v1-primary-modal-sdk-fallback" : "modal-js-sdk-function-call-v1",
