...
const upscaleModel =
  text(process.env.AVANTIQO_IMAGE_UPSCALE_MODEL) ||
  "caidas/swin2SR-realworld-sr-x4-64-bsrgan-psnr";
const analyzeModel =
  text(process.env.AVANTIQO_IMAGE_ANALYZE_MODEL) ||
...
PROVIDER_REGISTRY[PROVIDER_ID] = {
  ...
  metadata: {
    ...
    capability_foundation_models: {
      ...
      "ai.image.upscale": upscaleModel || null,
      "ai.image.analyze": analyzeModel || null,
    },
    runtime_configuration: {
      ...
      upscale_foundation_model_configured: Boolean(upscaleModel),
      analyze_foundation_model_configured: Boolean(analyzeModel),
      queue_endpoint: true,
      scale_to_zero: true,
    },
    image_capabilities: {
