...
function validateCompletedOutput(value, { expectedFrontTaskMode = null } = {}) {
  ...
  if (lane === "front") {
    ...
    if (output.memory_snapshot_enabled !== false || Number(output.min_containers) < 1) {
      throw new Error("AVANTIQO_INTELLIGENCE_MODAL_DIRECT_FRONT_WARM_CONTAINER_REQUIRED");
    }
  } else {
