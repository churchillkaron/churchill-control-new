...
const FRONT_RUNTIME_CONTRACT = "AVANTIQO_INTELLIGENCE_FRONT_CPU_SNAPSHOT_V1";
...
function validateCompletedOutput(value) {
  ...
  if (lane === "front") {
    ...
    if (output.memory_snapshot_enabled !== true || Number(output.min_containers) !== 0) {
      throw new Error("AVANTIQO_INTELLIGENCE_MODAL_DIRECT_FRONT_SCALE_TO_ZERO_REQUIRED");
    }
  } else {
