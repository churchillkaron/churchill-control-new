...
export function getAvantiqoIntelligenceRuntimeConfiguration() {
  ...
  return {
    ...
    execution_lanes: {
      front: { class_name: "FrontConversation", app_name: "avantiqo-intelligence-front-owned", model_name: FRONT_MODEL, reasoning_mode: "NON_THINKING_ONLY", tools_allowed: false, mutation_authority: false, memory_snapshot: false, min_containers: 1, max_containers: 2, scaledown_window_seconds: 120, runtime_contract: "AVANTIQO_INTELLIGENCE_FRONT_CPU_WARM_V2" },
