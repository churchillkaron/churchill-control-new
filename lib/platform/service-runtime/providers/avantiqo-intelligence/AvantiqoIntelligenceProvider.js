...
export function getAvantiqoIntelligenceRuntimeConfiguration() {
  ...
  return {
    ...
    governed_overflow_infrastructure: null,
    governed_modal_overflow_supported: false,
    governed_modal_overflow_available: false,
    automatic_modal_fallback_allowed: false,
    modal_overflow_owner_approval_required: false,
    modal_overflow_local_insufficiency_proof_required: false,
    modal_overflow_spend_ceiling_required: false,
    ...
    modal_overflow_server_credentials_required_at_submission: false,
