...
export function getAvantiqoIntelligenceRuntimeConfiguration() {
  ...
  return {
    ...
    execution_lanes: {
      ...
      fast: { function_name: "fast", model_name: FAST_MODEL, reasoning_mode: "NON_THINKING_ONLY", gpu_memory_snapshot: false, scaledown_window_seconds: 10, runtime_contract: "AVANTIQO_INTELLIGENCE_FAST_WARM_FUNCTION_V1" },
    },
