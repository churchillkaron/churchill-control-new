...
function modalOverflowConfigured() {
  return intelligenceModalOverflowProposalWorkflowEnabled() &&
...
export function getAvantiqoIntelligenceRuntimeConfiguration() {
  ...
  return {
    ...
    execution_lanes: {
      front: { class_name: "FrontConversation", app_name: null, model_name: FRONT_MODEL, reasoning_mode: "NON_THINKING_ONLY", tools_allowed: false, mutation_authority: false, memory_snapshot: false, infrastructure_provider: localConfigured ? localInfrastructure : null, min_containers: 0, max_containers: 1, scaledown_window_seconds: null, runtime_contract: "AVANTIQO_INTELLIGENCE_FRONT_LOCAL_V3" },
      deep: { function_name: "deep", model_name: FRONT_MODEL, reasoning_mode: "THINKING_REQUIRED", local_primary: true, local_context_tokens: 20480, local_output_cap_tokens: 8192, modal_overflow_allowed_with_approval: overflowConfigured, overflow_model_name: DEFAULT_MODEL, overflow_infrastructure_provider: "MODAL_H100_ASYNC_V1" },
      fast: { function_name: "fast", model_name: FAST_MODEL, reasoning_mode: "NON_THINKING_ONLY", local_primary: true, modal_overflow_allowed_with_approval: overflowConfigured, overflow_infrastructure_provider: "MODAL_H100_ASYNC_V1", gpu_memory_snapshot: false, min_containers: 0, max_containers: 1, scaledown_window_seconds: 5, runtime_contract: "AVANTIQO_INTELLIGENCE_FAST_WARM_FUNCTION_V1" },
    },
