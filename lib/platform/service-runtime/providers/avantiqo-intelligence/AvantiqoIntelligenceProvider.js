...
export function getAvantiqoIntelligenceRuntimeConfiguration() {
  ...
  return {
    ...
    execution_lanes: {
      ...
      fast: { function_name: "FastSnapshotWorker.invoke", model_name: FAST_MODEL, reasoning_mode: "NON_THINKING_ONLY", gpu_memory_snapshot: true, scaledown_window_seconds: 10 },
    },
