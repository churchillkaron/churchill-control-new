...
export function getAvantiqoIntelligenceRuntimeConfiguration() {
  ...
  return {
    ...
    execution_lanes: {
      front: { class_name: "FrontConversation", app_name: "avantiqo-intelligence-front-owned", model_name: FRONT_MODEL, reasoning_mode: "NON_THINKING_ONLY", tools_allowed: false, mutation_authority: false, memory_snapshot: true, min_containers: 0, max_containers: 1, scaledown_window_seconds: 120, runtime_contract: "AVANTIQO_INTELLIGENCE_FRONT_CPU_SNAPSHOT_V1" },
