...
export async function getAvantiqoIntelligenceEndpointHealthForLane(input = {}) {
  ...
  if (["front", "fast"].includes(lane) && intelligenceLocalConfigured()) return getIntelligenceLocalHealth();
...
export function getAvantiqoIntelligenceRuntimeConfiguration() {
  ...
  return {
    ...
    model_storage: "AVANTIQO_OWNED_SERVER",
...
export async function probeAvantiqoIntelligenceRuntime() {
  return getAvantiqoIntelligenceEndpointHealth();
}
