import "./AvantiqoIntelligenceCredentialRegistration.js";
...
const runtimeAvailable = Boolean(engineEnabled || localReviewRuntimeAllowed);
...
PROVIDER_REGISTRY[PROVIDER_ID] = {
  ...
  metadata: {
    ...
    infrastructure_provider: localComputeConfigured ? localInfrastructure : "MODAL_H100_ASYNC_V1",
    infrastructure_candidates: localComputeConfigured ? [localInfrastructure, "MODAL_H100_ASYNC_V1"] : ["MODAL_H100_ASYNC_V1"],
    modal_only: false,
    ...
    execution_lanes: {
      front: { class_name: "FrontConversation", app_name: "avantiqo-intelligence-front-owned", model_name: FRONT_MODEL, reasoning_mode: "NON_THINKING_ONLY", intended_workload: "BUSINESS_PARTNER_CONVERSATION_ONLY", tools_allowed: false, mutation_authority: false, memory_snapshot: false, min_containers: 0, max_containers: 2, warm_retention_seconds: 30 },
      deep: { function_name: "deep", model_name: configuredModel, reasoning_mode: "THINKING_REQUIRED", intended_workload: "COMPLEX_STRATEGIC_REASONING", min_containers: 0, max_containers: 1, warm_retention_seconds: 5, runtime_contract: "AVANTIQO_INTELLIGENCE_DEEP_SCALE_ZERO_V3" },
      fast: { function_name: "fast", model_name: configuredFastModel, reasoning_mode: "NON_THINKING_ONLY", intended_workload: "INTERACTIVE_CONVERSATION", min_containers: 0, max_containers: 1, warm_retention_seconds: 5 },
    },
    modal_worker_contract: {
      ...
      fast_bounded_warm_idle_seconds: 5,
    ...
    runtime_configuration: {
      ...
      credential_transport: "PROVIDER_EXECUTOR_GOVERNED_SECRET_BROKER_OR_PROCESS_ENV_V2",
      server_secret_broker: "SUPABASE_VAULT_ROW_BOUND_SERVICE_ROLE_RPC_V1",
      supported_secret_reference_schemes: ["env", "vault"],
      opaque_secret_reference_passthrough_allowed: false,
      runtime_credentials_required_at_execution: true,
      modal_process_env_configured: modalConfigured,
      modal_token_id_process_env_configured: Boolean(modalTokenId),
      modal_token_secret_process_env_configured: Boolean(modalTokenSecret),
