...
PROVIDER_REGISTRY[PROVIDER_ID] = {
  ...
  metadata: {
    ...
    execution_lanes: {
      ...
      deep: { function_name: "deep", model_name: configuredModel, reasoning_mode: "THINKING_REQUIRED", intended_workload: "COMPLEX_STRATEGIC_REASONING", min_containers: 0, max_containers: 1, warm_retention_seconds: 60, runtime_contract: "AVANTIQO_INTELLIGENCE_DEEP_BOUNDED_WARM_V2" },
