...
function outputExtensionForCapability(
  capability,
  outputExtension,
  outputExtensions,
) {
  if (
    outputExtensions &&
    typeof outputExtensions === "object" &&
    Object.prototype.hasOwnProperty.call(outputExtensions, capability)
  ) {
  ...
  return {
    ...
    async execute(input = {}) {
      ...
      const storageUpload = await outputUploadTarget({
        ...
        usageId,
        family,
        extension: outputExtensionForCapability(
          capability,
          outputExtension,
          outputExtensions,
        ),
