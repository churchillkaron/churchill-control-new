...
const modalBaseUrl = text(process.env.AVANTIQO_VIDEO_MODAL_BASE_URL);
const modalGatewayToken = text(process.env.AVANTIQO_VIDEO_MODAL_GATEWAY_TOKEN);
...
PROVIDER_REGISTRY[PROVIDER_ID] = {
  ...
  metadata: {
    ...
    capability_foundation_models: {
      "ai.video.generate": t2vFoundationModel,
      "ai.video.image_to_video": i2vFoundationModel,
      "ai.video.first_last_frame_to_video": firstLastFoundationModel,
    ...
    video_capabilities: {
      ...
      default_delivery_resolution: "720p",
