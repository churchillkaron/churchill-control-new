...
const MODAL_FUNCTION_NAME = "generate_native_job_v3";
...
const upscaleFoundationModel = text(process.env.AVANTIQO_VIDEO_UPSCALE_MODEL);
...
const requiredTransportConfigured = modalConfigured;
