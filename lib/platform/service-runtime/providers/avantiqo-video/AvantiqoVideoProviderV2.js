...
// Match the proven Audio/Intelligence architecture exactly at the execution
// boundary: Service Runtime owns governance, wallet, signed Studio assets and
// durable job state; Modal owns elastic compute. The mastered Video path calls
// one async Modal function with one governed payload and polls by FunctionCall.
// GitHub Actions is certification/control-plane only and is never the runtime.
