...
export const AvantiqoVideoProviderV2 = {
  ...
  async getStatus(input = {}) {
    ...
    if (workflowV2Job(suppliedJobId)) {
      return AvantiqoVideoWorkflowRuntimeV2.getStatus(input);
    }

    if (legacyWorkflowJob(suppliedJobId)) {
      return AvantiqoVideoWorkflowRuntime.getStatus(input);
    }
