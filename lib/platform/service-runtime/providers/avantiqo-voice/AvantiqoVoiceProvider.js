...
function requireSafeLeaseForSubmission(endpointId, capability) {
...
async function submitJob({ endpointId, capability, payload }) {
  requireSafeLeaseForSubmission(endpointId, capability);
