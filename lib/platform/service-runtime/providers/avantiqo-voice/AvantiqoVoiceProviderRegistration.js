...
const runtimeAvailable = Boolean(
  engineEnabled && (localComputeConfigured || modalDirectConfigured) && capabilities.length,
);
...
PROVIDER_REGISTRY[PROVIDER_ID] = {
  ...
  metadata: {
    ...
    infrastructure_provider: "AVANTIQO_LOCAL_NODE_V1_PRIMARY_MODAL_FALLBACK",
    infrastructure_candidates: ["AVANTIQO_LOCAL_NODE_V1", "MODAL_A10G_ASYNC_V1"],
    modal_only_execution: false,
    local_first_execution: true,
    modal_fallback_when_local_unavailable: true,
    ...
    runtime_configuration: {
      ...
      stt_local_first: true,
      tts_local_first: true,
      tts_local_mode: "LOCAL_GPU_FIRST_MODAL_FALLBACK",
