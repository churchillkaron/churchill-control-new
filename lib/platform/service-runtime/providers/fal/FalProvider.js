  ...
  async execute(input = {}) {
    ...
    return {
      ...
      output: {
        ...
        status_url: text(result.status_url || result.statusUrl) || null,
        response_url: text(result.response_url || result.responseUrl) || null,
        cancel_url: text(result.cancel_url || result.cancelUrl) || null,
        raw: result,
      },
    };
  },
