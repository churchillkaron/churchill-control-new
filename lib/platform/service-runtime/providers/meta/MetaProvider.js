...
async function createAdsBundle({
  ...
  if (!page_id) {
    throw new Error("Meta Facebook page id is required");
  }
  ...
  if (!creative.image_url && !creative.link_url) {
    throw new Error("An image URL or destination URL is required");
  }
  ...
  try {
    ...
    const objectStorySpec = creative.object_story_spec || {
      ...
      ...(instagram_business_id
        ? { instagram_actor_id: instagram_business_id }
        : {}),
      link_data: {
        message: creative.message,
        link: creative.link_url || "https://www.facebook.com",
        ...
        ...(creative.call_to_action
          ? {
              call_to_action: {
                ...
                value: creative.call_to_action_value || {
...
async function updateAdObjectStatus({
  access_token,
  object_id,
  status,
}) {
