  ...
  async execute({
    ...
    switch (capability) {
      case "communication.whatsapp.send":
        return sendMessage({ phone_number_id, access_token, recipient, message });

      case "communication.whatsapp.template":
      case "communication.whatsapp.templates":
...
async function sendMessage({ phone_number_id, access_token, recipient, message }) {
