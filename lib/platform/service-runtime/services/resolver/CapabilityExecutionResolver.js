const CAPABILITY_EXECUTION_MAP = {
  ...
  TELEGRAM: ["communication.telegram.send"],
  SMS: ["communication.sms.send"],
  PINTEREST: ["marketing.pinterest.publish", "marketing.pinterest.boards.read"],
  YOUTUBE: ["marketing.youtube.publish", "marketing.youtube.analytics"],
};
