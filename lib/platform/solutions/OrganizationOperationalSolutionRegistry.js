...
const SOLUTION_DEFINITIONS = Object.freeze([
  Object.freeze({
    ...
    items: Object.freeze([
      ...
      Object.freeze({ id: "pos", label: "POS", description: "Open and manage the stationary point of sale.", icon: "pos", route: "/workspace/:organizationId/operations/pos" }),
      Object.freeze({ id: "waiter", label: "Waiter", description: "Take orders and manage guest service from the floor.", icon: "service", route: "/workspace/:organizationId/operations/pos/waiter" }),
      ...
      Object.freeze({ id: "orders", label: "Orders", description: "Review active and completed restaurant orders.", icon: "orders", route: "/workspace/:organizationId/operations/pos/orders" }),
      Object.freeze({ id: "payments", label: "Payments", description: "Settle bills, split payments and control payment state.", icon: "payments", route: "/workspace/:organizationId/operations/pos/payments" }),
      Object.freeze({ id: "receipts", label: "Receipts", description: "Review and reproduce completed transaction receipts.", icon: "receipts", route: "/workspace/:organizationId/operations/pos/receipts" }),
      Object.freeze({ id: "shifts", label: "POS Shifts", description: "Open, control and close point-of-sale shifts.", icon: "shifts", route: "/workspace/:organizationId/operations/pos/shifts" }),
    ]),
  }),
  Object.freeze({
    id: "hotel",
    ...
    description: "Coordinate front office, reservations, rooms, housekeeping, maintenance and guest service.",
    items: Object.freeze([
      Object.freeze({ id: "hotel-command", label: "Hotel Control", description: "Open the hotel operating overview and live property workspace.", icon: "command", route: "/workspace/:organizationId/hotel" }),
      Object.freeze({ id: "front-desk", label: "Front Desk", description: "Manage arrivals, departures and live guest service.", icon: "frontdesk", route: "/workspace/:organizationId/hotel/frontdesk" }),
      Object.freeze({ id: "reservations", label: "Reservations", description: "Review bookings, availability and upcoming stays.", icon: "reservations", route: "/workspace/:organizationId/hotel/reservations" }),
      Object.freeze({ id: "housekeeping", label: "Housekeeping", description: "Coordinate room status, cleaning and readiness.", icon: "housekeeping", route: "/workspace/:organizationId/hotel/housekeeping" }),
      Object.freeze({ id: "maintenance", label: "Maintenance", description: "Track property issues, repairs and operational downtime.", icon: "maintenance", route: "/workspace/:organizationId/hotel/maintenance" }),
      Object.freeze({ id: "concierge", label: "Concierge", description: "Manage guest requests and service coordination.", icon: "concierge", route: "/workspace/:organizationId/hotel/concierge" }),
    ]),
  }),
  Object.freeze({
    id: "retail",
    ...
    items: Object.freeze([
      Object.freeze({ id: "retail-command", label: "Retail Control", description: "Open the retail operating workspace.", icon: "command", route: "/workspace/:organizationId/retail" }),
      Object.freeze({ id: "pos", label: "POS", description: "Open the stationary retail point of sale.", icon: "pos", route: "/workspace/:organizationId/operations/pos" }),
      Object.freeze({ id: "orders", label: "Sales Orders", description: "Review active and completed sales orders.", icon: "orders", route: "/workspace/:organizationId/operations/pos/orders" }),
      Object.freeze({ id: "payments", label: "Payments", description: "Control checkout and payment state.", icon: "payments", route: "/workspace/:organizationId/operations/pos/payments" }),
      Object.freeze({ id: "receipts", label: "Receipts", description: "Review completed transaction receipts.", icon: "receipts", route: "/workspace/:organizationId/operations/pos/receipts" }),
      Object.freeze({ id: "shifts", label: "POS Shifts", description: "Open and close retail point-of-sale shifts.", icon: "shifts", route: "/workspace/:organizationId/operations/pos/shifts" }),
  ...
  Object.freeze({
    ...
    items: Object.freeze([
      Object.freeze({ id: "healthcare-command", label: "Healthcare Control", description: "Open the healthcare operating dashboard.", icon: "command", route: "/workspace/:organizationId/healthcare/dashboard" }),
  ...
  Object.freeze({
    ...
    items: Object.freeze([
      Object.freeze({ id: "construction-command", label: "Project Operations", description: "Open the construction operating workspace.", icon: "command", route: "/workspace/:organizationId/construction" }),
  ...
  Object.freeze({
    ...
    items: Object.freeze([
      Object.freeze({ id: "field-command", label: "Service Control", description: "Open the field-service operating workspace.", icon: "command", route: "/workspace/:organizationId/pest_control" }),
  ...
  Object.freeze({
    ...
    items: Object.freeze([
      Object.freeze({ id: "venue-command", label: "Venue Control", description: "Open the venue operating workspace.", icon: "command", route: "/workspace/:organizationId/entertainment" }),
      Object.freeze({ id: "pos", label: "POS", description: "Open the venue point of sale.", icon: "pos", route: "/workspace/:organizationId/operations/pos" }),
      Object.freeze({ id: "payments", label: "Payments", description: "Review checkout and payment state.", icon: "payments", route: "/workspace/:organizationId/operations/pos/payments" }),
      Object.freeze({ id: "shifts", label: "POS Shifts", description: "Control active point-of-sale shifts.", icon: "shifts", route: "/workspace/:organizationId/operations/pos/shifts" }),
