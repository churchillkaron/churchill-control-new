...
const SOLUTION_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    items: Object.freeze([
      Object.freeze({ id: "artist-agency-command", label: "Booking Desk", description: "Run the artist booking pipeline, holds, contracts, routing and show execution.", icon: "command", route: "/workspace/:organizationId/operations/artist-agency" }),
    ]),
  }),
  Object.freeze({
    id: "entertainment",
