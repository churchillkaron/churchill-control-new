...
const SOLUTION_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    items: Object.freeze([
      Object.freeze({ id: "hotel-command", label: "Hotel Control", description: "Open the hotel operating overview and live property workspace.", icon: "command", route: "/workspace/:organizationId/operations/hotel" }),
      Object.freeze({ id: "front-desk", label: "Front Desk", description: "Manage arrivals, departures and live guest service.", icon: "frontdesk", route: "/workspace/:organizationId/operations/front-desk" }),
      Object.freeze({ id: "reservations", label: "Reservations", description: "Review bookings, availability and upcoming stays.", icon: "reservations", route: "/workspace/:organizationId/operations/reservations" }),
      Object.freeze({ id: "housekeeping", label: "Housekeeping", description: "Coordinate room status, cleaning and readiness.", icon: "housekeeping", route: "/workspace/:organizationId/operations/housekeeping" }),
      ...
      Object.freeze({ id: "concierge", label: "Concierge", description: "Manage guest requests and service coordination.", icon: "concierge", route: "/workspace/:organizationId/operations/concierge" }),
    ]),
  }),
  Object.freeze({
    id: "retail",
