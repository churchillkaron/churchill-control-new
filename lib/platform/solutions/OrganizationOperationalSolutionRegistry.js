...
const SOLUTION_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    description: "Run the complete property operation from reservations and guest stays through rooms, distribution, revenue control and governed end-of-day.",
    items: Object.freeze([
      ...
      Object.freeze({ id: "guest-stays", label: "Guests & Stays", description: "Manage guest profiles, room assignment and moves, digital arrival, folios, deposits and upsells in one stay record.", icon: "records", route: "/workspace/:organizationId/operations/stay-control" }),
      ...
      Object.freeze({ id: "revenue", label: "Revenue", description: "Review forward occupancy, ADR, RevPAR and property-level room revenue outlook.", icon: "payments", route: "/workspace/:organizationId/operations/revenue" }),
