export const RestaurantRuntime = {
  ...
  capabilities: {
    ...
    kitchen: {
      CreateKitchenTicket: () => import("@/lib/restaurant/kitchen/workflows/CreateKitchenTicket"),
      StartPreparation: () => import("@/lib/restaurant/kitchen/workflows/StartPreparation"),
      MarkReady: () => import("@/lib/restaurant/kitchen/workflows/MarkReady"),
      Complete: () => import("@/lib/restaurant/kitchen/workflows/CompleteKitchenTicket"),
    },
