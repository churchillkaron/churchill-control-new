...
export default registerCapability(
  defineCapability({
    ...
    risk: "medium",
    operatorVerification: { capability_key: "restaurant.session.read", payload_from_result: { sessionId: ["sessionId", "session.id"] }, derivation: "declared_result_bound_session_verifier" },
  })
);