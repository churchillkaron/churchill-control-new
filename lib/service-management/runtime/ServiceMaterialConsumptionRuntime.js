...
function treatmentMaterials(submission = {}) {
  const applications = Array.isArray(submission.treatment_applications)
    ? submission.treatment_applications
    : [];
...
export async function consumeServiceMaterials({
  ...
  const applicationMaterials = treatmentMaterials(submission);
