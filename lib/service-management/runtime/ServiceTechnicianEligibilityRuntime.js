...
export async function assertServiceTechnicianEligibility({
  ...
  if (evaluation?.status === "REQUIREMENT_NOT_CONFIGURED") {
    throw blockedError(
      "The treatment protocol requires a People qualification that is not currently configured. Execution is blocked rather than guessing eligibility.",
      {
        ...
        unknown_requirement_codes: evaluation.unknown_requirement_codes || [],
