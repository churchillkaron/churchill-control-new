...
export async function rejectApprovalRequest({
  ...
  await emitBusinessPartnerBusinessEvent({
    ...
    identity: `${workflowRequestId}:rejected`,
    evidence: { workflow_request_id: workflowRequestId, reference_table: request.reference_table, reference_id: request.reference_id, status: "rejected" },
