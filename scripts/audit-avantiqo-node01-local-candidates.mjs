...
if(!api.includes("MODAL_KEEP_EXACT_MODEL_EXCEEDS_VRAM")) throw new Error("NODE01_EXACT_MODEL_VRAM_GUARD_MISSING");
console.log(JSON.stringify({contract:"AVANTIQO_NODE01_LOCAL_CANDIDATE_AUDIT_V1",certified_local:8,hybrid_local:1,modal_guarded:3,quality_downgrade:false},null,2));
