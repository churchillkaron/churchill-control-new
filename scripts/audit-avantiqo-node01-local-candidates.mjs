...
const required=["qwen3:4b-instruct","openai/whisper-large-v3-turbo","demucs-htdemucs-ft","torchcrepe-full","media.ffmpeg.process","ai.image.upscale"];
...
console.log(JSON.stringify({contract:"AVANTIQO_NODE01_LOCAL_CANDIDATE_AUDIT_V1",certified_local:7,modal_guarded:2,quality_downgrade:false},null,2));
