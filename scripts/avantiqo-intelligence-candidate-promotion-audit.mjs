...
assert(inspector.includes("ADAPTER_MOE_LORA_TENSOR_NOT_3D"), "CANDIDATE_3D_TENSOR_GATE_REQUIRED");
...
console.log("AVANTIQO_INTELLIGENCE_CANDIDATE_MOE_LAYOUT=FUSED_3D_ONLY");
console.log("AVANTIQO_INTELLIGENCE_CANDIDATE_TARGET_PARAMETERS=VERIFIED");
