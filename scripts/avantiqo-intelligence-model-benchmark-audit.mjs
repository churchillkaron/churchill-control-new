...
assert(handler.includes('mode not in {"baseline", "candidate"}'), "BENCHMARK_WORKER_BASELINE_CANDIDATE_REQUIRED");
...
assert(execution.includes("AVANTIQO_INTELLIGENCE_BENCHMARK_ENABLED"), "BENCHMARK_EXECUTION_ENABLE_GATE_REQUIRED");
assert(execution.includes("RUNPOD_AVANTIQO_INTELLIGENCE_BENCHMARK_ENDPOINT_ID"), "BENCHMARK_EXECUTION_ENDPOINT_REQUIRED");
assert(execution.includes("approved !== true"), "BENCHMARK_EXECUTION_EXPLICIT_APPROVAL_REQUIRED");
assert(execution.includes('mode: "baseline"'), "BENCHMARK_EXECUTION_BASELINE_REQUIRED");
assert(execution.includes('mode: "candidate"'), "BENCHMARK_EXECUTION_CANDIDATE_REQUIRED");
