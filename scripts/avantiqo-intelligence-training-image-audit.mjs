...
assert(candidateInspector.includes('"layout": "MOE_3D_FUSED_PEFT"'), "INTELLIGENCE_CANDIDATE_FUSED_3D_ONLY_REQUIRED");
assert(candidateInspector.includes("EXPECTED_TARGET_PARAMETERS"), "INTELLIGENCE_CANDIDATE_TARGET_PARAMETER_CHECK_REQUIRED");
assert(candidateInspector.includes("ADAPTER_MOE_LORA_TENSOR_NOT_3D"), "INTELLIGENCE_CANDIDATE_3D_SHAPE_CHECK_REQUIRED");
