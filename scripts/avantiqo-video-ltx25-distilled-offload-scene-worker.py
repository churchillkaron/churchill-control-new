...
QUALITY_CONTRACT = "AVANTIQO_VIDEO_LTX25_DISTILLED_TWO_STAGE_OFFLOAD_V1"
...
def main() -> None:
    ...
    try:
        ...
        with tempfile.TemporaryDirectory(prefix="avantiqo-ltx25-offload-") as tmp_dir:
    ...
    response.raise_for_status()
    print(f"AVANTIQO_VIDEO_LTX25_OFFLOAD_RECEIPT_WRITTEN={str(receipt.get('success') is True).lower()}", flush=True)
