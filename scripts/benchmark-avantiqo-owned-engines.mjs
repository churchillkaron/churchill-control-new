...
function missing(names = []) { return names.filter((name) => !text(process.env[name])); }
...
const engines = [
  ...
  { id:"image", provider:"avantiqo-image", models:["Qwen/Qwen-Image","Qwen/Qwen-Image-Edit","Qwen/Qwen-Image-Edit-2511","caidas/swin2SR-realworld-sr-x4-64-bsrgan-psnr","Qwen/Qwen2.5-VL-7B-Instruct"], implemented_capabilities:IMAGE_IMPLEMENTED, measured_capabilities:["ai.image.generate","ai.image.analyze","document.ocr","document.classify"], required_env:["RUNPOD_AVANTIQO_IMAGE_ENDPOINT_ID","AVANTIQO_IMAGE_BENCHMARK_UPLOAD_URL","AVANTIQO_IMAGE_BENCHMARK_STORAGE_REFERENCE"], source_ready:true, benchmark_script:"scripts/benchmark-avantiqo-image.mjs", benchmark_output:"/tmp/avantiqo-image-certification-benchmark.json", output_env:"AVANTIQO_IMAGE_BENCHMARK_OUTPUT" },
  ...
  { id:"music", provider:"avantiqo-audio", models:["ACE-Step/Ace-Step1.5"], implemented_capabilities:["ai.music.generate"], measured_capabilities:["ai.music.generate"], required_env:["RUNPOD_AVANTIQO_AUDIO_ENDPOINT_ID","NEXT_PUBLIC_SUPABASE_URL","SUPABASE_SERVICE_ROLE_KEY","AVANTIQO_MUSIC_BENCHMARK_ORGANIZATION_ID","AVANTIQO_AUDIO_BENCHMARK_SPEND_APPROVED"], source_ready:true, benchmark_script:"scripts/benchmark-avantiqo-music.mjs", benchmark_output:"/tmp/avantiqo-music-certification-benchmark.json", output_env:"AVANTIQO_AUDIO_BENCHMARK_OUTPUT", isolation_contract:"AVANTIQO_MUSIC_CERTIFICATION_BENCHMARK_V3" },
