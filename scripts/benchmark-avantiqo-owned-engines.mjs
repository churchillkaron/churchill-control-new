...
const OUTPUT = resolve(
  process.env.AVANTIQO_OWNED_BENCHMARK_OUTPUT ||
...
const engines = [
  {
    ...
    endpoint_env: ["RUNPOD_AVANTIQO_INTELLIGENCE_ENDPOINT_ID"],
    source_ready: true,
    benchmark_script: null,
    blocker: "DEDICATED_NON_QUEUE_CONTAMINATING_CERTIFICATION_PROBE_REQUIRED",
  },
  {
    id: "image",
  ...
  },
  {
    ...
    source_ready: true,
    benchmark_script: null,
    blocker: "DEDICATED_T2V_I2V_OUTPUT_QUALITY_BENCHMARK_REQUIRED",
  },
  {
    id: "voice",
...
const report = {
  contract: "AVANTIQO_OWNED_ENGINE_CERTIFICATION_SUITE_V1",
