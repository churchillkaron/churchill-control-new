...
if(review?.contract!==REVIEW||review?.human_review_status!=="APPROVED"||review?.eligible_for_later_release_decision!==true||review?.automatic_human_approval_forbidden!==true||review?.technical_quality_passed!==true||!text(review?.technical_quality_report_path)||Number(review?.minimum_score_0_to_100)<92||Number(review?.average_score)<92)throw new Error("AVANTIQO_MUSIC_SFX_HUMAN_REVIEW_NOT_APPROVED");
