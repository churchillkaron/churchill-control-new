...
requireText(staffEvidenceApi, 'const BUCKET = "service-evidence"');
requireText(staffEvidenceApi, 'assertStaffUploadSignature');
requireText(staffEvidenceApi, '.from(BUCKET)');
requireText(staffEvidenceApi, 'storageReference(storagePath)');
requireText(staffEvidenceApi, 'private: true');
