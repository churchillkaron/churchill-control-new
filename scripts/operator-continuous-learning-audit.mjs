...
assert(
  localLauncher.includes("AVANTIQO_INTELLIGENCE_FAST_TIMEOUT_MS=480000"),
  "CONTINUOUS_LEARNING_FAST_COLD_START_WAIT_REQUIRED",
);
assert(
...
assert(
  localRunner.includes('request as httpRequest'),
  "CONTINUOUS_LEARNING_LOCAL_HTTP_TRANSPORT_REQUIRED",
);
assert(
  localRunner.includes("const RESEARCH_RESPONSE_LIMIT = 2_000_000"),
  "CONTINUOUS_LEARNING_LOCAL_RESPONSE_BOUND_REQUIRED",
);
assert(
  localRunner.includes("AVANTIQO_CONTINUOUS_LEARNING_LOCAL_RESEARCH_TIMEOUT"),
  "CONTINUOUS_LEARNING_LOCAL_HTTP_TIMEOUT_REQUIRED",
);
assert(
  localRunner.includes("cause_code="),
  "CONTINUOUS_LEARNING_LOCAL_TRANSPORT_DIAGNOSTICS_REQUIRED",
);
assert(
...
assert(
  fastE2EWrapper.includes("AVANTIQO_INTELLIGENCE_FAST_TIMEOUT_MS"),
  "CONTINUOUS_LEARNING_FAST_E2E_COLD_START_WAIT_REQUIRED",
);
assert(
  fastE2EWrapper.includes('"480000"'),
  "CONTINUOUS_LEARNING_FAST_E2E_COLD_START_WAIT_BOUND_REQUIRED",
);
