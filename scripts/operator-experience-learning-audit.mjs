...
assert(dataset.includes('preferred_method: "QLORA_OR_LORA"'), "TRAINING_DATASET_LORA_STRATEGY_REQUIRED");
...
assert(improvement.includes('execution_backend: "UNBOUND_UNTIL_TRAINING_WORKER_CONFIGURED"'), "MODEL_IMPROVEMENT_NO_FAKE_TRAINING_BACKEND_REQUIRED");
...
console.log("AVANTIQO_TRAINING_ADAPTER_STRATEGY=PEFT");
