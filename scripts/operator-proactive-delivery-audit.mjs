...
assert.match(readinessSource, /evaluated = \{\}/);
assert.match(readinessSource, /evaluated\.provider_selected === true/);
assert.match(readinessSource, /evaluated\.pricing_ready === true/);
assert.match(readinessSource, /evaluated\.runtime_ready === true/);
assert.match(readinessSource, /serviceStatusError = null/);
assert.match(readinessSource, /ORGANIZATION_SERVICE_STATUS_UNAVAILABLE/);
assert.match(readinessSource, /organization_service_exists:\s*null/);
assert.match(readinessSource, /active:\s*null/);
assert.match(readinessSource, /usage_enabled:\s*null/);
assert.match(readinessSource, /PROVIDER_UNAVAILABLE/);
assert.match(readinessSource, /PROVIDER_PRICING_UNAVAILABLE/);
assert.match(readinessSource, /credential_required:\s*null/);
assert.match(readinessSource, /credential_configured:\s*null/);
assert.match(readinessSource, /credential_ready:\s*null/);
assert.match(readinessSource, /PROVIDER_CREDENTIAL_STATUS_UNAVAILABLE/);
assert.match(readinessSource, /provider\.ready_for_execution === true/);
...
assert.match(uiSource, /Service status unavailable/);
assert.match(uiSource, /Service usage status unavailable/);
assert.match(uiSource, /Provider status unavailable/);
assert.match(uiSource, /Provider not evaluated/);
assert.match(uiSource, /Provider unavailable/);
assert.match(uiSource, /Pricing not evaluated/);
assert.match(uiSource, /Provider pricing required/);
assert.match(uiSource, /Runtime not evaluated/);
assert.match(uiSource, /Provider runtime unavailable/);
assert.match(uiSource, /Credential status unavailable/);
assert.match(uiSource, /Provider credential required/);
assert.match(uiSource, /Provider credential incomplete/);
assert.match(uiSource, /organization_service_exists === null/);
assert.match(uiSource, /organization_service_exists === false/);
assert.match(uiSource, /provider\.provider_selected === null/);
assert.match(uiSource, /provider\.provider_selected === false/);
assert.match(uiSource, /provider\.pricing_ready === null/);
assert.match(uiSource, /provider\.runtime_ready === null/);
assert.match(uiSource, /provider\.credential_ready === null/);
...
console.log("OPERATOR_PROACTIVE_DELIVERY_READINESS_SEMANTICS=TRI_STATE_EVALUATED_FAILURE_ONLY");
console.log("OPERATOR_PROACTIVE_DELIVERY_READINESS_UI=UNKNOWN_DISTINCT_FROM_FAILURE");
