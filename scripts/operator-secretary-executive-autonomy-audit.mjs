...
assert.match(source.meetingAudioRuntime, /expected_segment_count/);
assert.match(source.meetingAudioRuntime, /markAudioChunkSegmentPlan/);
assert.match(source.meetingAudioRuntime, /deletePartialSegmentsForChunk/);
assert.match(source.meetingAudioRuntime, /RECOVERED_COMPLETE/);
assert.match(source.meetingAudioRuntime, /partial_segments_cleared/);
...
console.log("SECRETARY_MEETING_PARTIAL_CHUNK_RECOVERY=true");
