...
assert.match(runtime, /SECRETARY_VISITOR_COORDINATION_HOST_EVIDENCE_REQUIRED/);
assert.match(runtime, /SECRETARY_VISITOR_COORDINATION_VISITOR_EVIDENCE_REQUIRED/);
