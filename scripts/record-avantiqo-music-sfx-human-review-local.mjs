...
const result={success:true,contract:CONTRACT,generated_at:new Date().toISOString(),review_packet_path:reviewPath,benchmark_report_path:review.benchmark_report_path,benchmark_job_id:review.benchmark_job_id,capability:"ai.sfx.generate",reviewer,notes,human_review_required:true,human_review_status:verdict,criteria:scored,minimum_score_0_to_100:minimum,average_score:Number(average.toFixed(2)),minimum_average_score:92,automatic_human_approval_forbidden:true,all_criteria_minimum_92_required:true,technical_quality_passed:true,technical_quality_report_path:review.technical_quality_report_path,technical_quality_warnings:Array.isArray(review?.technical_quality?.warnings)?review.technical_quality.warnings:[],eligible_for_later_release_decision:verdict==="APPROVED",production_routing_allowed:false,production_activation_allowed:false,pricing_activation_allowed:false,provider_jobs_submitted:0,production_activation_performed:false,pricing_activation_performed:false};
