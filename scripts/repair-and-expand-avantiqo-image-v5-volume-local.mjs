...
const CONTRACT = "AVANTIQO_IMAGE_V5_BIND_AND_VOLUME_EXPANSION_V1";
const BINDER = "scripts/bind-avantiqo-image-photoreal-v5-worker-local.mjs";
...
console.log("AVANTIQO_IMAGE_V5_VOLUME_SEQUENCE=V5_BIND_THEN_IN_PLACE_VOLUME_EXPANSION");
