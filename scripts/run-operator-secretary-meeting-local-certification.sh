...
node --import ./scripts/register-node-next-alias-hooks.mjs scripts/certify-secretary-executive-notes-dictation-local.mjs
...
node --import ./scripts/register-node-next-alias-hooks.mjs scripts/certify-secretary-office-artifact-preparation-local.mjs
...
node --import ./scripts/register-node-next-alias-hooks.mjs scripts/certify-secretary-document-transmittal-local.mjs
node --import ./scripts/register-node-next-alias-hooks.mjs scripts/certify-secretary-written-action-administration-local.mjs
...
node --import ./scripts/register-node-next-alias-hooks.mjs scripts/certify-secretary-travel-document-readiness-local.mjs
