"""Isolated Qwen3.8 runtime V9: V7 actor schema plus compact reviewer schema.

V9 preserves Runtime V7 execution and its actor structured-output contract
exactly, including up to 16 implementation criteria. Only reviewer requests use
the compact four-field schema introduced in Runtime V8.

No model, storage, deployment, production routing, GPU policy or call-count
behavior changes.
"""
...
CONTRACT = "AVANTIQO_CODE_QWEN38_CANARY_RUNTIME_V9"
...
def generate_v9(requests: list[dict[str, Any]], approved: bool = False) -> dict[str, Any]:
