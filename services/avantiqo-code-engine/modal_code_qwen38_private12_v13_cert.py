"""Avantiqo Code Qwen3.8 Private12 V13 certification wrapper.

V13 combines Repo Agent V12 with Runtime V8. The quality contract and call
ceilings remain unchanged while model-output contracts become materially
smaller:

* actor: 640 tokens, with <=4 concise criteria labels;
* reviewer: 256 tokens, compact four-field schema;
* repair actor: 1024 tokens;
* final reviewer: 256 tokens, same compact four-field schema.

The original task, current changed source, public-test evidence and independent
semantic review remain authoritative. No hidden material, benchmark-specific
rewriter, extra model call, new model, production routing or storage change is
introduced.
"""
...
CONTRACT = "AVANTIQO_CODE_QWEN38_PRIVATE12_CERT_V13"
RUN_SEED = "20260904-qwen38-private12-v13"
...
def _bind_v13() -> None:
    ...
    base.generate_v6 = runtime.generate_v8
    base._batch = _batch_v13
...
@app.local_entrypoint(name="qwen38_private12_v13")
def qwen38_private12_v13(approved: bool = False) -> None:
