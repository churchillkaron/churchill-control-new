"""Avantiqo Code Qwen3.8 Private12 V16 certification wrapper.

V16 preserves V15 runtime/call budgets and hot-path headroom, while switching
the repository agent to V15 for deterministic normalization of grammar-valid
optional edit placeholders and a shorter hot-path prompt.
"""
...
CONTRACT = "AVANTIQO_CODE_QWEN38_PRIVATE12_CERT_V16"
RUN_SEED = "20260904-qwen38-private12-v16"
...
@app.local_entrypoint(name="qwen38_private12_v16")
def qwen38_private12_v16(approved: bool = False) -> None:
