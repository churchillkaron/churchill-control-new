"""Avantiqo Code Qwen3.8 Private12 V17 certification wrapper.

V17 preserves the complete V16 repository-agent behavior, token budgets, repair
policy, compact reviewer contract, call ceilings and certification gates. The
only runtime change is V10 native MTP speculative decoding in place of V9 n-gram
...
CONTRACT = "AVANTIQO_CODE_QWEN38_PRIVATE12_CERT_V17"
...
def _bind_v17() -> None:
    ...
    base.generate_v6 = runtime.generate_v10
    base._batch = _batch_v17
...
@app.local_entrypoint(name="qwen38_private12_v17")
def qwen38_private12_v17(approved: bool = False) -> None:
