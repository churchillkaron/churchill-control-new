      ...
      for (const symbol of dirtySymbols) {
        ...
        for (const target of symbolTargets(this.group, symbol)) {
          snapshotRows.push({
            ...
            latest_trade_at: snapshot.latest_trade_at ?? null,
            latest_trade_id: snapshot.latest_trade_id ?? null,
            latest_quote_at: snapshot.latest_quote_at ?? null,
            latest_quote_fingerprint: snapshot.latest_quote_fingerprint ?? null,
