...
# Stable public alias: new callers get the preferred fast contract while older
# tests/integrations that imported GENERATION_CONTRACT continue to resolve safely.
GENERATION_CONTRACT = FAST_GENERATION_CONTRACT
