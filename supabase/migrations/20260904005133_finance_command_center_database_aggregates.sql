...
select jsonb_build_object(
  ...
  'filings', jsonb_build_object(
    'count', filings.count,
    'overdue', filings.overdue
  ),
  'review', jsonb_build_object(
    'count', review_items.count,
    'ready', review_items.ready,
    'changes_requested', review_items.changes_requested,
    'overdue', review_items.overdue
  ),
...
is 'Server-only exact Finance command-center aggregate. Authorization remains in the application route; execution is restricted to service_role.';
