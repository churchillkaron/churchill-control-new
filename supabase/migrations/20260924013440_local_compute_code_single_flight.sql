-- Serialize interactive Code inference per local node while preserving CPU fallback beside exclusive GPU work.
-- The advisory transaction lock closes the duplicate-worker race between concurrent claim RPCs.
