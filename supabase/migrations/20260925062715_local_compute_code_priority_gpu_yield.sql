...
comment on function public.claim_avantiqo_local_compute_jobs(text,text,text[],integer,integer)
  is 'Claims authenticated local compute with live front-lane reservation, Code single-flight, strong-Code/media coexistence, and fresh-Code priority at GPU job boundaries.';
