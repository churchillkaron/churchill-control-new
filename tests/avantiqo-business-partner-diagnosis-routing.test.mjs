...
import { businessDiagnosisAuditProjectionFingerprint, businessDiagnosisAnswerContentFingerprint, AVANTIQO_BUSINESS_DIAGNOSIS_AUDIT_PROJECTION_CONTRACT } from "../lib/intelligence/runtime/AvantiqoBusinessDiagnosisReceiptRuntime.js";
...
test("diagnosis adapter forwards authenticated scope and governed context at runtime",async()=>{
 ...
 const result=await runBusinessPartnerBusinessDiagnosis({
  ...
  received=payload;
  const receipt={contract:"AVANTIQO_BUSINESS_DIAGNOSIS_RECEIPT_V2",receipt_fingerprint:"abc123",answer_content_fingerprint:businessDiagnosisAnswerContentFingerprint("Verified diagnosis."),audit_projection_contract:AVANTIQO_BUSINESS_DIAGNOSIS_AUDIT_PROJECTION_CONTRACT,diagnosis_class:"CAUSAL_DIAGNOSIS",business_timezone:"UTC",final_evidence_state:"INTERNAL_SUFFICIENT",residual_material:false,answer_boundary_status:"PASS",answer_unsupported_recommendation_outcome_detected:false,validated_external_context_ids:[],rejected_or_unresolved_external_contexts:[],baseline_period_id:"aug-entity",baseline_period_start_date:"2026-08-01",baseline_period_end_date:"2026-08-31",current_period_id:"sep-entity",current_period_start_date:"2026-09-01",current_period_end_date:"2026-09-30"};
  receipt.audit_projection_fingerprint=businessDiagnosisAuditProjectionFingerprint({receipt_fingerprint:receipt.receipt_fingerprint,receipt_contract:receipt.contract,diagnosis_class:receipt.diagnosis_class,business_timezone:receipt.business_timezone,answer_content_fingerprint:receipt.answer_content_fingerprint,final_evidence_state:receipt.final_evidence_state,residual_material:receipt.residual_material,answer_boundary_status:receipt.answer_boundary_status,answer_unsupported_recommendation_outcome_detected:receipt.answer_unsupported_recommendation_outcome_detected,validated_external_context_count:0,unresolved_external_context_count:0,baseline_period_id:receipt.baseline_period_id,baseline_period_start_date:receipt.baseline_period_start_date,baseline_period_end_date:receipt.baseline_period_end_date,current_period_id:receipt.current_period_id,current_period_start_date:receipt.current_period_start_date,current_period_end_date:receipt.current_period_end_date});
