...
import { businessDiagnosisAuditProjectionFingerprint, AVANTIQO_BUSINESS_DIAGNOSIS_AUDIT_PROJECTION_CONTRACT } from "../lib/intelligence/runtime/AvantiqoBusinessDiagnosisReceiptRuntime.js";
...
test("diagnosis adapter forwards authenticated scope and governed context at runtime",async()=>{
 ...
 const result=await runBusinessPartnerBusinessDiagnosis({
  ...
  received=payload;
  const receipt={receipt_fingerprint:"abc123",audit_projection_contract:AVANTIQO_BUSINESS_DIAGNOSIS_AUDIT_PROJECTION_CONTRACT,diagnosis_class:"CAUSAL_DIAGNOSIS",business_timezone:"UTC",final_evidence_state:"INTERNAL_SUFFICIENT",residual_material:false,answer_boundary_status:"PASS",answer_unsupported_recommendation_outcome_detected:false,validated_external_context_ids:[],rejected_or_unresolved_external_contexts:[],baseline_period_id:"aug-entity",baseline_period_start_date:"2026-08-01",baseline_period_end_date:"2026-08-31",current_period_id:"sep-entity",current_period_start_date:"2026-09-01",current_period_end_date:"2026-09-30"};
