...
test("profit is never inferred from invoice or cash proxies",()=>{const r=resolve({metric:"profit",comparison_results:[cash("THB",1000,800)]});assert.equal(r.status,"TARGET_METRIC_EVIDENCE_GAP");assert.equal(r.reason,"EXACT_TARGET_MEASURE_NOT_OBSERVED");});
