...
function referenceReport({ provider, model, caseIds, suiteSha, wallMs }) {
  return {
...
async function fixture() {
  ...
  const refA = attestCodeAICompetitiveReferenceReport(referenceReport({
    provider: "reference-a", model: "model-a", caseIds, suiteSha, wallMs: 100,
  }), { env });
  const refB = attestCodeAICompetitiveReferenceReport(referenceReport({
    provider: "reference-b", model: "model-b", caseIds, suiteSha, wallMs: 110,
  }), { env });
