...
test("Image Studio clipping mask geometry is shared by preview and deterministic export", async () => {
  ...
  assert.deepEqual(reusable.imageStudioMaskGeometry(target,mask),{visible:true,x:50,y:25,width:100,height:150,target_width:200,target_height:200,feather:0,opacity:1,invert:false,shape:"RECT",radius:24});
