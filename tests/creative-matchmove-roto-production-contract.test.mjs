...
test("roto execution propagates matte temporally with optical flow and lossless packaging",()=>{
  ...
  assert.match(roto,/"ffv1"/);
  assert.match(roto,/"gray"/);
  assert.match(roto,/video\/x-matroska/);
});
