...
test('unsupported heavy solver remains blocked instead of being faked',()=>{
  const authored=CreativeSimulationRuntime.author({simulation:[request('HAIR_FUR')],subject:'flame source',action:'ignition',frame_plan:{opening_frame:'source cold',progression:'ignites',closing_frame:'smoke rises'},continuity:{environment:'kitchen'}});
