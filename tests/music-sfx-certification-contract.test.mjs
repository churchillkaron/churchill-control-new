...
test("SFX certification uses controlled fixture and exact owned model",()=>{
  assert.match(run,/MUSIC_SFX_CERTIFICATION_FIXTURES/); assert.match(run,/AVANTIQO_MUSIC_SFX_CERTIFICATION_FIXTURE_ID/); assert.match(run,/OpenMOSS-Team\/MOSS-SoundEffect-v2\.0/); assert.match(run,/avantiqo-sfx-v1/);
});
