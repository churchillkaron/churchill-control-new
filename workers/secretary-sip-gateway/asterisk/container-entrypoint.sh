...
TRUNK_ENABLED_RAW="${ASTERISK_SECRETARY_TRUNK_ENABLED:-false}"
...
TRUNK_ENABLED="$(normalize_bool "$TRUNK_ENABLED_RAW")" || {
  echo "SECRETARY_ASTERISK_CONFIG_ERROR=ASTERISK_SECRETARY_TRUNK_ENABLED_INVALID" >&2
  exit 1
}
...
echo "SECRETARY_ASTERISK_TRUNK_ENABLED=${TRUNK_ENABLED}"
